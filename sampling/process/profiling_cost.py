...
class BaselineManager:
    def __init__(self, sample_ratio, cluster_size,
            ...
            bq_cost=5, duck_cost=1.48, rs_cost=1.086, duck_load_cost=0.0):
        ...
        self.rs = json.load(open(f"rs_baseline_{self.cs}_{self.sr}.json"))
        self.rs_c = json.load(open(f"rs_c_baseline_{self.cs}_{self.sr}.json"))
        self.bq = json.load(open(f"bigquery_baseline_1tb_{self.sr}.json"))

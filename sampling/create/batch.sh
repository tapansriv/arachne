...
do
    python3 sample.py -S 0.25 /mnt/disks/tpcds/parquet "$tbl" create &
done
wait
...
for tbl in ${tpcds_names[@]}
do
    python3 sample.py -S 0.25 /mnt/disks/tpcds/parquet "$tbl" check > outputs/"$tbl"_0.25.output &
done
wait
...
for tbl in ${tpcds_names[@]}
do
    python3 sample.py -S 0.15 /mnt/disks/tpcds/parquet "$tbl" create &
done
wait
...
for tbl in ${tpcds_names[@]}
do
    python3 sample.py -S 0.15 /mnt/disks/tpcds/parquet "$tbl" check > outputs/"$tbl"_0.15.output &
done
wait
...
for tbl in ${tpcds_names[@]}
do
    python3 sample.py -S 0.50 /mnt/disks/tpcds/parquet "$tbl" create &
done
wait
...
for tbl in ${tpcds_names[@]}
do
    python3 sample.py -S 0.50 /mnt/disks/tpcds/parquet "$tbl" check > outputs/"$tbl"_0.50.output &
done
wait

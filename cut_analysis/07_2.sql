CREATE TABLE duck_table_07_0 AS SELECT "t7"."ss_promo_sk", "t7"."ss_quantity", "t7"."ss_list_price", "t7"."ss_sales_price", "t7"."ss_coupon_amt", "t8"."i_item_id"
...
;
SELECT "duck_table_07_0"."i_item_id", AVG("duck_table_07_0"."ss_quantity") AS "agg1", AVG("duck_table_07_0"."ss_list_price") AS "agg2", AVG("duck_table_07_0"."ss_coupon_amt") AS "agg3", AVG("duck_table_07_0"."ss_sales_price") AS "agg4"

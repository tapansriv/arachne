...
if __name__ == '__main__':
    ...
    fname = sys.argv[2]
    home = os.path.expanduser("~")
    print(f"{home}/arachneDB/baseline_10tb/{fname}.json")
    ...
    x = None
    with open(f"{home}/arachneDB/baseline_10tb/{fname}.json") as fp:
        x = json.load(fp)

    x[key] = runtime
    with open(f"{home}/arachneDB/baseline_10tb/{fname}.json", "w") as fp:

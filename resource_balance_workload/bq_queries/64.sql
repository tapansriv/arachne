 ...
 cross_sales AS
  (SELECT i_product_name product_name,
   ...
   FROM `arachne-multicloud.tpcds.store_sales` AS store_sales,
        ...
        `arachne-multicloud.tpcds.household_demographics` hd1,
        `arachne-multicloud.tpcds.household_demographics` hd2,
        `arachne-multicloud.tpcds.customer_address` ad1,
        `arachne-multicloud.tpcds.customer_address` ad2,
        `arachne-multicloud.tpcds.income_band` ib1,
        `arachne-multicloud.tpcds.income_band` ib2,

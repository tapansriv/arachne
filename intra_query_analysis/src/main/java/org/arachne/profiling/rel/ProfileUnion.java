...
public class ProfileUnion extends Union implements ProfileRel {
    protected Long card;
    ...
    public ProfileUnion(RelOptCluster cluster, RelTraitSet traits, List<RelNode> inputs, boolean all) {
    ...
    public SetOp copy(RelTraitSet traitSet, List<RelNode> inputs, boolean all) {
        return (SetOp) new ProfileUnion(getCluster(), traitSet, inputs, all).copyProfileData(this);
    }

CREATE TABLE duck_table_52_0 AS SELECT "t3"."d_year", "t6"."i_brand" AS "brand", "t6"."i_brand_id" AS "brand_id", SUM("t3"."ss_ext_sales_price") AS "ext_price"
...
;
SELECT "d_year", "brand_id", "brand", "ext_price"
FROM "duck_table_52_0"
ORDER BY "d_year", "ext_price" DESC NULLS LAST, "brand_id"

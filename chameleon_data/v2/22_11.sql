CREATE TABLE duck_table_22_0 AS SELECT "t2"."inv_warehouse_sk", "t2"."inv_quantity_on_hand"
...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t3" ON "t2"."inv_item_sk" = "t3"."i_item_sk"
;
SELECT *
FROM (SELECT *
FROM (SELECT *
...
UNION ALL
SELECT NULL AS "i_product_name", NULL AS "i_brand", NULL AS "i_class", NULL AS "i_category", AVG("duck_table_22_0"."inv_quantity_on_hand") AS "qoh"
FROM "duck_table_22_0"
INNER JOIN (SELECT "w_warehouse_sk"
FROM '/mnt/disks/tpcds/parquet/warehouse.parquet' AS warehouse) AS "t41" ON "duck_table_22_0"."inv_warehouse_sk" = "t41"."w_warehouse_sk") AS "t45"

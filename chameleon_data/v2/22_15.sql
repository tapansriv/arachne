...
FROM (SELECT "duck_table_22_0"."inv_warehouse_sk", "duck_table_22_0"."inv_quantity_on_hand", "t8"."i_brand", "t8"."i_class", "t8"."i_product_name"
FROM "duck_table_22_0"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t8" ON "duck_table_22_0"."inv_item_sk" = "t8"."i_item_sk") AS "t9"
INNER JOIN (SELECT "w_warehouse_sk"

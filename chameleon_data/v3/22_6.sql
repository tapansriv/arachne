CREATE TABLE duck_table_22_0 AS SELECT "t4"."i_product_name", AVG("t4"."inv_quantity_on_hand") AS "qoh"
FROM (SELECT "t2"."inv_warehouse_sk", "t2"."inv_quantity_on_hand", "t3"."i_product_name"
...
UNION ALL
SELECT "i_product_name", NULL AS "i_brand", NULL AS "i_class", NULL AS "i_category", "qoh"

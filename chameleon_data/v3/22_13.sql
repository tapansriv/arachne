...
FROM (SELECT "duck_table_22_0"."inv_warehouse_sk", "duck_table_22_0"."inv_quantity_on_hand", "t30"."i_product_name"
FROM "duck_table_22_0"
INNER JOIN (SELECT "i_item_sk", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t30" ON "duck_table_22_0"."inv_item_sk" = "t30"."i_item_sk") AS "t31"
INNER JOIN (SELECT "w_warehouse_sk"

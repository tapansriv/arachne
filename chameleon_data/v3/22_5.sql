CREATE TABLE duck_table_22_0 AS SELECT AVG("t4"."inv_quantity_on_hand") AS "qoh"
...
UNION ALL
SELECT NULL AS "i_product_name", NULL AS "i_brand", NULL AS "i_class", NULL AS "i_category", "qoh"
FROM "duck_table_22_0") AS "t42"

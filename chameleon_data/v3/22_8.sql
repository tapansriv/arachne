CREATE TABLE duck_table_22_0 AS SELECT "t4"."i_product_name", "t4"."i_brand", "t4"."i_class", AVG("t4"."inv_quantity_on_hand") AS "qoh"
...
GROUP BY "t4"."i_product_name", "t4"."i_brand", "t4"."i_class"
;
SELECT *
FROM (SELECT *
FROM (SELECT *
...
UNION ALL
SELECT "i_product_name", "i_brand", "i_class", NULL AS "i_category", "qoh"

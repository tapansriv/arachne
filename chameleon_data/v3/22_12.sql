...
FROM (SELECT "duck_table_22_0"."inv_warehouse_sk", "duck_table_22_0"."inv_quantity_on_hand"
FROM "duck_table_22_0"
INNER JOIN (SELECT "i_item_sk"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t41" ON "duck_table_22_0"."inv_item_sk" = "t41"."i_item_sk") AS "t42"
INNER JOIN (SELECT "w_warehouse_sk"

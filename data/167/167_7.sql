CREATE TABLE duck_table_167_0 AS SELECT "t6"."i_category", "t6"."i_class", "t6"."i_brand", "t6"."i_product_name", "t5"."d_year", "t5"."d_qoy", "t5"."d_moy", "t5"."wp_web_page_id", "t5"."*" AS "$f8"
...
FROM (SELECT *
FROM (SELECT *
FROM (SELECT "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id", SUM("$f8") AS "sumsales"
...
FROM (SELECT "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t2"
...
FROM (SELECT "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t7"
...
FROM (SELECT "i_category", "i_class", "i_brand", "i_product_name", "d_year", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t12"
...
FROM (SELECT "i_category", "i_class", "i_brand", "i_product_name", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t17"
...
FROM (SELECT "i_category", "i_class", "i_brand", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
...
FROM (SELECT "i_category", "i_class", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t27"
...
FROM (SELECT "i_category", SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t32"
...
FROM (SELECT SUM("$f8") AS "sumsales"
FROM "duck_table_167_0"
GROUP BY "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", "wp_web_page_id") AS "t37") AS "t40") AS "t41"
WHERE "rk" <= 100

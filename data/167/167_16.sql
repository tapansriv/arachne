...
;
CREATE TABLE duck_table_167_1 AS SELECT "i_category", "i_class", "i_brand", "i_product_name", SUM("sumsales") AS "sumsales"
...
UNION ALL
SELECT "i_category", "i_class", "i_brand", "i_product_name", NULL AS "d_year", NULL AS "d_qoy", NULL AS "d_moy", NULL AS "wp_web_page_id", "sumsales"

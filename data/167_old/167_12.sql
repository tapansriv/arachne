...
;
CREATE TABLE duck_table_167_1 AS SELECT SUM("sumsales") AS "sumsales"
...
UNION ALL
SELECT NULL AS "i_category", NULL AS "i_class", NULL AS "i_brand", NULL AS "i_product_name", NULL AS "d_year", NULL AS "d_qoy", NULL AS "d_moy", NULL AS "wp_web_page_id", "sumsales"
FROM "duck_table_167_1") AS "t29") AS "t30"
WHERE "rk" <= 100

...
;
CREATE TABLE duck_table_167_1 AS SELECT "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", SUM("sumsales") AS "sumsales"
...
FROM "duck_table_167_0"
UNION ALL
SELECT "i_category", "i_class", "i_brand", "i_product_name", "d_year", "d_qoy", "d_moy", NULL AS "wp_web_page_id", "sumsales"

CREATE TABLE duck_table_11_0 AS SELECT "t5"."p_personid", "t8"."k_person1id", "t8"."k_person2id"
...
FROM "duck_table_11_1") AS "t0" ON "t"."friendid" = "t0"."personid" AND "t"."personid" < "t0"."personid"
INNER JOIN (SELECT "p_personid" AS "personid", "k_person2id" AS "friendid"
FROM "duck_table_11_1") AS "t1" ON "t0"."friendid" = "t1"."personid" AND "t"."personid" = "t1"."friendid" AND "t0"."personid" < "t1"."personid"
;

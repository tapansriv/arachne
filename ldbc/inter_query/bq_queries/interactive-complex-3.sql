...
from
 ...
 ) f,  ldbc.person, ldbc.place p1, ldbc.place p2,
 (
  select chn.m_c_creatorid, ct1, ct2, ct1 + ct2 as total
  from
   (
      select m_creatorid as m_c_creatorid, count(*) as ct1 from ldbc.message, ldbc.place
      where
   ...
   (
      select m_creatorid as m_c_creatorid, count(*) as ct2 from ldbc.message, ldbc.place
      where

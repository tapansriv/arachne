CREATE TABLE duck_table_84_0 AS SELECT "t7"."c_customer_id", "t7"."cd_demo_sk", "t7"."c_last_name" || ', ' || "t7"."c_first_name" AS "||"
...
WHERE "ib_lower_bound" >= 38128 AND "ib_upper_bound" <= 38128 + 50000) AS "t9" ON "t7"."hd_income_band_sk" = "t9"."ib_income_band_sk";
SELECT "duck_table_84_0"."c_customer_id" AS "customer_id", "duck_table_84_0"."||" AS "customername"
FROM "duck_table_84_0"
INNER JOIN (SELECT "sr_cdemo_sk"
FROM '/mnt/disks/tpcds/parquet/store_returns.parquet' AS store_returns) AS "t" ON "duck_table_84_0"."cd_demo_sk" = "t"."sr_cdemo_sk"
ORDER BY "duck_table_84_0"."c_customer_id" NULLS FIRST

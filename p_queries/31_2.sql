CREATE TABLE duck_table_31_0 AS SELECT "t2"."ca_county", SUM("t1"."ws_ext_sales_price") * 1.0000 AS "*"
...
SELECT "t43"."ca_county", "t43"."d_year", "t43"."/" AS "web_q1_q2_increase", "t43"."/5" AS "store_q1_q2_increase", "duck_table_31_0"."*" / "t43"."web_sales0" AS "web_q2_q3_increase", "t43"."/6" AS "store_q2_q3_increase"
...
INNER JOIN "duck_table_31_0" ON "t43"."ca_county2" = "duck_table_31_0"."ca_county" AND CASE WHEN "t43".">" THEN CAST("duck_table_31_0"."*" / "t43"."web_sales0" AS DECIMAL(19, 4)) ELSE NULL END > "t43"."CASE"

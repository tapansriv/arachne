CREATE TABLE duck_table_93_0 AS SELECT "t1"."ss_customer_sk", "t1"."CASE" AS "act_sales"
...
FROM '/mnt/disks/tpcds/parquet/reason.parquet' AS reason
WHERE "r_reason_desc" = 'reason 28') AS "t4" ON "t1"."sr_reason_sk" = "t4"."r_reason_sk";
SELECT "ss_customer_sk", SUM("act_sales") AS "sumsales"
FROM "duck_table_93_0"
GROUP BY "ss_customer_sk"
ORDER BY SUM("act_sales") NULLS FIRST, "ss_customer_sk" NULLS FIRST

CREATE TABLE duck_table_73_0 AS SELECT "t7"."ss_ticket_number", "t7"."ss_customer_sk", COUNT(*) AS "cnt"
...
SELECT "t"."c_last_name", "t"."c_first_name", "t"."c_salutation", "t"."c_preferred_cust_flag", "duck_table_73_0"."ss_ticket_number", "duck_table_73_0"."cnt"
FROM "duck_table_73_0"
INNER JOIN (SELECT "c_customer_sk", "c_salutation", "c_first_name", "c_last_name", "c_preferred_cust_flag"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t" ON "duck_table_73_0"."ss_customer_sk" = "t"."c_customer_sk"
ORDER BY "duck_table_73_0"."cnt" DESC NULLS LAST, "t"."c_last_name";

CREATE TABLE duck_table_87_0 AS SELECT *
...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t4" ON "t3"."ss_customer_sk" = "t4"."c_customer_sk"
...
INNER JOIN (SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t12" ON "t11"."cs_bill_customer_sk" = "t12"."c_customer_sk"
...
INNER JOIN (SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t21" ON "t20"."ws_bill_customer_sk" = "t21"."c_customer_sk"
GROUP BY "t21"."c_last_name", "t21"."c_first_name", "t20"."d_date";
SELECT COUNT(*)
FROM "duck_table_87_0";

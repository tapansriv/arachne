CREATE TABLE duck_table_56_0 AS SELECT "t13"."i_item_id", "t7"."ws_ext_sales_price"
...
WHERE "d_year" = 2001 AND "d_moy" = 2) AS "t2" ON "t"."ws_sold_date_sk" = "t2"."d_date_sk") AS "t3"
...
GROUP BY "i_item_id") AS "t11" ON "item"."i_item_id" = "t11"."i_item_id") AS "t13" ON "t7"."ws_item_sk" = "t13"."i_item_sk";
...
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_year" = 2001 AND "d_moy" = 2) AS "t20" ON "t17"."cs_sold_date_sk" = "t20"."d_date_sk") AS "t21"
INNER JOIN (SELECT "ca_address_sk"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address

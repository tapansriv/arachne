CREATE TABLE duck_table_46_0 AS SELECT "ca_address_sk", "ca_city"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address;
SELECT "t17"."c_last_name", "t17"."c_first_name", "duck_table_46_0"."ca_city", "t17"."bought_city", "t17"."ss_ticket_number", "t17"."amt", "t17"."profit"

CREATE TABLE duck_table_83_0 AS SELECT "t1"."i_item_id" AS "item_id", SUM("t1"."cr_return_quantity") AS "cr_item_qty", SUM("t1"."cr_return_quantity") * 1.0000 AS "*"
...
FROM (SELECT "t13"."item_id", "t13"."sr_item_qty", "duck_table_83_0"."cr_item_qty", "t13"."*" AS "*", "t13"."sr_item_qty" + "duck_table_83_0"."cr_item_qty" AS "+", "duck_table_83_0"."*" AS "*5"
...
INNER JOIN "duck_table_83_0" ON "t13"."item_id" = "duck_table_83_0"."item_id") AS "t14"

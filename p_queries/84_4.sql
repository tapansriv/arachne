CREATE TABLE duck_table_84_0 AS SELECT "ib_income_band_sk"
FROM '/mnt/disks/tpcds/parquet/income_band.parquet' AS income_band
WHERE "ib_lower_bound" >= 38128 AND "ib_upper_bound" <= 38128 + 50000;
SELECT "t9"."c_customer_id" AS "customer_id", "t9"."||" AS "customername"
...
INNER JOIN "duck_table_84_0" ON "t7"."hd_income_band_sk" = "duck_table_84_0"."ib_income_band_sk") AS "t9"
INNER JOIN (SELECT "sr_cdemo_sk"
FROM '/mnt/disks/tpcds/parquet/store_returns.parquet' AS store_returns) AS "t10" ON "t9"."cd_demo_sk" = "t10"."sr_cdemo_sk"
ORDER BY "t9"."c_customer_id" NULLS FIRST

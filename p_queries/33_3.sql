CREATE TABLE duck_table_33_0 AS SELECT "t13"."i_manufact_id", "t7"."ss_ext_sales_price"
...
FROM (SELECT *
FROM (SELECT "i_manufact_id", SUM("ss_ext_sales_price") AS "total_sales"
FROM "duck_table_33_0"
GROUP BY "i_manufact_id"
UNION ALL
SELECT "t15"."i_manufact_id", SUM("t9"."cs_ext_sales_price") AS "total_sales"
...
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_year" = 1998 AND "d_moy" = 5) AS "t4" ON "t1"."cs_sold_date_sk" = "t4"."d_date_sk") AS "t5"
INNER JOIN (SELECT "ca_address_sk"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address
...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
WHERE "i_category" = 'Electronics'
GROUP BY "i_manufact_id") AS "t13" ON "item"."i_manufact_id" = "t13"."i_manufact_id") AS "t15" ON "t9"."cs_item_sk" = "t15"."i_item_sk"
GROUP BY "t15"."i_manufact_id") AS "t"
UNION ALL

CREATE TABLE duck_table_83_0 AS SELECT "t1"."i_item_id" AS "item_id", SUM("t1"."wr_return_quantity") AS "wr_item_qty", SUM("t1"."wr_return_quantity") * 1.0000 AS "*"
...
SELECT "t29"."item_id", "t29"."sr_item_qty", "t29"."*" / ("t29"."+" + "duck_table_83_0"."wr_item_qty") / 3.0000 * 100 AS "sr_dev", "t29"."cr_item_qty", "t29"."*5" / ("t29"."+" + "duck_table_83_0"."wr_item_qty") / 3.0000 * 100 AS "cr_dev", "duck_table_83_0"."wr_item_qty", "duck_table_83_0"."*" / ("t29"."+" + "duck_table_83_0"."wr_item_qty") / 3.0000 * 100 AS "wr_dev", ("t29"."+" + "duck_table_83_0"."wr_item_qty") / 3.0 AS "average"
...
FROM '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS catalog_returns) AS "t14"
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t15" ON "t14"."cr_item_sk" = "t15"."i_item_sk") AS "t16"
...
INNER JOIN "duck_table_83_0" ON "t29"."item_id" = "duck_table_83_0"."item_id"

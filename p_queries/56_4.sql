CREATE TABLE duck_table_56_0 AS SELECT "t13"."i_item_id", "t7"."cs_ext_sales_price"
...
WHERE "d_year" = 2001 AND "d_moy" = 2) AS "t2" ON "t"."cs_sold_date_sk" = "t2"."d_date_sk") AS "t3"
...
GROUP BY "i_item_id") AS "t11" ON "item"."i_item_id" = "t11"."i_item_id") AS "t13" ON "t7"."cs_item_sk" = "t13"."i_item_sk";

CREATE TABLE duck_table_46_0 AS SELECT "t15"."ss_ticket_number", "t15"."bought_city", "t15"."amt", "t15"."profit", "t16"."c_current_addr_sk", "t16"."c_first_name", "t16"."c_last_name"
...
SELECT "duck_table_46_0"."c_last_name", "duck_table_46_0"."c_first_name", "t"."ca_city", "duck_table_46_0"."bought_city", "duck_table_46_0"."ss_ticket_number", "duck_table_46_0"."amt", "duck_table_46_0"."profit"

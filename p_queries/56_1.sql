CREATE TABLE duck_table_56_0 AS SELECT "item"."i_item_sk", "item"."i_item_id"
...
CREATE TABLE duck_table_56_1 AS SELECT *
FROM (SELECT "duck_table_56_0"."i_item_id", SUM("t7"."ss_ext_sales_price") AS "total_sales"
...
WHERE "d_year" = 2001 AND "d_moy" = 2) AS "t2" ON "t"."ss_sold_date_sk" = "t2"."d_date_sk") AS "t3"
...
INNER JOIN "duck_table_56_0" ON "t7"."ss_item_sk" = "duck_table_56_0"."i_item_sk"
GROUP BY "duck_table_56_0"."i_item_id"
UNION ALL
SELECT "duck_table_56_00"."i_item_id", SUM("t19"."cs_ext_sales_price") AS "total_sales"
...
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_year" = 2001 AND "d_moy" = 2) AS "t14" ON "t11"."cs_sold_date_sk" = "t14"."d_date_sk") AS "t15"
INNER JOIN (SELECT "ca_address_sk"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address
WHERE "ca_gmt_offset" = -5) AS "t18" ON "t15"."cs_bill_addr_sk" = "t18"."ca_address_sk") AS "t19"
INNER JOIN "duck_table_56_0" AS "duck_table_56_00" ON "t19"."cs_item_sk" = "duck_table_56_00"."i_item_sk"
GROUP BY "duck_table_56_00"."i_item_id") AS "t"
UNION ALL
SELECT "duck_table_56_01"."i_item_id", SUM("t32"."ws_ext_sales_price") AS "total_sales"
...
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_year" = 2001 AND "d_moy" = 2) AS "t27" ON "t24"."ws_sold_date_sk" = "t27"."d_date_sk") AS "t28"
INNER JOIN (SELECT "ca_address_sk"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address
WHERE "ca_gmt_offset" = -5) AS "t31" ON "t28"."ws_bill_addr_sk" = "t31"."ca_address_sk") AS "t32"
INNER JOIN "duck_table_56_0" AS "duck_table_56_01" ON "t32"."ws_item_sk" = "duck_table_56_01"."i_item_sk"
GROUP BY "duck_table_56_01"."i_item_id";
SELECT "i_item_id", SUM("total_sales") AS "total_sales"
FROM "duck_table_56_1"
GROUP BY "i_item_id"
ORDER BY SUM("total_sales") NULLS FIRST, "i_item_id" NULLS FIRST

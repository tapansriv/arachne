CREATE TABLE duck_table_60_0 AS SELECT "item"."i_item_sk", "item"."i_item_id"
...
CREATE TABLE duck_table_60_1 AS SELECT *
FROM (SELECT "duck_table_60_0"."i_item_id", SUM("t7"."ss_ext_sales_price") AS "total_sales"
...
INNER JOIN "duck_table_60_0" ON "t7"."ss_item_sk" = "duck_table_60_0"."i_item_sk"
GROUP BY "duck_table_60_0"."i_item_id"
UNION ALL
SELECT "duck_table_60_00"."i_item_id", SUM("t19"."cs_ext_sales_price") AS "total_sales"
...
INNER JOIN "duck_table_60_0" AS "duck_table_60_00" ON "t19"."cs_item_sk" = "duck_table_60_00"."i_item_sk"
GROUP BY "duck_table_60_00"."i_item_id") AS "t"
UNION ALL
SELECT "duck_table_60_01"."i_item_id", SUM("t32"."ws_ext_sales_price") AS "total_sales"
...
INNER JOIN "duck_table_60_0" AS "duck_table_60_01" ON "t32"."ws_item_sk" = "duck_table_60_01"."i_item_sk"
GROUP BY "duck_table_60_01"."i_item_id";
SELECT "i_item_id", SUM("total_sales") AS "total_sales1"
FROM "duck_table_60_1"
GROUP BY "i_item_id"

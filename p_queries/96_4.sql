...
WHERE "t_hour" = 20 AND "t_minute" >= 30) AS "t" ON "duck_table_96_0"."ss_sold_time_sk" = "t"."t_time_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store
WHERE "s_store_name" = 'ese') AS "t0" ON "duck_table_96_0"."ss_store_sk" = "t0"."s_store_sk"
ORDER BY COUNT(*)

CREATE TABLE duck_table_91_0 AS SELECT "t11"."cc_call_center_id", "t11"."cc_name", "t11"."cc_manager", "t11"."cr_net_loss", "t11"."c_current_hdemo_sk", "t13"."cd_marital_status", "t13"."cd_education_status"
...
WHERE "cd_marital_status" = 'M' AND "cd_education_status" = 'Unknown' OR "cd_marital_status" = 'W' AND "cd_education_status" = 'Advanced Degree') AS "t13" ON "t11"."c_current_cdemo_sk" = "t13"."cd_demo_sk";
SELECT "duck_table_91_0"."cc_call_center_id" AS "Call_Center", "duck_table_91_0"."cc_name" AS "Call_Center_Name", "duck_table_91_0"."cc_manager" AS "Manager", SUM("duck_table_91_0"."cr_net_loss") AS "Returns_Loss"
...
WHERE "hd_buy_potential" LIKE 'Unknown%') AS "t1" ON "duck_table_91_0"."c_current_hdemo_sk" = "t1"."hd_demo_sk"
GROUP BY "duck_table_91_0"."cc_call_center_id", "duck_table_91_0"."cc_name", "duck_table_91_0"."cc_manager", "duck_table_91_0"."cd_marital_status", "duck_table_91_0"."cd_education_status"
ORDER BY SUM("duck_table_91_0"."cr_net_loss") DESC NULLS LAST;

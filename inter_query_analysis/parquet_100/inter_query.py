...
table_sizes_bytes = {"call_center":9356, "catalog_page":2857922, "catalog_returns":2279225314, "catalog_sales":31016462258, "customer":269534238, "customer_address":111154196, "customer_demographics":80660096, "date_dim":10317438, "dbgen_version":39, "household_demographics":151653, "income_band":328, "inventory":8626269134, "item":58366791, "promotion":124973, "reason":1959, "ship_mode":1113, "store":106820, "store_returns":3483867155, "store_sales":40959624908, "time_dim":5107780, "warehouse":1782, "web_page":199049, "web_returns":1053529104, "web_sales":15463513086, "web_site":6874}
...
class BaselineManager:
    def __init__(self, egress_cost, use_duck=False):
        ...
        self.rs = json.load(open(f"duckdb_baseline_100.json"))
        self.rs_c = json.load(open(f"duckdb_c_baseline_100.json"))

...
table_sizes_bytes = json.load(open("table_sizes.json"))
table_size_gb = {}
...
class BaselineManager:
    def __init__(self, egress_cost, use_duck=False):
        ...
        self.rs = json.load(open(f"ldbc_baseline.json"))
        self.rs_c = json.load(open(f"ldbc_c_baseline.json"))
...
if __name__ == '__main__':
    ...
    find_best_subset(query_bit_vecs, len(table_indices), egress_cost, use_duck=use_duck)

...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 180 and 180+10 
             or ss_coupon_amt between 9976 and 9976+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 161 and 161+10
          or ss_coupon_amt between 9148 and 9148+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 96 and 96+10
          or ss_coupon_amt between 10801 and 10801+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 4 and 4+10
          or ss_coupon_amt between 16332 and 16332+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 50 and 50+10
          or ss_coupon_amt between 10879 and 10879+1000

...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 98 and 98+10 
             or ss_coupon_amt between 3866 and 3866+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 102 and 102+10
          or ss_coupon_amt between 3039 and 3039+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 113 and 113+10
          or ss_coupon_amt between 3578 and 3578+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 1 and 1+10
          or ss_coupon_amt between 6772 and 6772+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 30 and 30+10
          or ss_coupon_amt between 15105 and 15105+1000

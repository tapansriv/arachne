...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 37 and 37+10 
             or ss_coupon_amt between 12183 and 12183+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 34 and 34+10
          or ss_coupon_amt between 785 and 785+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 169 and 169+10
          or ss_coupon_amt between 376 and 376+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 121 and 121+10
          or ss_coupon_amt between 12222 and 12222+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 86 and 86+10
          or ss_coupon_amt between 7669 and 7669+1000

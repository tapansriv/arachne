CREATE TABLE rs_table_72_0 AS SELECT "t21"."cs_item_sk", "t21"."cs_order_number", "t21"."w_warehouse_name", "t21"."i_item_desc", "t21"."d_week_seq", CASE WHEN "t22"."p_promo_sk" IS NULL THEN 1 ELSE 0 END AS "CASE", CASE WHEN "t22"."p_promo_sk" IS NOT NULL THEN 1 ELSE 0 END AS "CASE6"
...
FROM promotion) AS "t22" ON "t21"."cs_promo_sk" = "t22"."p_promo_sk"
;
SELECT "rs_table_72_0"."i_item_desc", "rs_table_72_0"."w_warehouse_name", "rs_table_72_0"."d_week_seq", SUM("rs_table_72_0"."CASE") AS "no_promo", SUM("rs_table_72_0"."CASE6") AS "promo", COUNT(*) AS "total_cnt"
FROM "rs_table_72_0"
LEFT JOIN (SELECT "cr_item_sk", "cr_order_number"
FROM catalog_returns) AS "t" ON "rs_table_72_0"."cs_item_sk" = "t"."cr_item_sk" AND "rs_table_72_0"."cs_order_number" = "t"."cr_order_number"
GROUP BY "rs_table_72_0"."i_item_desc", "rs_table_72_0"."w_warehouse_name", "rs_table_72_0"."d_week_seq"
ORDER BY COUNT(*) DESC, "rs_table_72_0"."i_item_desc" NULLS FIRST, "rs_table_72_0"."w_warehouse_name" NULLS FIRST, "rs_table_72_0"."d_week_seq" NULLS FIRST
LIMIT 100
;

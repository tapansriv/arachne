...
GROUP BY "t2"."w_warehouse_name", "t2"."w_warehouse_sk", "t2"."i_item_sk", "t5"."d_moy"
HAVING CASE WHEN AVG("t2"."inv_quantity_on_hand") = 0 THEN 0 ELSE STDDEV_SAMP("t2"."inv_quantity_on_hand") * 1.000 / AVG("t2"."inv_quantity_on_hand") END > 1) AS "t8"
WHERE "t8"."d_moy" = 1 + 1) AS "t12" ON "rs_table_39_0"."i_item_sk" = "t12"."i_item_sk" AND "rs_table_39_0"."w_warehouse_sk" = "t12"."w_warehouse_sk"
ORDER BY "rs_table_39_0"."w_warehouse_sk" NULLS FIRST, "rs_table_39_0"."i_item_sk" NULLS FIRST, "rs_table_39_0"."d_moy" NULLS FIRST, "rs_table_39_0"."mean" NULLS FIRST, "rs_table_39_0"."cov" NULLS FIRST, "t12"."d_moy" NULLS FIRST, "t12"."mean" NULLS FIRST, "t12"."cov" NULLS FIRST
;

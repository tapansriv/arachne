CREATE TABLE rs_table_68_0 AS SELECT "c_customer_sk", "c_current_addr_sk", "c_first_name", "c_last_name"
FROM customer
;
SELECT "t16"."c_last_name", "t16"."c_first_name", "t17"."ca_city", "t16"."bought_city", "t16"."ss_ticket_number", "t16"."extended_price", "t16"."extended_tax", "t16"."list_price"
FROM (SELECT "t15"."ss_ticket_number", "t15"."bought_city", "t15"."extended_price", "t15"."list_price", "t15"."extended_tax", "rs_table_68_0"."c_current_addr_sk", "rs_table_68_0"."c_first_name", "rs_table_68_0"."c_last_name"
...
INNER JOIN "rs_table_68_0" ON "t15"."ss_customer_sk" = "rs_table_68_0"."c_customer_sk") AS "t16"
INNER JOIN (SELECT "ca_address_sk", "ca_city"
FROM customer_address) AS "t17" ON "t16"."c_current_addr_sk" = "t17"."ca_address_sk" AND "t17"."ca_city" <> "t16"."bought_city"
ORDER BY "t16"."c_last_name" NULLS FIRST, "t16"."ss_ticket_number" NULLS FIRST
LIMIT 100
;

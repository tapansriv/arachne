CREATE TABLE rs_table_68_0 AS SELECT "ca_address_sk", "ca_city"
FROM customer_address
;
SELECT "t17"."c_last_name", "t17"."c_first_name", "rs_table_68_0"."ca_city", "t17"."bought_city", "t17"."ss_ticket_number", "t17"."extended_price", "t17"."extended_tax", "t17"."list_price"
...
FROM customer) AS "t16" ON "t15"."ss_customer_sk" = "t16"."c_customer_sk") AS "t17"
INNER JOIN "rs_table_68_0" ON "t17"."c_current_addr_sk" = "rs_table_68_0"."ca_address_sk" AND "rs_table_68_0"."ca_city" <> "t17"."bought_city"

CREATE TABLE rs_table_50_0 AS SELECT "t6"."s_store_name", "t6"."s_company_id", "t6"."s_street_number", "t6"."s_street_name", "t6"."s_street_type", "t6"."s_suite_number", "t6"."s_city", "t6"."s_county", "t6"."s_state", "t6"."s_zip", "t6"."CASE" AS "$f10", "t6"."CASE12" AS "$f11", "t6"."CASE13" AS "$f12", "t6"."CASE14" AS "$f13", "t6"."CASE15" AS "$f14"
...
;
SELECT "s_store_name", "s_company_id", "s_street_number", "s_street_name", "s_street_type", "s_suite_number", "s_city", "s_county", "s_state", "s_zip", SUM("$f10") AS "days_30", SUM("$f11") AS "days_31_60", SUM("$f12") AS "days_61_90", SUM("$f13") AS "days_90_120", SUM("$f14") AS "days_over_120"
FROM "rs_table_50_0"

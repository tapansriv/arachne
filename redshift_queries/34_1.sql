CREATE TABLE rs_table_34_0 AS SELECT "t7"."ss_ticket_number", "t7"."ss_customer_sk", COUNT(*) AS "cnt"
...
;
SELECT "t"."c_last_name", "t"."c_first_name", "t"."c_salutation", "t"."c_preferred_cust_flag", "rs_table_34_0"."ss_ticket_number", "rs_table_34_0"."cnt"
FROM "rs_table_34_0"
INNER JOIN (SELECT "c_customer_sk", "c_salutation", "c_first_name", "c_last_name", "c_preferred_cust_flag"
FROM customer) AS "t" ON "rs_table_34_0"."ss_customer_sk" = "t"."c_customer_sk"
ORDER BY "t"."c_last_name" NULLS FIRST, "t"."c_first_name" NULLS FIRST, "t"."c_salutation" NULLS FIRST, "t"."c_preferred_cust_flag" DESC, "rs_table_34_0"."ss_ticket_number" NULLS FIRST
;

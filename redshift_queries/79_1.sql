CREATE TABLE rs_table_79_0 AS SELECT "t7"."ss_ticket_number", "t7"."ss_customer_sk", SUM("t7"."ss_coupon_amt") AS "amt", SUM("t7"."ss_net_profit") AS "profit", SUBSTRING("t7"."s_city" FROM 1 FOR 30) AS "SUBSTRING"
...
;
SELECT "t"."c_last_name", "t"."c_first_name", "rs_table_79_0"."SUBSTRING", "rs_table_79_0"."ss_ticket_number", "rs_table_79_0"."amt", "rs_table_79_0"."profit"
FROM "rs_table_79_0"
INNER JOIN (SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM customer) AS "t" ON "rs_table_79_0"."ss_customer_sk" = "t"."c_customer_sk"
ORDER BY "t"."c_last_name" NULLS FIRST, "t"."c_first_name" NULLS FIRST, "rs_table_79_0"."SUBSTRING" NULLS FIRST, "rs_table_79_0"."profit" NULLS FIRST
LIMIT 100
;

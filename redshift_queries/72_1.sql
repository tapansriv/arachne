CREATE TABLE rs_table_72_0 AS SELECT "t23"."i_item_desc", "t23"."w_warehouse_name", "t23"."d_week_seq", "t23"."CASE" AS "$f3", "t23"."CASE6" AS "$f4"
...
FROM catalog_returns) AS "t24" ON "t23"."cs_item_sk" = "t24"."cr_item_sk" AND "t23"."cs_order_number" = "t24"."cr_order_number"
;
SELECT "i_item_desc", "w_warehouse_name", "d_week_seq", SUM("$f3") AS "no_promo", SUM("$f4") AS "promo", COUNT(*) AS "total_cnt"
FROM "rs_table_72_0"
GROUP BY "i_item_desc", "w_warehouse_name", "d_week_seq"
ORDER BY COUNT(*) DESC, "i_item_desc" NULLS FIRST, "w_warehouse_name" NULLS FIRST, "d_week_seq" NULLS FIRST
LIMIT 100
;

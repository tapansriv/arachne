CREATE TABLE rs_table_11_0 AS SELECT "customer_id", "year_total" * 1.0000 AS """*"""
...
INNER JOIN "rs_table_11_0" ON "t55"."customer_id" = "rs_table_11_0"."customer_id" AND CASE WHEN "t55".">" THEN "rs_table_11_0"."""*""" / "t55"."year_total1" ELSE 0.0 END > "t55"."CASE"

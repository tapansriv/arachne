CREATE TABLE rs_table_18_0 AS SELECT "t18"."i_item_id", "t17"."ca_country", "t17"."CAST" AS "agg1", "t17"."CAST3" AS "agg2", "t17"."CAST4" AS "agg3", "t17"."CAST5" AS "agg4", "t17"."CAST6" AS "agg5", "t17"."CAST7" AS "agg6", "t17"."CAST8" AS "agg7"
FROM (SELECT "t13"."cs_item_sk", "t13"."ca_country", "t13"."CAST", "t13"."CAST4" AS "CAST3", "t13"."CAST5" AS "CAST4", "t13"."CAST6" AS "CAST5", "t13"."CAST7" AS "CAST6", "t13"."CAST8" AS "CAST7", "t13"."CAST9" AS "CAST8"
FROM (SELECT "t9"."cs_sold_date_sk", "t9"."cs_item_sk", "t12"."ca_country", "t9"."CAST", "t9"."CAST4", "t9"."CAST5", "t9"."CAST6", "t9"."CAST7", "t9"."CAST8", "t9"."CAST9"
...
UNION ALL
SELECT "i_item_id", "ca_country", NULL AS "ca_state", NULL AS "county", AVG("agg1") AS "agg1", AVG("agg2") AS "agg2", AVG("agg3") AS "agg3", AVG("agg4") AS "agg4", AVG("agg5") AS "agg5", AVG("agg6") AS "agg6", AVG("agg7") AS "agg7"
FROM "rs_table_18_0"
GROUP BY "i_item_id", "ca_country")
UNION ALL
SELECT "t65"."i_item_id", NULL AS "ca_country", NULL AS "ca_state", NULL AS "county", AVG("t64"."CAST") AS "agg1", AVG("t64"."CAST2") AS "agg2", AVG("t64"."CAST3") AS "agg3", AVG("t64"."CAST4") AS "agg4", AVG("t64"."CAST5") AS "agg5", AVG("t64"."CAST6") AS "agg6", AVG("t64"."CAST7") AS "agg7"
FROM (SELECT "t60"."cs_item_sk", "t60"."CAST", "t60"."CAST3" AS "CAST2", "t60"."CAST4" AS "CAST3", "t60"."CAST5" AS "CAST4", "t60"."CAST6" AS "CAST5", "t60"."CAST7" AS "CAST6", "t60"."CAST8" AS "CAST7"
FROM (SELECT "t56"."cs_sold_date_sk", "t56"."cs_item_sk", "t56"."CAST", "t56"."CAST4" AS "CAST3", "t56"."CAST5" AS "CAST4", "t56"."CAST6" AS "CAST5", "t56"."CAST7" AS "CAST6", "t56"."CAST8" AS "CAST7", "t56"."CAST9" AS "CAST8"
FROM (SELECT "t52"."cs_sold_date_sk", "t52"."cs_item_sk", "t55"."c_current_addr_sk", "t52"."CAST", "t52"."CAST5" AS "CAST4", "t52"."CAST6" AS "CAST5", "t52"."CAST7" AS "CAST6", "t52"."CAST8" AS "CAST7", "t55"."CAST" AS "CAST8", "t52"."CAST9"
FROM (SELECT "t50"."cs_sold_date_sk", "t50"."cs_bill_customer_sk", "t50"."cs_item_sk", "t51"."cd_demo_sk" AS "cd_demo_sk0", "t50"."CAST", "t50"."CAST4" AS "CAST5", "t50"."CAST5" AS "CAST6", "t50"."CAST6" AS "CAST7", "t50"."CAST7" AS "CAST8", "t50"."CAST8" AS "CAST9"
FROM (SELECT "t46"."cs_sold_date_sk", "t46"."cs_bill_customer_sk", "t46"."cs_item_sk", "t46"."CAST", "t46"."CAST5" AS "CAST4", "t46"."CAST6" AS "CAST5", "t46"."CAST7" AS "CAST6", "t46"."CAST8" AS "CAST7", "t49"."CAST" AS "CAST8"
FROM (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", "cs_bill_cdemo_sk", "cs_item_sk", CAST("cs_quantity" AS DECIMAL(12, 2)) AS "CAST", CAST("cs_list_price" AS DECIMAL(12, 2)) AS "CAST5", CAST("cs_coupon_amt" AS DECIMAL(12, 2)) AS "CAST6", CAST("cs_sales_price" AS DECIMAL(12, 2)) AS "CAST7", CAST("cs_net_profit" AS DECIMAL(12, 2)) AS "CAST8"
FROM catalog_sales) AS "t46"
INNER JOIN (SELECT "cd_demo_sk", CAST("cd_dep_count" AS DECIMAL(12, 2)) AS "CAST"
FROM customer_demographics
WHERE "cd_gender" = 'F' AND "cd_education_status" = 'Unknown') AS "t49" ON "t46"."cs_bill_cdemo_sk" = "t49"."cd_demo_sk") AS "t50",
(SELECT "cd_demo_sk"
FROM customer_demographics) AS "t51") AS "t52"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_addr_sk", CAST("c_birth_year" AS DECIMAL(12, 2)) AS "CAST"
FROM customer
WHERE "c_birth_month" IN (1, 2, 6, 8, 9, 12)) AS "t55" ON "t52"."cs_bill_customer_sk" = "t55"."c_customer_sk" AND "t52"."cd_demo_sk0" = "t55"."c_current_cdemo_sk") AS "t56"
INNER JOIN (SELECT "ca_address_sk"
FROM customer_address
WHERE "ca_state" IN ('IN', 'MS', 'ND', 'NM', 'OK', 'VA')) AS "t59" ON "t56"."c_current_addr_sk" = "t59"."ca_address_sk") AS "t60"
INNER JOIN (SELECT "d_date_sk"
FROM date_dim
WHERE "d_year" = 1998) AS "t63" ON "t60"."cs_sold_date_sk" = "t63"."d_date_sk") AS "t64"
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM item) AS "t65" ON "t64"."cs_item_sk" = "t65"."i_item_sk"
GROUP BY "t65"."i_item_id")
UNION ALL

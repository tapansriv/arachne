CREATE TABLE rs_table_91_0 AS SELECT "t14"."cc_call_center_id" AS "Call_Center", "t14"."cc_name" AS "Call_Center_Name", "t14"."cc_manager" AS "Manager", "t14"."cd_marital_status", "t14"."cd_education_status", "t14"."cr_net_loss"

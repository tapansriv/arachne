CREATE TABLE rs_table_75_0 AS SELECT "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id", SUM("sales_cnt") AS "sales_cnt", SUM("sales_amt") AS "sales_amt", CAST(SUM("sales_cnt") AS DECIMAL(17, 2)) AS "CAST"
FROM (SELECT *
...
HAVING "d_year" = 2002
;
SELECT "t30"."d_year" AS "prev_year", "rs_table_75_0"."d_year" AS "year_", "rs_table_75_0"."i_brand_id", "rs_table_75_0"."i_class_id", "rs_table_75_0"."i_category_id", "rs_table_75_0"."i_manufact_id", "t30"."sales_cnt" AS "prev_yr_cnt", "rs_table_75_0"."sales_cnt" AS "curr_yr_cnt", "rs_table_75_0"."sales_cnt" - "t30"."sales_cnt" AS "sales_cnt_diff", "rs_table_75_0"."sales_amt" - "t30"."sales_amt" AS "sales_amt_diff"
FROM "rs_table_75_0"
...
FROM web_returns) AS "t25" ON "t24"."ws_order_number" = "t25"."wr_order_number" AND "t24"."ws_item_sk" = "t25"."wr_item_sk") AS "t27"
GROUP BY "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
HAVING "d_year" = 2002 - 1) AS "t30" ON "rs_table_75_0"."i_brand_id" = "t30"."i_brand_id" AND "rs_table_75_0"."i_class_id" = "t30"."i_class_id" AND "rs_table_75_0"."i_category_id" = "t30"."i_category_id" AND "rs_table_75_0"."i_manufact_id" = "t30"."i_manufact_id" AND "rs_table_75_0"."CAST" / "t30"."CAST" < 0.9
ORDER BY "rs_table_75_0"."sales_cnt" - "t30"."sales_cnt", "rs_table_75_0"."sales_amt" - "t30"."sales_amt"
LIMIT 100
;

...
;
CREATE TABLE rs_table_04_1 AS SELECT "t13"."customer_id", "t13"."customer_id0", "t13"."customer_first_name0", "t13"."customer_last_name0", "t13"."customer_preferred_cust_flag0", "t16"."year_total" AS "year_total3", "t13"."CASE", "t16".">"
...
INNER JOIN (SELECT "customer_id", "year_total", "year_total" > 0 AS ">"
FROM "rs_table_04_0"
WHERE "sale_type" = 'w' AND "dyear" = 2001 AND "year_total" > 0) AS "t16" ON "t13"."customer_id" = "t16"."customer_id"
;
SELECT "rs_table_04_1"."customer_id0" AS "customer_id", "rs_table_04_1"."customer_first_name0" AS "customer_first_name", "rs_table_04_1"."customer_last_name0" AS "customer_last_name", "rs_table_04_1"."customer_preferred_cust_flag0" AS "customer_preferred_cust_flag"
FROM "rs_table_04_1"
INNER JOIN (SELECT "customer_id", "year_total"
FROM (SELECT *
FROM (SELECT "t1"."c_customer_id" AS "customer_id", "t1"."c_first_name" AS "customer_first_name", "t1"."c_last_name" AS "customer_last_name", "t1"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t1"."c_birth_country" AS "customer_birth_country", "t1"."c_login" AS "customer_login", "t1"."c_email_address" AS "customer_email_address", "t2"."d_year" AS "dyear", SUM("t1"."/") AS "year_total", 's' AS "sale_type"
...
WHERE "sale_type" = 'w' AND "dyear" = 2001 + 1) AS "t24" ON "rs_table_04_1"."customer_id" = "t24"."customer_id" AND "rs_table_04_1"."CASE" > CASE WHEN "rs_table_04_1".">" THEN CAST("t24"."year_total" / "rs_table_04_1"."year_total3" AS DECIMAL(19, 0)) ELSE NULL END
ORDER BY "rs_table_04_1"."customer_id0" NULLS FIRST, "rs_table_04_1"."customer_first_name0" NULLS FIRST, "rs_table_04_1"."customer_last_name0" NULLS FIRST, "rs_table_04_1"."customer_preferred_cust_flag0" NULLS FIRST
LIMIT 100
;

CREATE TABLE rs_table_31_0 AS SELECT "t2"."ca_county", SUM("t1"."ws_ext_sales_price") * 1.0000 AS """*"""
...
HAVING "t1"."d_qoy" = 3 AND "t1"."d_year" = 2000
;
SELECT "t43"."ca_county", "t43"."d_year", "t43"."/" AS "web_q1_q2_increase", "t43"."/5" AS "store_q1_q2_increase", "rs_table_31_0"."""*""" / "t43"."web_sales0" AS "web_q2_q3_increase", "t43"."/6" AS "store_q2_q3_increase"
...
INNER JOIN "rs_table_31_0" ON "t43"."ca_county2" = "rs_table_31_0"."ca_county" AND CASE WHEN "t43".">" THEN CAST("rs_table_31_0"."""*""" / "t43"."web_sales0" AS DECIMAL(19, 4)) ELSE NULL END > "t43"."CASE"

CREATE TABLE rs_table_73_0 AS SELECT "c_customer_sk", "c_salutation", "c_first_name", "c_last_name", "c_preferred_cust_flag"
FROM customer
;
SELECT "rs_table_73_0"."c_last_name", "rs_table_73_0"."c_first_name", "rs_table_73_0"."c_salutation", "rs_table_73_0"."c_preferred_cust_flag", "t13"."ss_ticket_number", "t13"."cnt"
...
HAVING COUNT(*) >= 1 AND COUNT(*) <= 5) AS "t13"
INNER JOIN "rs_table_73_0" ON "t13"."ss_customer_sk" = "rs_table_73_0"."c_customer_sk"
ORDER BY "t13"."cnt" DESC NULLS LAST, "rs_table_73_0"."c_last_name"
;

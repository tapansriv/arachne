CREATE TABLE rs_table_84_0 AS SELECT "t5"."c_customer_id", "t5"."c_first_name", "t5"."c_last_name", "t5"."cd_demo_sk", "t6"."hd_income_band_sk"
...
FROM household_demographics) AS "t6" ON "t5"."c_current_hdemo_sk" = "t6"."hd_demo_sk"
;
SELECT "t2"."c_customer_id" AS "customer_id", "t2"."||" AS "customername"
FROM (SELECT "rs_table_84_0"."c_customer_id", "rs_table_84_0"."cd_demo_sk", "rs_table_84_0"."c_last_name" || ', ' || "rs_table_84_0"."c_first_name" AS "||"
FROM "rs_table_84_0"
INNER JOIN (SELECT "ib_income_band_sk"
FROM income_band
WHERE "ib_lower_bound" >= 38128 AND "ib_upper_bound" <= 38128 + 50000) AS "t0" ON "rs_table_84_0"."hd_income_band_sk" = "t0"."ib_income_band_sk") AS "t2"
INNER JOIN (SELECT "sr_cdemo_sk"
FROM store_returns) AS "t3" ON "t2"."cd_demo_sk" = "t3"."sr_cdemo_sk"

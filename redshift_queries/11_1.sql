...
;
CREATE TABLE rs_table_11_1 AS SELECT "t5"."customer_id", "t5"."customer_id0", "t5"."customer_first_name0", "t5"."customer_last_name0", "t5"."customer_preferred_cust_flag0", "t8"."year_total" AS "year_total1", "t8".">", CASE WHEN "t5".">" THEN "t5"."/" ELSE 0.0 END AS "CASE"
...
FROM "rs_table_11_0"
WHERE "sale_type" = 'w' AND "dyear" = 2001 AND "year_total" > 0) AS "t8" ON "t5"."customer_id" = "t8"."customer_id"
;
SELECT "rs_table_11_1"."customer_id0" AS "customer_id", "rs_table_11_1"."customer_first_name0" AS "customer_first_name", "rs_table_11_1"."customer_last_name0" AS "customer_last_name", "rs_table_11_1"."customer_preferred_cust_flag0" AS "customer_preferred_cust_flag"
FROM "rs_table_11_1"
...
WHERE "sale_type" = 'w' AND "dyear" = 2001 + 1) AS "t16" ON "rs_table_11_1"."customer_id" = "t16"."customer_id" AND CASE WHEN "rs_table_11_1".">" THEN "t16"."""*""" / "rs_table_11_1"."year_total1" ELSE 0.0 END > "rs_table_11_1"."CASE"
ORDER BY "rs_table_11_1"."customer_id0" NULLS FIRST, "rs_table_11_1"."customer_first_name0" NULLS FIRST, "rs_table_11_1"."customer_last_name0" NULLS FIRST, "rs_table_11_1"."customer_preferred_cust_flag0" NULLS FIRST
LIMIT 100
;

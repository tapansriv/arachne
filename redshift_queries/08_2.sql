CREATE TABLE rs_table_08_0 AS SELECT "t3"."ss_net_profit", "t4"."s_store_name", "t4"."SUBSTRING"
...
;
SELECT "rs_table_08_0"."s_store_name", SUM("rs_table_08_0"."ss_net_profit")
FROM "rs_table_08_0"
...
GROUP BY "t2"."ca_zip"
HAVING COUNT(*) > 10) AS "t10") AS "t12" ON "rs_table_08_0"."SUBSTRING" = "t12"."SUBSTRING"
GROUP BY "rs_table_08_0"."s_store_name"
ORDER BY "rs_table_08_0"."s_store_name"
LIMIT 100
;

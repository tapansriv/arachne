CREATE TABLE rs_table_88_0 AS SELECT COUNT(*) AS "h11_30_to_12"
FROM store_sales
INNER JOIN (SELECT *
...
INNER JOIN (SELECT *
FROM time_dim
WHERE "t_hour" = 11 AND "t_minute" >= 30) AS "t0" ON "store_sales"."ss_sold_time_sk" = "t0"."t_time_sk"
INNER JOIN (SELECT *
FROM store
...
INNER JOIN (SELECT *
FROM time_dim
WHERE "t_hour" = 12 AND "t_minute" < 30) AS "t24" ON "store_sales5"."ss_sold_time_sk" = "t24"."t_time_sk"
INNER JOIN (SELECT *
FROM store

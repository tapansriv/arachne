CREATE TABLE rs_table_27_0 AS SELECT "t7"."ss_item_sk", "t7"."ss_quantity", "t7"."ss_list_price", "t7"."ss_sales_price", "t7"."ss_coupon_amt"
...
FROM store
WHERE "s_state" = 'TN') AS "t10" ON "t7"."ss_store_sk" = "t10"."s_store_sk"
;
SELECT *
FROM (SELECT *
...
UNION ALL
SELECT NULL AS "i_item_id", NULL AS "s_state", 1 AS "g_state", AVG("rs_table_27_0"."ss_quantity") AS "agg1", AVG("rs_table_27_0"."ss_list_price") AS "agg2", AVG("rs_table_27_0"."ss_coupon_amt") AS "agg3", AVG("rs_table_27_0"."ss_sales_price") AS "agg4"
FROM "rs_table_27_0"
INNER JOIN (SELECT "i_item_sk"
FROM item) AS "t33" ON "rs_table_27_0"."ss_item_sk" = "t33"."i_item_sk") AS "t37"

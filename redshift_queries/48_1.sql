CREATE TABLE rs_table_48_0 AS SELECT "t5"."ss_quantity"
...
FROM customer_demographics) AS "t2" ON "t1"."ss_cdemo_sk" = "t2"."cd_demo_sk" AND "t2"."=" AND "t2"."=2" AND "t1"."SEARCH" OR "t1"."ss_cdemo_sk" = "t2"."cd_demo_sk" AND "t2"."=3" AND "t2"."=4" AND "t1"."SEARCH8" OR "t1"."ss_cdemo_sk" = "t2"."cd_demo_sk" AND "t2"."=5" AND "t2"."=6" AND "t1"."SEARCH9") AS "t3"
...
FROM customer_address) AS "t4" ON "t3"."ss_addr_sk" = "t4"."ca_address_sk" AND "t4"."=" AND "t4"."SEARCH" AND "t3"."SEARCH" OR "t3"."ss_addr_sk" = "t4"."ca_address_sk" AND "t4"."=" AND "t4"."SEARCH3" AND "t3"."SEARCH4" OR "t3"."ss_addr_sk" = "t4"."ca_address_sk" AND "t4"."=" AND "t4"."SEARCH4" AND "t3"."SEARCH5") AS "t5"

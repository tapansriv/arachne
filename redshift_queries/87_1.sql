CREATE TABLE rs_table_87_0 AS SELECT *
...
FROM customer) AS "t4" ON "t3"."ss_customer_sk" = "t4"."c_customer_sk"
...
INNER JOIN (SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM customer) AS "t12" ON "t11"."cs_bill_customer_sk" = "t12"."c_customer_sk"
GROUP BY "t12"."c_last_name", "t12"."c_first_name", "t11"."d_date")
EXCEPT
...
INNER JOIN (SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM customer) AS "t21" ON "t20"."ws_bill_customer_sk" = "t21"."c_customer_sk"

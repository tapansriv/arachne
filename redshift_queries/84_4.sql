CREATE TABLE rs_table_84_0 AS SELECT "ib_income_band_sk"
FROM income_band
...
INNER JOIN "rs_table_84_0" ON "t7"."hd_income_band_sk" = "rs_table_84_0"."ib_income_band_sk") AS "t9"
INNER JOIN (SELECT "sr_cdemo_sk"
FROM store_returns) AS "t10" ON "t9"."cd_demo_sk" = "t10"."sr_cdemo_sk"

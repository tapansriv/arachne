CREATE TABLE rs_table_84_0 AS SELECT "t7"."c_customer_id", "t7"."cd_demo_sk", "t7"."c_last_name" || ', ' || "t7"."c_first_name" AS "||"
...
;
SELECT "rs_table_84_0"."c_customer_id" AS "customer_id", "rs_table_84_0"."||" AS "customername"
FROM "rs_table_84_0"
INNER JOIN (SELECT "sr_cdemo_sk"
FROM store_returns) AS "t" ON "rs_table_84_0"."cd_demo_sk" = "t"."sr_cdemo_sk"
ORDER BY "rs_table_84_0"."c_customer_id" NULLS FIRST
LIMIT 100
;

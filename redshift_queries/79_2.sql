CREATE TABLE rs_table_79_0 AS SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM customer
;
SELECT "rs_table_79_0"."c_last_name", "rs_table_79_0"."c_first_name", "t14"."SUBSTRING", "t14"."ss_ticket_number", "t14"."amt", "t14"."profit"
FROM (SELECT "t7"."ss_ticket_number", "t7"."ss_customer_sk", SUM("t7"."ss_coupon_amt") AS "amt", SUM("t7"."ss_net_profit") AS "profit", SUBSTRING("t7"."s_city" FROM 1 FOR 30) AS "SUBSTRING"
...
INNER JOIN "rs_table_79_0" ON "t14"."ss_customer_sk" = "rs_table_79_0"."c_customer_sk"
ORDER BY "rs_table_79_0"."c_last_name" NULLS FIRST, "rs_table_79_0"."c_first_name" NULLS FIRST, "t14"."SUBSTRING" NULLS FIRST, "t14"."profit" NULLS FIRST
LIMIT 100
;

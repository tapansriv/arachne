CREATE TABLE rs_table_18_0 AS SELECT "t17"."CAST" AS "agg1", "t17"."CAST2" AS "agg2", "t17"."CAST3" AS "agg3", "t17"."CAST4" AS "agg4", "t17"."CAST5" AS "agg5", "t17"."CAST6" AS "agg6", "t17"."CAST7" AS "agg7"
...
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM item) AS "t86" ON "t85"."cs_item_sk" = "t86"."i_item_sk"
GROUP BY "t86"."i_item_id")
UNION ALL
SELECT NULL AS "i_item_id", NULL AS "ca_country", NULL AS "ca_state", NULL AS "county", AVG("agg1") AS "agg1", AVG("agg2") AS "agg2", AVG("agg3") AS "agg3", AVG("agg4") AS "agg4", AVG("agg5") AS "agg5", AVG("agg6") AS "agg6", AVG("agg7") AS "agg7"
FROM "rs_table_18_0") AS "t93"

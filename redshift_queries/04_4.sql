CREATE TABLE rs_table_04_0 AS SELECT "customer_id", "year_total", "year_total" > 0 AS ">"
FROM (SELECT *
...
;
SELECT "t107"."customer_id0" AS "customer_id", "t107"."customer_first_name0" AS "customer_first_name", "t107"."customer_last_name0" AS "customer_last_name", "t107"."customer_preferred_cust_flag0" AS "customer_preferred_cust_flag"
FROM (SELECT "t105"."customer_id", "t105"."customer_id0", "t105"."customer_first_name0", "t105"."customer_last_name0", "t105"."customer_preferred_cust_flag0", "rs_table_04_0"."year_total" AS "year_total3", "t105"."CASE", "rs_table_04_0".">"
...
INNER JOIN "rs_table_04_0" ON "t105"."customer_id" = "rs_table_04_0"."customer_id") AS "t107"
INNER JOIN (SELECT "customer_id", "year_total"
FROM (SELECT *
FROM (SELECT "t110"."c_customer_id" AS "customer_id", "t110"."c_first_name" AS "customer_first_name", "t110"."c_last_name" AS "customer_last_name", "t110"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t110"."c_birth_country" AS "customer_birth_country", "t110"."c_login" AS "customer_login", "t110"."c_email_address" AS "customer_email_address", "t111"."d_year" AS "dyear", SUM("t110"."/") AS "year_total", 's' AS "sale_type"
FROM (SELECT "t108"."c_customer_id", "t108"."c_first_name", "t108"."c_last_name", "t108"."c_preferred_cust_flag", "t108"."c_birth_country", "t108"."c_login", "t108"."c_email_address", "t109"."ss_sold_date_sk", "t109"."/"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t108"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM store_sales) AS "t109" ON "t108"."c_customer_sk" = "t109"."ss_customer_sk") AS "t110"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t111" ON "t110"."ss_sold_date_sk" = "t111"."d_date_sk"
GROUP BY "t110"."c_customer_id", "t110"."c_first_name", "t110"."c_last_name", "t110"."c_preferred_cust_flag", "t110"."c_birth_country", "t110"."c_login", "t110"."c_email_address", "t111"."d_year"
UNION ALL
SELECT "t117"."c_customer_id" AS "customer_id", "t117"."c_first_name" AS "customer_first_name", "t117"."c_last_name" AS "customer_last_name", "t117"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t117"."c_birth_country" AS "customer_birth_country", "t117"."c_login" AS "customer_login", "t117"."c_email_address" AS "customer_email_address", "t118"."d_year" AS "dyear", SUM("t117"."/") AS "year_total", 'c' AS "sale_type"
FROM (SELECT "t115"."c_customer_id", "t115"."c_first_name", "t115"."c_last_name", "t115"."c_preferred_cust_flag", "t115"."c_birth_country", "t115"."c_login", "t115"."c_email_address", "t116"."cs_sold_date_sk", "t116"."/"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t115"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM catalog_sales) AS "t116" ON "t115"."c_customer_sk" = "t116"."cs_bill_customer_sk") AS "t117"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t118" ON "t117"."cs_sold_date_sk" = "t118"."d_date_sk"
GROUP BY "t117"."c_customer_id", "t117"."c_first_name", "t117"."c_last_name", "t117"."c_preferred_cust_flag", "t117"."c_birth_country", "t117"."c_login", "t117"."c_email_address", "t118"."d_year")
UNION ALL
SELECT "t125"."c_customer_id" AS "customer_id", "t125"."c_first_name" AS "customer_first_name", "t125"."c_last_name" AS "customer_last_name", "t125"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t125"."c_birth_country" AS "customer_birth_country", "t125"."c_login" AS "customer_login", "t125"."c_email_address" AS "customer_email_address", "t126"."d_year" AS "dyear", SUM("t125"."/") AS "year_total", 'w' AS "sale_type"
FROM (SELECT "t123"."c_customer_id", "t123"."c_first_name", "t123"."c_last_name", "t123"."c_preferred_cust_flag", "t123"."c_birth_country", "t123"."c_login", "t123"."c_email_address", "t124"."ws_sold_date_sk", "t124"."/"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t123"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM web_sales) AS "t124" ON "t123"."c_customer_sk" = "t124"."ws_bill_customer_sk") AS "t125"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t126" ON "t125"."ws_sold_date_sk" = "t126"."d_date_sk"
GROUP BY "t125"."c_customer_id", "t125"."c_first_name", "t125"."c_last_name", "t125"."c_preferred_cust_flag", "t125"."c_birth_country", "t125"."c_login", "t125"."c_email_address", "t126"."d_year") AS "t130"
WHERE "sale_type" = 'w' AND "dyear" = 2001 + 1) AS "t133" ON "t107"."customer_id" = "t133"."customer_id" AND "t107"."CASE" > CASE WHEN "t107".">" THEN CAST("t133"."year_total" / "t107"."year_total3" AS DECIMAL(19, 0)) ELSE NULL END
ORDER BY "t107"."customer_id0" NULLS FIRST, "t107"."customer_first_name0" NULLS FIRST, "t107"."customer_last_name0" NULLS FIRST, "t107"."customer_preferred_cust_flag0" NULLS FIRST
LIMIT 100
;

...
HAVING "d_year" = 2002 - 1
;
SELECT "rs_table_75_0"."d_year" AS "prev_year", "t30"."d_year" AS "year_", "t30"."i_brand_id", "t30"."i_class_id", "t30"."i_category_id", "t30"."i_manufact_id", "rs_table_75_0"."sales_cnt" AS "prev_yr_cnt", "t30"."sales_cnt" AS "curr_yr_cnt", "t30"."sales_cnt" - "rs_table_75_0"."sales_cnt" AS "sales_cnt_diff", "t30"."sales_amt" - "rs_table_75_0"."sales_amt" AS "sales_amt_diff"
...
INNER JOIN "rs_table_75_0" ON "t30"."i_brand_id" = "rs_table_75_0"."i_brand_id" AND "t30"."i_class_id" = "rs_table_75_0"."i_class_id" AND "t30"."i_category_id" = "rs_table_75_0"."i_category_id" AND "t30"."i_manufact_id" = "rs_table_75_0"."i_manufact_id" AND "t30"."CAST" / "rs_table_75_0"."CAST" < 0.9
ORDER BY "t30"."sales_cnt" - "rs_table_75_0"."sales_cnt", "t30"."sales_amt" - "rs_table_75_0"."sales_amt"
LIMIT 100
;

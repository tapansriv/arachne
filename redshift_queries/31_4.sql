CREATE TABLE rs_table_31_0 AS SELECT "t2"."ca_county", SUM("t1"."ws_ext_sales_price") AS "web_sales", SUM("t1"."ws_ext_sales_price") * 1.0000 AS """*""", SUM("t1"."ws_ext_sales_price") > 0 AS ">"
...
FROM (SELECT "t33"."ca_county", "t33"."d_year", "t33"."ca_county2", "rs_table_31_0"."web_sales" AS "web_sales0", "rs_table_31_0"."""*""" / "t33"."web_sales" AS "/", "t33"."/" AS "/5", "t33"."/5" AS "/6", "rs_table_31_0".">", "t33"."CASE"
...
INNER JOIN "rs_table_31_0" ON "t33"."ca_county2" = "rs_table_31_0"."ca_county" AND CASE WHEN "t33".">" THEN "rs_table_31_0"."""*""" / "t33"."web_sales" ELSE NULL END > "t33"."CASE8") AS "t35"
...
INNER JOIN (SELECT "d_date_sk", "d_year", "d_qoy"
FROM date_dim) AS "t37" ON "t36"."ws_sold_date_sk" = "t37"."d_date_sk") AS "t38"
INNER JOIN (SELECT "ca_address_sk", "ca_county"
FROM customer_address) AS "t39" ON "t38"."ws_bill_addr_sk" = "t39"."ca_address_sk"

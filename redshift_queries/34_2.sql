CREATE TABLE rs_table_34_0 AS SELECT "c_customer_sk", "c_salutation", "c_first_name", "c_last_name", "c_preferred_cust_flag"
FROM customer
;
SELECT "rs_table_34_0"."c_last_name", "rs_table_34_0"."c_first_name", "rs_table_34_0"."c_salutation", "rs_table_34_0"."c_preferred_cust_flag", "t13"."ss_ticket_number", "t13"."cnt"
...
INNER JOIN "rs_table_34_0" ON "t13"."ss_customer_sk" = "rs_table_34_0"."c_customer_sk"
ORDER BY "rs_table_34_0"."c_last_name" NULLS FIRST, "rs_table_34_0"."c_first_name" NULLS FIRST, "rs_table_34_0"."c_salutation" NULLS FIRST, "rs_table_34_0"."c_preferred_cust_flag" DESC, "t13"."ss_ticket_number" NULLS FIRST
;

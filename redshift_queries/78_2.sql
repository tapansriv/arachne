CREATE TABLE rs_table_78_0 AS SELECT "t2"."d_year" AS "cs_sold_year", "t1"."cs_item_sk", "t1"."cs_bill_customer_sk" AS "cs_customer_sk", SUM("t1"."cs_quantity") AS "cs_qty", SUM("t1"."cs_wholesale_cost") AS "cs_wc", SUM("t1"."cs_sales_price") AS "cs_sp"
...
GROUP BY "t2"."d_year", "t1"."cs_item_sk", "t1"."cs_bill_customer_sk"
;
SELECT "t5"."ss_sold_year", "t5"."ss_item_sk", "t5"."ss_customer_sk", ROUND("t5"."ss_qty" * 1.00 / (CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS INTEGER) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_qty" IS NOT NULL THEN CAST("rs_table_78_0"."cs_qty" AS INTEGER) ELSE 0 END), 2) AS "ratio", "t5"."ss_qty" AS "store_qty", "t5"."ss_wc" AS "store_wholesale_cost", "t5"."ss_sp" AS "store_sales_price", CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS INTEGER) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_qty" IS NOT NULL THEN CAST("rs_table_78_0"."cs_qty" AS INTEGER) ELSE 0 END AS "other_chan_qty", CASE WHEN "t11"."ws_wc" IS NOT NULL THEN CAST("t11"."ws_wc" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_wc" IS NOT NULL THEN CAST("rs_table_78_0"."cs_wc" AS DECIMAL(19, 0)) ELSE 0 END AS "other_chan_wholesale_cost", CASE WHEN "t11"."ws_sp" IS NOT NULL THEN CAST("t11"."ws_sp" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_sp" IS NOT NULL THEN CAST("rs_table_78_0"."cs_sp" AS DECIMAL(19, 0)) ELSE 0 END AS "other_chan_sales_price"
...
LEFT JOIN "rs_table_78_0" ON "t5"."ss_sold_year" = "rs_table_78_0"."cs_sold_year" AND "t5"."ss_item_sk" = "rs_table_78_0"."cs_item_sk" AND "t5"."ss_customer_sk" = "rs_table_78_0"."cs_customer_sk"
WHERE CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS INTEGER) ELSE 0 END > 0 OR CASE WHEN "rs_table_78_0"."cs_qty" IS NOT NULL THEN CAST("rs_table_78_0"."cs_qty" AS INTEGER) ELSE 0 END > 0
ORDER BY "t5"."ss_sold_year", "t5"."ss_item_sk", "t5"."ss_customer_sk", "t5"."ss_qty" DESC NULLS LAST, "t5"."ss_wc" DESC NULLS LAST, "t5"."ss_sp" DESC NULLS LAST, CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS INTEGER) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_qty" IS NOT NULL THEN CAST("rs_table_78_0"."cs_qty" AS INTEGER) ELSE 0 END, CASE WHEN "t11"."ws_wc" IS NOT NULL THEN CAST("t11"."ws_wc" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_wc" IS NOT NULL THEN CAST("rs_table_78_0"."cs_wc" AS DECIMAL(19, 0)) ELSE 0 END, CASE WHEN "t11"."ws_sp" IS NOT NULL THEN CAST("t11"."ws_sp" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_sp" IS NOT NULL THEN CAST("rs_table_78_0"."cs_sp" AS DECIMAL(19, 0)) ELSE 0 END, ROUND("t5"."ss_qty" * 1.00 / (CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS INTEGER) ELSE 0 END + CASE WHEN "rs_table_78_0"."cs_qty" IS NOT NULL THEN CAST("rs_table_78_0"."cs_qty" AS INTEGER) ELSE 0 END), 2)
LIMIT 100
;

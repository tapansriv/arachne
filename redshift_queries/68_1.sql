CREATE TABLE rs_table_68_0 AS SELECT "t15"."ss_ticket_number", "t15"."bought_city", "t15"."extended_price", "t15"."list_price", "t15"."extended_tax", "t16"."c_current_addr_sk", "t16"."c_first_name", "t16"."c_last_name"
...
;
SELECT "rs_table_68_0"."c_last_name", "rs_table_68_0"."c_first_name", "t"."ca_city", "rs_table_68_0"."bought_city", "rs_table_68_0"."ss_ticket_number", "rs_table_68_0"."extended_price", "rs_table_68_0"."extended_tax", "rs_table_68_0"."list_price"
FROM "rs_table_68_0"
INNER JOIN (SELECT "ca_address_sk", "ca_city"
FROM customer_address) AS "t" ON "rs_table_68_0"."c_current_addr_sk" = "t"."ca_address_sk" AND "t"."ca_city" <> "rs_table_68_0"."bought_city"
ORDER BY "rs_table_68_0"."c_last_name" NULLS FIRST, "rs_table_68_0"."ss_ticket_number" NULLS FIRST
LIMIT 100
;

...
public class ArachneSchema extends AbstractSchema {

    private final String schemaName;
    private final Map<String, Table> tableMap;

    private ArachneSchema(String schemaName, Map<String, Table> tableMap) {
    ...
    public static final class Builder {
        ...
        public Builder addTable(ArachneTable table) {
        ...
        public ArachneSchema build() {
            return new ArachneSchema(schemaName, tableMap);
        }
    }
}

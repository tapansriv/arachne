 ...
 */
public class ArachneRelWriter implements RelWriter {
    //~ Instance fields --------------------------------------------------------
    ...
    public ArachneRelWriter(PrintWriter pw) {
        this(pw, SqlExplainLevel.EXPPLAN_ATTRIBUTES, true);
    }

    public ArachneRelWriter(
    ...
    protected void explain_(RelNode rel,
        ...
        ProfileRel pr = (ProfileRel)rel;
        switch (detailLevel) {
            case ALL_ATTRIBUTES:
                s.append(": rowcount = ")
                        .append(pr.getCardinality())
                        .append(", timing = ")
                        .append(pr.getTiming())
                        .append(", opportunity = ")
                        .append(pr.getOpportunity())
                        .append(", arachneId = ")
                        .append(pr.getArachneID());
                break;
            default:
                break;
        }
            ...
            case ALL_ATTRIBUTES:
                if (!withIdPrefix) {
                    ...
                    s.append(", id = ").append(rel.getId())
                            .append(", arachneId = ").append(((ProfileRel) rel).getArachneID());
                }
                break;
            default:
                break;

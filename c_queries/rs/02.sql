...
FROM (SELECT "t13"."d_week_seq", SUM(CASE WHEN "t13"."=" THEN "t12"."sales_price" ELSE NULL END) AS "sun_sales", SUM(CASE WHEN "t13"."=3" THEN "t12"."sales_price" ELSE NULL END) AS "mon_sales", SUM(CASE WHEN "t13"."=4" THEN "t12"."sales_price" ELSE NULL END) AS "tue_sales", SUM(CASE WHEN "t13"."=5" THEN "t12"."sales_price" ELSE NULL END) AS "wed_sales", SUM(CASE WHEN "t13"."=6" THEN "t12"."sales_price" ELSE NULL END) AS "thu_sales", SUM(CASE WHEN "t13"."=7" THEN "t12"."sales_price" ELSE NULL END) AS "fri_sales", SUM(CASE WHEN "t13"."=8" THEN "t12"."sales_price" ELSE NULL END) AS "sat_sales"
FROM (SELECT "ws_sold_date_sk" AS "sold_date_sk", "ws_ext_sales_price" AS "sales_price"
FROM web_sales
UNION ALL
SELECT "cs_sold_date_sk" AS "sold_date_sk", "cs_ext_sales_price" AS "sales_price"

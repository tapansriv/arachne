...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t134"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM store_sales) AS "t135" ON "t134"."c_customer_sk" = "t135"."ss_customer_sk") AS "t136"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t137" ON "t136"."ss_sold_date_sk" = "t137"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t141"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM catalog_sales) AS "t142" ON "t141"."c_customer_sk" = "t142"."cs_bill_customer_sk") AS "t143"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t144" ON "t143"."cs_sold_date_sk" = "t144"."d_date_sk"
GROUP BY "t143"."c_customer_id", "t143"."c_first_name", "t143"."c_last_name", "t143"."c_preferred_cust_flag", "t143"."c_birth_country", "t143"."c_login", "t143"."c_email_address", "t144"."d_year")
UNION ALL
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t149"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM web_sales) AS "t150" ON "t149"."c_customer_sk" = "t150"."ws_bill_customer_sk") AS "t151"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t152" ON "t151"."ws_sold_date_sk" = "t152"."d_date_sk"

...
FROM (SELECT "t10"."d_week_seq", "t9"."ss_store_sk", SUM(CASE WHEN "t10"."=" THEN "t9"."ss_sales_price" ELSE NULL END) AS "sun_sales", SUM(CASE WHEN "t10"."=3" THEN "t9"."ss_sales_price" ELSE NULL END) AS "mon_sales", SUM(CASE WHEN "t10"."=4" THEN "t9"."ss_sales_price" ELSE NULL END) AS "tue_sales", SUM(CASE WHEN "t10"."=5" THEN "t9"."ss_sales_price" ELSE NULL END) AS "wed_sales", SUM(CASE WHEN "t10"."=6" THEN "t9"."ss_sales_price" ELSE NULL END) AS "thu_sales", SUM(CASE WHEN "t10"."=7" THEN "t9"."ss_sales_price" ELSE NULL END) AS "fri_sales", SUM(CASE WHEN "t10"."=8" THEN "t9"."ss_sales_price" ELSE NULL END) AS "sat_sales"
FROM (SELECT "ss_sold_date_sk", "ss_store_sk", "ss_sales_price"

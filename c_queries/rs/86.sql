...
GROUP BY "t16"."i_category")
UNION
SELECT SUM(SUM("t24"."ws_net_paid")) AS "total_sum", NULL AS "i_category", NULL AS "i_class", 1 AS "g_category", 1 AS "g_class", 2 AS "lochierarchy"
...
GROUP BY "t25"."i_category", "t25"."i_class") AS "t31"

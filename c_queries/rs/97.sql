SELECT CAST(COUNT(CASE WHEN "t4"."customer_sk" IS NOT NULL AND "t10"."customer_sk" IS NULL THEN 1 ELSE NULL END) AS INTEGER) AS "store_only", CAST(COUNT(CASE WHEN "t4"."customer_sk" IS NULL AND "t10"."customer_sk" IS NOT NULL THEN 1 ELSE NULL END) AS INTEGER) AS "catalog_only", CAST(COUNT(CASE WHEN "t4"."customer_sk" IS NOT NULL AND "t10"."customer_sk" IS NOT NULL THEN 1 ELSE NULL END) AS INTEGER) AS "store_and_catalog"

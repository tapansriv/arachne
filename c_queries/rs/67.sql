...
GROUP BY "t20"."i_category", "t20"."i_class", "t20"."i_brand", "t20"."i_product_name", "t20"."d_year", "t20"."d_qoy", "t20"."d_moy")
UNION ALL
...
GROUP BY "t34"."i_category", "t34"."i_class", "t34"."i_brand", "t34"."i_product_name", "t34"."d_year", "t34"."d_qoy")
UNION ALL
...
GROUP BY "t48"."i_category", "t48"."i_class", "t48"."i_brand", "t48"."i_product_name", "t48"."d_year")
UNION ALL
...
GROUP BY "t62"."i_category", "t62"."i_class", "t62"."i_brand", "t62"."i_product_name")
UNION ALL
...
GROUP BY "t76"."i_category", "t76"."i_class", "t76"."i_brand")
UNION ALL
...
GROUP BY "t90"."i_category", "t90"."i_class")
UNION ALL
...
GROUP BY "t104"."i_category")
UNION ALL
SELECT NULL AS "i_category", NULL AS "i_class", NULL AS "i_brand", NULL AS "i_product_name", NULL AS "d_year", NULL AS "d_qoy", NULL AS "d_moy", NULL AS "s_store_id", SUM(SUM("t114"."""*""")) AS "sumsales"
...
GROUP BY "t115"."i_category", "t115"."i_class", "t115"."i_brand", "t115"."i_product_name", "t114"."d_year", "t114"."d_qoy", "t114"."d_moy", "t114"."s_store_id") AS "t121") AS "t122"
WHERE "rk" <= 100

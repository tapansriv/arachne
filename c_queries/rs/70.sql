...
GROUP BY "t32"."s_state")
UNION
SELECT SUM(SUM("t40"."ss_net_profit")) AS "total_sum", NULL AS "s_state", NULL AS "s_county", 1 AS "g_state", 1 AS "g_county", 2 AS "lochierarchy"
...
GROUP BY "t49"."s_state", "t49"."s_county") AS "t55"

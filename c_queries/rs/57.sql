...
FROM item) AS "t9"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_call_center_sk", "cs_item_sk", "cs_sales_price"
FROM catalog_sales) AS "t10" ON "t9"."i_item_sk" = "t10"."cs_item_sk") AS "t11"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy"
FROM date_dim
...
INNER JOIN (SELECT "cc_call_center_sk", "cc_name"
FROM call_center) AS "t15" ON "t14"."cs_call_center_sk" = "t15"."cc_call_center_sk"
...
FROM item) AS "t21"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_call_center_sk", "cs_item_sk", "cs_sales_price"
FROM catalog_sales) AS "t22" ON "t21"."i_item_sk" = "t22"."cs_item_sk") AS "t23"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy"
FROM date_dim
...
INNER JOIN (SELECT "cc_call_center_sk", "cc_name"
FROM call_center) AS "t27" ON "t26"."cs_call_center_sk" = "t27"."cc_call_center_sk"

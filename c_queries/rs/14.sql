...
LEFT JOIN (SELECT SINGLE_VALUE(AVG("quantity" * "list_price")) AS "$f0"
FROM (SELECT *
...
WHERE "web_sales0"."ws_sold_date_sk" = "date_dim5"."d_date_sk" AND "date_dim5"."d_year" >= 1999 AND "date_dim5"."d_year" <= 1999 + 2) AS "t33") AS "t37" ON TRUE
...
WHERE "web_sales2"."ws_sold_date_sk" = "date_dim12"."d_date_sk" AND "date_dim12"."d_year" >= 1999 AND "date_dim12"."d_year" <= 1999 + 2) AS "t75") AS "t79" ON TRUE
WHERE "t64"."sales" > "t79"."$f0")
UNION ALL
...
WHERE "web_sales5"."ws_sold_date_sk" = "date_dim19"."d_date_sk" AND "date_dim19"."d_year" >= 1999 AND "date_dim19"."d_year" <= 1999 + 2) AS "t118") AS "t122" ON TRUE
...
WHERE "catalog_sales6"."cs_item_sk" = "item16"."i_item_sk" AND "catalog_sales6"."cs_sold_date_sk" = "date_dim21"."d_date_sk" AND "date_dim21"."d_year" >= 1999 AND "date_dim21"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales7"."cs_sold_date_sk" = "date_dim25"."d_date_sk" AND "date_dim25"."d_year" >= 1999 AND "date_dim25"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales7"."ws_sold_date_sk" = "date_dim26"."d_date_sk" AND "date_dim26"."d_year" >= 1999 AND "date_dim26"."d_year" <= 1999 + 2) AS "t163") AS "t167" ON TRUE
...
WHERE "catalog_sales9"."cs_item_sk" = "item21"."i_item_sk" AND "catalog_sales9"."cs_sold_date_sk" = "date_dim28"."d_date_sk" AND "date_dim28"."d_year" >= 1999 AND "date_dim28"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales10"."cs_sold_date_sk" = "date_dim32"."d_date_sk" AND "date_dim32"."d_year" >= 1999 AND "date_dim32"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales9"."ws_sold_date_sk" = "date_dim33"."d_date_sk" AND "date_dim33"."d_year" >= 1999 AND "date_dim33"."d_year" <= 1999 + 2) AS "t205") AS "t209" ON TRUE
WHERE "t194"."sales" > "t209"."$f0")
UNION ALL
...
WHERE "catalog_sales11"."cs_item_sk" = "item26"."i_item_sk" AND "catalog_sales11"."cs_sold_date_sk" = "date_dim35"."d_date_sk" AND "date_dim35"."d_year" >= 1999 AND "date_dim35"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales12"."cs_sold_date_sk" = "date_dim39"."d_date_sk" AND "date_dim39"."d_year" >= 1999 AND "date_dim39"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales12"."ws_sold_date_sk" = "date_dim40"."d_date_sk" AND "date_dim40"."d_year" >= 1999 AND "date_dim40"."d_year" <= 1999 + 2) AS "t248") AS "t252" ON TRUE
...
WHERE "catalog_sales13"."cs_item_sk" = "item31"."i_item_sk" AND "catalog_sales13"."cs_sold_date_sk" = "date_dim42"."d_date_sk" AND "date_dim42"."d_year" >= 1999 AND "date_dim42"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales14"."cs_sold_date_sk" = "date_dim46"."d_date_sk" AND "date_dim46"."d_year" >= 1999 AND "date_dim46"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales14"."ws_sold_date_sk" = "date_dim47"."d_date_sk" AND "date_dim47"."d_year" >= 1999 AND "date_dim47"."d_year" <= 1999 + 2) AS "t296") AS "t300" ON TRUE
...
WHERE "catalog_sales16"."cs_item_sk" = "item36"."i_item_sk" AND "catalog_sales16"."cs_sold_date_sk" = "date_dim49"."d_date_sk" AND "date_dim49"."d_year" >= 1999 AND "date_dim49"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales17"."cs_sold_date_sk" = "date_dim53"."d_date_sk" AND "date_dim53"."d_year" >= 1999 AND "date_dim53"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales16"."ws_sold_date_sk" = "date_dim54"."d_date_sk" AND "date_dim54"."d_year" >= 1999 AND "date_dim54"."d_year" <= 1999 + 2) AS "t338") AS "t342" ON TRUE
WHERE "t327"."sales" > "t342"."$f0")
UNION ALL
...
WHERE "catalog_sales18"."cs_item_sk" = "item41"."i_item_sk" AND "catalog_sales18"."cs_sold_date_sk" = "date_dim56"."d_date_sk" AND "date_dim56"."d_year" >= 1999 AND "date_dim56"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales19"."cs_sold_date_sk" = "date_dim60"."d_date_sk" AND "date_dim60"."d_year" >= 1999 AND "date_dim60"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales19"."ws_sold_date_sk" = "date_dim61"."d_date_sk" AND "date_dim61"."d_year" >= 1999 AND "date_dim61"."d_year" <= 1999 + 2) AS "t381") AS "t385" ON TRUE
...
WHERE "catalog_sales20"."cs_item_sk" = "item46"."i_item_sk" AND "catalog_sales20"."cs_sold_date_sk" = "date_dim63"."d_date_sk" AND "date_dim63"."d_year" >= 1999 AND "date_dim63"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales21"."cs_sold_date_sk" = "date_dim67"."d_date_sk" AND "date_dim67"."d_year" >= 1999 AND "date_dim67"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales21"."ws_sold_date_sk" = "date_dim68"."d_date_sk" AND "date_dim68"."d_year" >= 1999 AND "date_dim68"."d_year" <= 1999 + 2) AS "t429") AS "t433" ON TRUE
...
WHERE "catalog_sales23"."cs_item_sk" = "item51"."i_item_sk" AND "catalog_sales23"."cs_sold_date_sk" = "date_dim70"."d_date_sk" AND "date_dim70"."d_year" >= 1999 AND "date_dim70"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales24"."cs_sold_date_sk" = "date_dim74"."d_date_sk" AND "date_dim74"."d_year" >= 1999 AND "date_dim74"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales23"."ws_sold_date_sk" = "date_dim75"."d_date_sk" AND "date_dim75"."d_year" >= 1999 AND "date_dim75"."d_year" <= 1999 + 2) AS "t471") AS "t475" ON TRUE
WHERE "t460"."sales" > "t475"."$f0")
UNION ALL
...
WHERE "catalog_sales25"."cs_item_sk" = "item56"."i_item_sk" AND "catalog_sales25"."cs_sold_date_sk" = "date_dim77"."d_date_sk" AND "date_dim77"."d_year" >= 1999 AND "date_dim77"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales26"."cs_sold_date_sk" = "date_dim81"."d_date_sk" AND "date_dim81"."d_year" >= 1999 AND "date_dim81"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales26"."ws_sold_date_sk" = "date_dim82"."d_date_sk" AND "date_dim82"."d_year" >= 1999 AND "date_dim82"."d_year" <= 1999 + 2) AS "t514") AS "t518" ON TRUE
WHERE "t503"."sales" > "t518"."$f0") AS "t522"
GROUP BY "channel", "i_brand_id", "i_class_id", "i_category_id") AS "t524"
GROUP BY "channel")
UNION
SELECT NULL AS "channel", NULL AS "i_brand_id", NULL AS "i_class_id", NULL AS "i_category_id", SUM(SUM("sales")) AS "EXPR$4", SUM(SUM("number_sales")) AS "EXPR$5"
FROM (SELECT *
...
WHERE "catalog_sales27"."cs_item_sk" = "item61"."i_item_sk" AND "catalog_sales27"."cs_sold_date_sk" = "date_dim84"."d_date_sk" AND "date_dim84"."d_year" >= 1999 AND "date_dim84"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales28"."cs_sold_date_sk" = "date_dim88"."d_date_sk" AND "date_dim88"."d_year" >= 1999 AND "date_dim88"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales28"."ws_sold_date_sk" = "date_dim89"."d_date_sk" AND "date_dim89"."d_year" >= 1999 AND "date_dim89"."d_year" <= 1999 + 2) AS "t562") AS "t566" ON TRUE
...
WHERE "catalog_sales30"."cs_item_sk" = "item66"."i_item_sk" AND "catalog_sales30"."cs_sold_date_sk" = "date_dim91"."d_date_sk" AND "date_dim91"."d_year" >= 1999 AND "date_dim91"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales31"."cs_sold_date_sk" = "date_dim95"."d_date_sk" AND "date_dim95"."d_year" >= 1999 AND "date_dim95"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales30"."ws_sold_date_sk" = "date_dim96"."d_date_sk" AND "date_dim96"."d_year" >= 1999 AND "date_dim96"."d_year" <= 1999 + 2) AS "t604") AS "t608" ON TRUE
WHERE "t593"."sales" > "t608"."$f0")
UNION ALL
...
WHERE "catalog_sales32"."cs_item_sk" = "item71"."i_item_sk" AND "catalog_sales32"."cs_sold_date_sk" = "date_dim98"."d_date_sk" AND "date_dim98"."d_year" >= 1999 AND "date_dim98"."d_year" <= 1999 + 2
INTERSECT
...
WHERE "catalog_sales33"."cs_sold_date_sk" = "date_dim102"."d_date_sk" AND "date_dim102"."d_year" >= 1999 AND "date_dim102"."d_year" <= 1999 + 2)
UNION ALL
...
WHERE "web_sales33"."ws_sold_date_sk" = "date_dim103"."d_date_sk" AND "date_dim103"."d_year" >= 1999 AND "date_dim103"."d_year" <= 1999 + 2) AS "t647") AS "t651" ON TRUE
WHERE "t636"."sales" > "t651"."$f0") AS "t655"
GROUP BY "channel", "i_brand_id", "i_class_id", "i_category_id") AS "t660"

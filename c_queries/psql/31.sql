...
FROM (SELECT "ws_sold_date_sk", "ws_bill_addr_sk", "ws_ext_sales_price"
FROM web_sales) AS "t44"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_qoy"
FROM date_dim) AS "t45" ON "t44"."ws_sold_date_sk" = "t45"."d_date_sk") AS "t46"
INNER JOIN (SELECT "ca_address_sk", "ca_county"
FROM customer_address) AS "t47" ON "t46"."ws_bill_addr_sk" = "t47"."ca_address_sk"

...
FROM item) AS "t45" ON "t44"."inv_item_sk" = "t45"."i_item_sk") AS "t46"
INNER JOIN (SELECT "w_warehouse_sk"
FROM warehouse) AS "t47" ON "t46"."inv_warehouse_sk" = "t47"."w_warehouse_sk") AS "t51"

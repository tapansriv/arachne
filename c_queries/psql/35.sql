...
FROM customer_address) AS "t15" ON "t14"."c_current_addr_sk" = "t15"."ca_address_sk") AS "t16"
INNER JOIN (SELECT "cd_demo_sk", "cd_gender", "cd_marital_status", "cd_dep_count", "cd_dep_employed_count", "cd_dep_college_count"
FROM customer_demographics) AS "t17" ON "t16"."c_current_cdemo_sk" = "t17"."cd_demo_sk"

...
FROM tpcds.sf1000.date_dim AS date_dim) AS "t4" ON "t3"."cs_sold_date_sk" = "t4"."d_date_sk") AS "t5"
...
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t6" ON "t5"."cs_order_number" = "t6"."cr_order_number" AND "t5"."cs_item_sk" = "t6"."cr_item_sk"
UNION
...
FROM tpcds.sf1000.store_sales AS store_sales) AS "t8"
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
FROM tpcds.sf1000.item AS item
WHERE "i_category" = 'Books') AS "t11" ON "t8"."ss_item_sk" = "t11"."i_item_sk") AS "t12"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t13" ON "t12"."ss_sold_date_sk" = "t13"."d_date_sk") AS "t14"
...
FROM tpcds.sf1000.store_returns AS store_returns) AS "t15" ON "t14"."ss_ticket_number" = "t15"."sr_ticket_number" AND "t14"."ss_item_sk" = "t15"."sr_item_sk") AS "t"
UNION
...
FROM tpcds.sf1000.web_sales AS web_sales) AS "t18"
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
FROM tpcds.sf1000.item AS item
WHERE "i_category" = 'Books') AS "t21" ON "t18"."ws_item_sk" = "t21"."i_item_sk") AS "t22"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t23" ON "t22"."ws_sold_date_sk" = "t23"."d_date_sk") AS "t24"
...
FROM tpcds.sf1000.web_returns AS web_returns) AS "t25" ON "t24"."ws_order_number" = "t25"."wr_order_number" AND "t24"."ws_item_sk" = "t25"."wr_item_sk") AS "t27"
...
FROM (SELECT "cs_sold_date_sk", "cs_item_sk", "cs_order_number", "cs_quantity", "cs_ext_sales_price"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t31"
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
FROM tpcds.sf1000.item AS item
WHERE "i_category" = 'Books') AS "t34" ON "t31"."cs_item_sk" = "t34"."i_item_sk") AS "t35"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t36" ON "t35"."cs_sold_date_sk" = "t36"."d_date_sk") AS "t37"
LEFT JOIN (SELECT "cr_item_sk", "cr_order_number", "cr_return_quantity", "cr_return_amount", "cr_return_quantity" AS "CAST", "cr_return_amount" AS "CAST5"
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t38" ON "t37"."cs_order_number" = "t38"."cr_order_number" AND "t37"."cs_item_sk" = "t38"."cr_item_sk"
UNION
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_ticket_number", "ss_quantity", "ss_ext_sales_price"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t40"
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
FROM tpcds.sf1000.item AS item
WHERE "i_category" = 'Books') AS "t43" ON "t40"."ss_item_sk" = "t43"."i_item_sk") AS "t44"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t45" ON "t44"."ss_sold_date_sk" = "t45"."d_date_sk") AS "t46"
LEFT JOIN (SELECT "sr_item_sk", "sr_ticket_number", "sr_return_quantity", "sr_return_amt", "sr_return_quantity" AS "CAST", "sr_return_amt" AS "CAST5"
FROM tpcds.sf1000.store_returns AS store_returns) AS "t47" ON "t46"."ss_ticket_number" = "t47"."sr_ticket_number" AND "t46"."ss_item_sk" = "t47"."sr_item_sk") AS "t"
UNION
...
FROM (SELECT "ws_sold_date_sk", "ws_item_sk", "ws_order_number", "ws_quantity", "ws_ext_sales_price"
FROM tpcds.sf1000.web_sales AS web_sales) AS "t50"
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
FROM tpcds.sf1000.item AS item
WHERE "i_category" = 'Books') AS "t53" ON "t50"."ws_item_sk" = "t53"."i_item_sk") AS "t54"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t55" ON "t54"."ws_sold_date_sk" = "t55"."d_date_sk") AS "t56"
LEFT JOIN (SELECT "wr_item_sk", "wr_order_number", "wr_return_quantity", "wr_return_amt", "wr_return_quantity" AS "CAST", "wr_return_amt" AS "CAST5"
FROM tpcds.sf1000.web_returns AS web_returns) AS "t57" ON "t56"."ws_order_number" = "t57"."wr_order_number" AND "t56"."ws_item_sk" = "t57"."wr_item_sk") AS "t59"
GROUP BY "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
...
ORDER BY "t30"."sales_cnt" - "t62"."sales_cnt" IS NULL, "t30"."sales_cnt" - "t62"."sales_cnt", "t30"."sales_amt" - "t62"."sales_amt" IS NULL, "t30"."sales_amt" - "t62"."sales_amt"
LIMIT 100

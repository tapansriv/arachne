...
FROM tpcds.sf1000.store_returns AS store_returns) AS "t0" ON "t"."ss_ticket_number" = "t0"."sr_ticket_number" AND "t"."ss_item_sk" = "t0"."sr_item_sk" AND "t"."ss_customer_sk" = "t0"."sr_customer_sk") AS "t1"
...
FROM tpcds.sf1000.store AS store) AS "t2" ON "t1"."ss_store_sk" = "t2"."s_store_sk") AS "t3"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t4" ON "t3"."ss_sold_date_sk" = "t4"."d_date_sk") AS "t6"
INNER JOIN (SELECT "d_date_sk"
...
ORDER BY "t6"."s_store_name" IS NULL, "t6"."s_store_name", "t6"."s_company_id" IS NULL, "t6"."s_company_id", "t6"."s_street_number" IS NULL, "t6"."s_street_number", "t6"."s_street_name" IS NULL, "t6"."s_street_name", "t6"."s_street_type" IS NULL, "t6"."s_street_type", "t6"."s_suite_number" IS NULL, "t6"."s_suite_number", "t6"."s_city" IS NULL, "t6"."s_city", "t6"."s_county" IS NULL, "t6"."s_county", "t6"."s_state" IS NULL, "t6"."s_state", "t6"."s_zip" IS NULL, "t6"."s_zip"
LIMIT 100

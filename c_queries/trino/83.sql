...
FROM tpcds.sf1000.item AS item) AS "t0" ON "t"."sr_item_sk" = "t0"."i_item_sk") AS "t1"
...
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t14"
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM tpcds.sf1000.item AS item) AS "t15" ON "t14"."cr_item_sk" = "t15"."i_item_sk") AS "t16"
...
FROM tpcds.sf1000.web_returns AS web_returns) AS "t30"
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM tpcds.sf1000.item AS item) AS "t31" ON "t30"."wr_item_sk" = "t31"."i_item_sk") AS "t32"
...
ORDER BY "t29"."item_id", "t29"."sr_item_qty"
LIMIT 100

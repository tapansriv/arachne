...
ORDER BY "t19"."cd_gender" IS NULL, "t19"."cd_gender", "t19"."cd_marital_status" IS NULL, "t19"."cd_marital_status", "t19"."cd_education_status" IS NULL, "t19"."cd_education_status", "t19"."cd_purchase_estimate" IS NULL, "t19"."cd_purchase_estimate", "t19"."cd_credit_rating" IS NULL, "t19"."cd_credit_rating"
LIMIT 100

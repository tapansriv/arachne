...
FROM tpcds.sf1000.web_returns AS web_returns) AS "t"
...
FROM tpcds.sf1000.customer_address AS customer_address) AS "t4" ON "t3"."wr_returning_addr_sk" = "t4"."ca_address_sk"
...
FROM tpcds.sf1000.web_returns AS "web_returns0",
...
FROM tpcds.sf1000.customer AS customer) AS "t23" ON "t22"."ca_address_sk" = "t23"."c_current_addr_sk" AND "t19"."ctr_customer_sk" = "t23"."c_customer_sk"
ORDER BY "t23"."c_customer_id", "t23"."c_salutation", "t23"."c_first_name", "t23"."c_last_name", "t23"."c_preferred_cust_flag", "t23"."c_birth_day", "t23"."c_birth_month", "t23"."c_birth_year", "t23"."c_birth_country", "t23"."c_login", "t23"."c_email_address", "t23"."c_last_review_date_sk", "t19"."ctr_total_return"
LIMIT 100

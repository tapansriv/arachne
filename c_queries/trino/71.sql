...
FROM tpcds.sf1000.web_sales AS web_sales) AS "t0"
...
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t6"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS store_sales) AS "t13"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim

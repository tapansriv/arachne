...
INNER JOIN (SELECT *
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t19" ON "t18"."c_current_cdemo_sk" = "t19"."cd_demo_sk"
...
ORDER BY "t19"."cd_gender" IS NULL, "t19"."cd_gender", "t19"."cd_marital_status" IS NULL, "t19"."cd_marital_status", "t19"."cd_education_status" IS NULL, "t19"."cd_education_status", "t19"."cd_purchase_estimate" IS NULL, "t19"."cd_purchase_estimate", "t19"."cd_credit_rating" IS NULL, "t19"."cd_credit_rating", "t19"."cd_dep_count" IS NULL, "t19"."cd_dep_count", "t19"."cd_dep_employed_count" IS NULL, "t19"."cd_dep_employed_count", "t19"."cd_dep_college_count" IS NULL, "t19"."cd_dep_college_count"
LIMIT 100

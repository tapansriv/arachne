...
FROM tpcds.sf1000.customer_demographics AS customer_demographics
WHERE "cd_gender" = 'F' AND "cd_education_status" = 'Unknown') AS "t2" ON "t"."cs_bill_cdemo_sk" = "t2"."cd_demo_sk") AS "t3",
(SELECT "cd_demo_sk"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t4") AS "t5"
...
FROM tpcds.sf1000.item AS item) AS "t17" ON "t16"."cs_item_sk" = "t17"."i_item_sk"
...
FROM (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", "cs_bill_cdemo_sk", "cs_item_sk", CAST("cs_quantity" AS DECIMAL(12, 2)) AS "CAST", CAST("cs_list_price" AS DECIMAL(12, 2)) AS "CAST5", CAST("cs_coupon_amt" AS DECIMAL(12, 2)) AS "CAST6", CAST("cs_sales_price" AS DECIMAL(12, 2)) AS "CAST7", CAST("cs_net_profit" AS DECIMAL(12, 2)) AS "CAST8"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t20"
INNER JOIN (SELECT "cd_demo_sk", CAST("cd_dep_count" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer_demographics AS customer_demographics
WHERE "cd_gender" = 'F' AND "cd_education_status" = 'Unknown') AS "t23" ON "t20"."cs_bill_cdemo_sk" = "t23"."cd_demo_sk") AS "t24",
(SELECT "cd_demo_sk"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t25") AS "t26"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_addr_sk", CAST("c_birth_year" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer AS customer
...
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM tpcds.sf1000.item AS item) AS "t38" ON "t37"."cs_item_sk" = "t38"."i_item_sk"
...
FROM (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", "cs_bill_cdemo_sk", "cs_item_sk", CAST("cs_quantity" AS DECIMAL(12, 2)) AS "CAST", CAST("cs_list_price" AS DECIMAL(12, 2)) AS "CAST5", CAST("cs_coupon_amt" AS DECIMAL(12, 2)) AS "CAST6", CAST("cs_sales_price" AS DECIMAL(12, 2)) AS "CAST7", CAST("cs_net_profit" AS DECIMAL(12, 2)) AS "CAST8"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t43"
INNER JOIN (SELECT "cd_demo_sk", CAST("cd_dep_count" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer_demographics AS customer_demographics
WHERE "cd_gender" = 'F' AND "cd_education_status" = 'Unknown') AS "t46" ON "t43"."cs_bill_cdemo_sk" = "t46"."cd_demo_sk") AS "t47",
(SELECT "cd_demo_sk"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t48") AS "t49"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_addr_sk", CAST("c_birth_year" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer AS customer
...
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM tpcds.sf1000.item AS item) AS "t62" ON "t61"."cs_item_sk" = "t62"."i_item_sk"
...
FROM (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", "cs_bill_cdemo_sk", "cs_item_sk", CAST("cs_quantity" AS DECIMAL(12, 2)) AS "CAST", CAST("cs_list_price" AS DECIMAL(12, 2)) AS "CAST5", CAST("cs_coupon_amt" AS DECIMAL(12, 2)) AS "CAST6", CAST("cs_sales_price" AS DECIMAL(12, 2)) AS "CAST7", CAST("cs_net_profit" AS DECIMAL(12, 2)) AS "CAST8"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t67"
INNER JOIN (SELECT "cd_demo_sk", CAST("cd_dep_count" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer_demographics AS customer_demographics
WHERE "cd_gender" = 'F' AND "cd_education_status" = 'Unknown') AS "t70" ON "t67"."cs_bill_cdemo_sk" = "t70"."cd_demo_sk") AS "t71",
(SELECT "cd_demo_sk"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t72") AS "t73"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_addr_sk", CAST("c_birth_year" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer AS customer
...
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM tpcds.sf1000.item AS item) AS "t86" ON "t85"."cs_item_sk" = "t86"."i_item_sk"
...
FROM (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", "cs_bill_cdemo_sk", "cs_item_sk", CAST("cs_quantity" AS DECIMAL(12, 2)) AS "CAST", CAST("cs_list_price" AS DECIMAL(12, 2)) AS "CAST5", CAST("cs_coupon_amt" AS DECIMAL(12, 2)) AS "CAST6", CAST("cs_sales_price" AS DECIMAL(12, 2)) AS "CAST7", CAST("cs_net_profit" AS DECIMAL(12, 2)) AS "CAST8"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t91"
INNER JOIN (SELECT "cd_demo_sk", CAST("cd_dep_count" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer_demographics AS customer_demographics
WHERE "cd_gender" = 'F' AND "cd_education_status" = 'Unknown') AS "t94" ON "t91"."cs_bill_cdemo_sk" = "t94"."cd_demo_sk") AS "t95",
(SELECT "cd_demo_sk"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t96") AS "t97"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_addr_sk", CAST("c_birth_year" AS DECIMAL(12, 2)) AS "CAST"
FROM tpcds.sf1000.customer AS customer
...
FROM tpcds.sf1000.item AS item) AS "t110" ON "t109"."cs_item_sk" = "t110"."i_item_sk") AS "t114"

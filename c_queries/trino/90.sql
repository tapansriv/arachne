...
INNER JOIN (SELECT *
FROM tpcds.sf1000.web_page AS web_page
...
ORDER BY CASE WHEN "t8"."=" THEN NULL ELSE "t3"."CAST" / "t8"."CAST" END IS NULL, CASE WHEN "t8"."=" THEN NULL ELSE "t3"."CAST" / "t8"."CAST" END
LIMIT 100

...
WHERE "rnk" < 11) AS "t11"
INNER JOIN (SELECT *
FROM (SELECT "t22"."item_sk", RANK() OVER (ORDER BY "t22"."rank_col" IS NULL DESC, "t22"."rank_col" DESC) AS "rnk"
...
FROM tpcds.sf1000.item AS item) AS "t27" ON "t26"."item_sk" = "t27"."i_item_sk") AS "t28"
INNER JOIN (SELECT "i_item_sk", "i_product_name"
FROM tpcds.sf1000.item AS item) AS "t29" ON "t28"."item_sk0" = "t29"."i_item_sk"
ORDER BY "t28"."rnk" IS NULL, "t28"."rnk"
LIMIT 100

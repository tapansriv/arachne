SELECT "t9"."i_item_id", AVG("t9"."ss_quantity") AS "agg1", AVG("t9"."ss_list_price") AS "agg2", AVG("t9"."ss_coupon_amt") AS "agg3", AVG("t9"."ss_sales_price") AS "agg4"
...
FROM tpcds.sf1000.item AS item) AS "t8" ON "t7"."ss_item_sk" = "t8"."i_item_sk") AS "t9"

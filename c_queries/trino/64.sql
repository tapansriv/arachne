...
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t2"
INNER JOIN (SELECT "cr_item_sk", "cr_order_number", "cr_refunded_cash" + "cr_reversed_charge" + "cr_store_credit" AS "+"
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t3" ON "t2"."cs_item_sk" = "t3"."cr_item_sk" AND "t2"."cs_order_number" = "t3"."cr_order_number"
...
FROM tpcds.sf1000.date_dim AS date_dim) AS "t9" ON "t8"."ss_sold_date_sk" = "t9"."d_date_sk") AS "t10",
(SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t11",
(SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t12"
INNER JOIN (SELECT "s_store_sk", "s_store_name", "s_zip"
FROM tpcds.sf1000.store AS store) AS "t13" ON "t10"."ss_store_sk" = "t13"."s_store_sk") AS "t14"
...
FROM tpcds.sf1000.customer AS customer) AS "t15" ON "t14"."ss_customer_sk" = "t15"."c_customer_sk" AND "t14"."d_date_sk0" = "t15"."c_first_sales_date_sk" AND "t14"."d_date_sk1" = "t15"."c_first_shipto_date_sk") AS "t16"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t17" ON "t16"."ss_cdemo_sk" = "t17"."cd_demo_sk") AS "t18"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t19" ON "t18"."c_current_cdemo_sk" = "t19"."cd_demo_sk" AND "t18"."cd_marital_status" <> "t19"."cd_marital_status") AS "t20"
INNER JOIN (SELECT "p_promo_sk"
FROM tpcds.sf1000.promotion AS promotion) AS "t21" ON "t20"."ss_promo_sk" = "t21"."p_promo_sk") AS "t22"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM tpcds.sf1000.household_demographics AS household_demographics) AS "t23" ON "t22"."ss_hdemo_sk" = "t23"."hd_demo_sk") AS "t24"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM tpcds.sf1000.household_demographics AS household_demographics) AS "t25" ON "t24"."c_current_hdemo_sk" = "t25"."hd_demo_sk") AS "t26"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM tpcds.sf1000.customer_address AS customer_address) AS "t27" ON "t26"."ss_addr_sk" = "t27"."ca_address_sk") AS "t28"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM tpcds.sf1000.customer_address AS customer_address) AS "t29" ON "t28"."c_current_addr_sk" = "t29"."ca_address_sk") AS "t30"
INNER JOIN (SELECT "ib_income_band_sk"
FROM tpcds.sf1000.income_band AS income_band) AS "t31" ON "t30"."hd_income_band_sk" = "t31"."ib_income_band_sk") AS "t32"
INNER JOIN (SELECT "ib_income_band_sk"
FROM tpcds.sf1000.income_band AS income_band) AS "t33" ON "t32"."hd_income_band_sk0" = "t33"."ib_income_band_sk") AS "t34"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_customer_sk", "ss_cdemo_sk", "ss_hdemo_sk", "ss_addr_sk", "ss_store_sk", "ss_promo_sk", "ss_ticket_number", "ss_wholesale_cost", "ss_list_price", "ss_coupon_amt"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t42"
INNER JOIN (SELECT "sr_item_sk", "sr_ticket_number"
FROM tpcds.sf1000.store_returns AS store_returns) AS "t43" ON "t42"."ss_item_sk" = "t43"."sr_item_sk" AND "t42"."ss_ticket_number" = "t43"."sr_ticket_number") AS "t44"
INNER JOIN (SELECT "t45"."cs_item_sk"
FROM (SELECT "cs_item_sk", "cs_order_number", "cs_ext_list_price"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t45"
INNER JOIN (SELECT "cr_item_sk", "cr_order_number", "cr_refunded_cash" + "cr_reversed_charge" + "cr_store_credit" AS "+"
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t46" ON "t45"."cs_item_sk" = "t46"."cr_item_sk" AND "t45"."cs_order_number" = "t46"."cr_order_number"
GROUP BY "t45"."cs_item_sk"
HAVING SUM("t45"."cs_ext_list_price") > 2 * SUM("t46"."+")) AS "t50" ON "t44"."ss_item_sk" = "t50"."cs_item_sk") AS "t51"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t52" ON "t51"."ss_sold_date_sk" = "t52"."d_date_sk") AS "t53",
(SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t54",
(SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t55"
INNER JOIN (SELECT "s_store_sk", "s_store_name", "s_zip"
FROM tpcds.sf1000.store AS store) AS "t56" ON "t53"."ss_store_sk" = "t56"."s_store_sk") AS "t57"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_hdemo_sk", "c_current_addr_sk", "c_first_shipto_date_sk", "c_first_sales_date_sk"
FROM tpcds.sf1000.customer AS customer) AS "t58" ON "t57"."ss_customer_sk" = "t58"."c_customer_sk" AND "t57"."d_date_sk0" = "t58"."c_first_sales_date_sk" AND "t57"."d_date_sk1" = "t58"."c_first_shipto_date_sk") AS "t59"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t60" ON "t59"."ss_cdemo_sk" = "t60"."cd_demo_sk") AS "t61"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM tpcds.sf1000.customer_demographics AS customer_demographics) AS "t62" ON "t61"."c_current_cdemo_sk" = "t62"."cd_demo_sk" AND "t61"."cd_marital_status" <> "t62"."cd_marital_status") AS "t63"
INNER JOIN (SELECT "p_promo_sk"
FROM tpcds.sf1000.promotion AS promotion) AS "t64" ON "t63"."ss_promo_sk" = "t64"."p_promo_sk") AS "t65"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM tpcds.sf1000.household_demographics AS household_demographics) AS "t66" ON "t65"."ss_hdemo_sk" = "t66"."hd_demo_sk") AS "t67"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM tpcds.sf1000.household_demographics AS household_demographics) AS "t68" ON "t67"."c_current_hdemo_sk" = "t68"."hd_demo_sk") AS "t69"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM tpcds.sf1000.customer_address AS customer_address) AS "t70" ON "t69"."ss_addr_sk" = "t70"."ca_address_sk") AS "t71"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM tpcds.sf1000.customer_address AS customer_address) AS "t72" ON "t71"."c_current_addr_sk" = "t72"."ca_address_sk") AS "t73"
INNER JOIN (SELECT "ib_income_band_sk"
FROM tpcds.sf1000.income_band AS income_band) AS "t74" ON "t73"."hd_income_band_sk" = "t74"."ib_income_band_sk") AS "t75"
INNER JOIN (SELECT "ib_income_band_sk"
FROM tpcds.sf1000.income_band AS income_band) AS "t76" ON "t75"."hd_income_band_sk0" = "t76"."ib_income_band_sk") AS "t77"
INNER JOIN (SELECT "i_item_sk", "i_product_name"
FROM tpcds.sf1000.item AS item

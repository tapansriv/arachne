...
FROM tpcds.sf1000.customer AS customer) AS "t12" ON "t11"."ss_customer_sk" = "t12"."c_customer_sk") AS "t13"
...
INNER JOIN (SELECT "c_customer_sk", "c_current_addr_sk"
FROM tpcds.sf1000.customer AS customer) AS "t33" ON "t32"."ss_customer_sk" = "t33"."c_customer_sk") AS "t34"
INNER JOIN (SELECT "ca_address_sk"
FROM tpcds.sf1000.customer_address AS customer_address

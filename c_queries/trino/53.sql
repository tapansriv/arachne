...
FROM tpcds.sf1000.store_sales AS store_sales) AS "t2" ON "t1"."i_item_sk" = "t2"."ss_item_sk") AS "t3"
...
FROM tpcds.sf1000.store AS store) AS "t8" ON "t7"."ss_store_sk" = "t8"."s_store_sk"
...
ORDER BY "avg_quarterly_sales" IS NULL, "avg_quarterly_sales", "sum_sales" IS NULL, "sum_sales", "i_manufact_id" IS NULL, "i_manufact_id"
LIMIT 100

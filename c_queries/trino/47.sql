...
FROM tpcds.sf1000.store_sales AS store_sales) AS "t0" ON "t"."i_item_sk" = "t0"."ss_item_sk") AS "t1"
...
FROM tpcds.sf1000.store AS store) AS "t5" ON "t4"."ss_store_sk" = "t5"."s_store_sk"
GROUP BY "t4"."i_category", "t4"."i_brand", "t5"."s_store_name", "t5"."s_company_name", "t4"."d_year", "t4"."d_moy") AS "t7") AS "t8"
INNER JOIN (SELECT "t17"."i_category", "t17"."i_brand", "t17"."s_store_name", "t17"."s_company_name", "t17"."sum_sales", (RANK() OVER (PARTITION BY "t17"."i_category", "t17"."i_brand", "t17"."s_store_name", "t17"."s_company_name" ORDER BY "t17"."d_year" IS NULL, "t17"."d_year", "t17"."d_moy" IS NULL, "t17"."d_moy")) + 1 AS "+"
...
INNER JOIN (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t10" ON "t9"."i_item_sk" = "t10"."ss_item_sk") AS "t11"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy"
FROM tpcds.sf1000.date_dim AS date_dim
...
INNER JOIN (SELECT "s_store_sk", "s_store_name", "s_company_name"
FROM tpcds.sf1000.store AS store) AS "t15" ON "t14"."ss_store_sk" = "t15"."s_store_sk"
...
INNER JOIN (SELECT "t29"."i_category", "t29"."i_brand", "t29"."s_store_name", "t29"."s_company_name", "t29"."sum_sales", (RANK() OVER (PARTITION BY "t29"."i_category", "t29"."i_brand", "t29"."s_store_name", "t29"."s_company_name" ORDER BY "t29"."d_year" IS NULL, "t29"."d_year", "t29"."d_moy" IS NULL, "t29"."d_moy")) - 1 AS "-"
...
INNER JOIN (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t22" ON "t21"."i_item_sk" = "t22"."ss_item_sk") AS "t23"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy"
FROM tpcds.sf1000.date_dim AS date_dim
...
INNER JOIN (SELECT "s_store_sk", "s_store_name", "s_company_name"
FROM tpcds.sf1000.store AS store) AS "t27" ON "t26"."ss_store_sk" = "t27"."s_store_sk"
...
ORDER BY "t20"."sum_sales" - "t20"."avg_monthly_sales" IS NULL, "t20"."sum_sales" - "t20"."avg_monthly_sales", "t20"."i_category" IS NULL, "t20"."i_category", "t20"."i_brand" IS NULL, "t20"."i_brand", "t20"."s_store_name" IS NULL, "t20"."s_store_name", "t20"."s_company_name" IS NULL, "t20"."s_company_name", "t20"."d_year" IS NULL, "t20"."d_year", "t20"."d_moy" IS NULL, "t20"."d_moy", "t20"."avg_monthly_sales" IS NULL, "t20"."avg_monthly_sales", "t20"."sum_sales" IS NULL, "t20"."sum_sales", "t20"."sum_sales0" IS NULL, "t20"."sum_sales0", "t31"."sum_sales" IS NULL, "t31"."sum_sales"
LIMIT 100

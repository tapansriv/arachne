...
FROM tpcds.sf1000.store AS store) AS "t4" ON "t3"."ss_store_sk" = "t4"."s_store_sk"
...
FROM tpcds.sf1000.store_returns AS store_returns) AS "t8"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t11" ON "t8"."sr_returned_date_sk" = "t11"."d_date_sk") AS "t12"
INNER JOIN (SELECT "s_store_sk"
FROM tpcds.sf1000.store AS store) AS "t13" ON "t12"."sr_store_sk" = "t13"."s_store_sk"
...
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t18"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t25"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.web_page AS web_page) AS "t39" ON "t38"."ws_web_page_sk" = "t39"."wp_web_page_sk"
...
FROM tpcds.sf1000.web_returns AS web_returns) AS "t43"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t46" ON "t43"."wr_returned_date_sk" = "t46"."d_date_sk") AS "t47"
INNER JOIN (SELECT "wp_web_page_sk"
FROM tpcds.sf1000.web_page AS web_page) AS "t48" ON "t47"."wr_web_page_sk" = "t48"."wp_web_page_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_store_sk", "ss_ext_sales_price", "ss_net_profit"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t56"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t59" ON "t56"."ss_sold_date_sk" = "t59"."d_date_sk") AS "t60"
INNER JOIN (SELECT "s_store_sk"
FROM tpcds.sf1000.store AS store) AS "t61" ON "t60"."ss_store_sk" = "t61"."s_store_sk"
...
FROM (SELECT "sr_returned_date_sk", "sr_store_sk", "sr_return_amt", "sr_net_loss"
FROM tpcds.sf1000.store_returns AS store_returns) AS "t65"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t68" ON "t65"."sr_returned_date_sk" = "t68"."d_date_sk") AS "t69"
INNER JOIN (SELECT "s_store_sk"
FROM tpcds.sf1000.store AS store) AS "t70" ON "t69"."sr_store_sk" = "t70"."s_store_sk"
...
FROM (SELECT "cs_sold_date_sk", "cs_call_center_sk", "cs_ext_sales_price", "cs_net_profit"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t75"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM (SELECT "cr_returned_date_sk", "cr_call_center_sk", "cr_return_amount", "cr_net_loss"
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t82"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM (SELECT "ws_sold_date_sk", "ws_web_page_sk", "ws_ext_sales_price", "ws_net_profit"
FROM tpcds.sf1000.web_sales AS web_sales) AS "t91"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t94" ON "t91"."ws_sold_date_sk" = "t94"."d_date_sk") AS "t95"
INNER JOIN (SELECT "wp_web_page_sk"
FROM tpcds.sf1000.web_page AS web_page) AS "t96" ON "t95"."ws_web_page_sk" = "t96"."wp_web_page_sk"
...
FROM (SELECT "wr_returned_date_sk", "wr_web_page_sk", "wr_return_amt", "wr_net_loss"
FROM tpcds.sf1000.web_returns AS web_returns) AS "t100"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t103" ON "t100"."wr_returned_date_sk" = "t103"."d_date_sk") AS "t104"
INNER JOIN (SELECT "wp_web_page_sk"
FROM tpcds.sf1000.web_page AS web_page) AS "t105" ON "t104"."wr_web_page_sk" = "t105"."wp_web_page_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_store_sk", "ss_ext_sales_price", "ss_net_profit"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t116"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t119" ON "t116"."ss_sold_date_sk" = "t119"."d_date_sk") AS "t120"
INNER JOIN (SELECT "s_store_sk"
FROM tpcds.sf1000.store AS store) AS "t121" ON "t120"."ss_store_sk" = "t121"."s_store_sk"
...
FROM (SELECT "sr_returned_date_sk", "sr_store_sk", "sr_return_amt", "sr_net_loss"
FROM tpcds.sf1000.store_returns AS store_returns) AS "t125"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t128" ON "t125"."sr_returned_date_sk" = "t128"."d_date_sk") AS "t129"
INNER JOIN (SELECT "s_store_sk"
FROM tpcds.sf1000.store AS store) AS "t130" ON "t129"."sr_store_sk" = "t130"."s_store_sk"
...
FROM (SELECT "cs_sold_date_sk", "cs_call_center_sk", "cs_ext_sales_price", "cs_net_profit"
FROM tpcds.sf1000.catalog_sales AS catalog_sales) AS "t135"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM (SELECT "cr_returned_date_sk", "cr_call_center_sk", "cr_return_amount", "cr_net_loss"
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t142"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM (SELECT "ws_sold_date_sk", "ws_web_page_sk", "ws_ext_sales_price", "ws_net_profit"
FROM tpcds.sf1000.web_sales AS web_sales) AS "t151"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t154" ON "t151"."ws_sold_date_sk" = "t154"."d_date_sk") AS "t155"
INNER JOIN (SELECT "wp_web_page_sk"
FROM tpcds.sf1000.web_page AS web_page) AS "t156" ON "t155"."ws_web_page_sk" = "t156"."wp_web_page_sk"
...
FROM (SELECT "wr_returned_date_sk", "wr_web_page_sk", "wr_return_amt", "wr_net_loss"
FROM tpcds.sf1000.web_returns AS web_returns) AS "t160"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t163" ON "t160"."wr_returned_date_sk" = "t163"."d_date_sk") AS "t164"
INNER JOIN (SELECT "wp_web_page_sk"
FROM tpcds.sf1000.web_page AS web_page) AS "t165" ON "t164"."wr_web_page_sk" = "t165"."wp_web_page_sk"

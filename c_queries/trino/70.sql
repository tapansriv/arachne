...
FROM (SELECT "ss_sold_date_sk", "ss_store_sk", "ss_net_profit"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t16"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store AS "store1"
INNER JOIN (SELECT "s_state"
...
tpcds.sf1000.store AS "store2",
tpcds.sf1000.date_dim AS "date_dim2"
...
FROM (SELECT "ss_sold_date_sk", "ss_store_sk", "ss_net_profit"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t36"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store AS "store3"
INNER JOIN (SELECT "s_state"

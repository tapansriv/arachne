SELECT SUBSTR("t16"."r_reason_desc", 1, 20), AVG("t15"."ws_quantity") AS "avg1", AVG("t15"."wr_refunded_cash") AS "avg2", AVG("t15"."wr_fee")
...
FROM tpcds.sf1000.web_returns AS web_returns) AS "t0" ON "t"."ws_item_sk" = "t0"."wr_item_sk" AND "t"."ws_order_number" = "t0"."wr_order_number") AS "t1"
INNER JOIN (SELECT "wp_web_page_sk"
FROM tpcds.sf1000.web_page AS web_page) AS "t2" ON "t1"."ws_web_page_sk" = "t2"."wp_web_page_sk") AS "t3"
...
FROM tpcds.sf1000.customer_address AS customer_address) AS "t10" ON "t9"."wr_refunded_addr_sk" = "t10"."ca_address_sk" AND ("t10"."=" AND "t10"."SEARCH" AND "t9"."SEARCH" OR "t10"."=" AND "t10"."SEARCH3" AND "t9"."SEARCH7" OR "t10"."=" AND "t10"."SEARCH4" AND "t9"."SEARCH8")) AS "t11"
...
FROM tpcds.sf1000.reason AS reason) AS "t16" ON "t15"."wr_reason_sk" = "t16"."r_reason_sk"
GROUP BY "t16"."r_reason_desc"
ORDER BY SUBSTR("t16"."r_reason_desc", 1, 20) IS NULL, SUBSTR("t16"."r_reason_desc", 1, 20), AVG("t15"."ws_quantity") IS NULL, AVG("t15"."ws_quantity"), AVG("t15"."wr_refunded_cash") IS NULL, AVG("t15"."wr_refunded_cash"), AVG("t15"."wr_fee") IS NULL, AVG("t15"."wr_fee")
LIMIT 100

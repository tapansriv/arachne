...
FROM tpcds.sf1000.store_returns AS store_returns) AS "t"
...
FROM tpcds.sf1000.store_returns AS "store_returns0",
...
FROM tpcds.sf1000.customer AS customer) AS "t22" ON "t21"."ctr_customer_sk" = "t22"."c_customer_sk"
ORDER BY "t22"."c_customer_id" IS NULL, "t22"."c_customer_id"
LIMIT 100

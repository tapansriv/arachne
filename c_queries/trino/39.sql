...
FROM tpcds.sf1000.item AS item) AS "t" ON "inventory"."inv_item_sk" = "t"."i_item_sk") AS "t0"
INNER JOIN (SELECT "w_warehouse_sk", "w_warehouse_name"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t1" ON "t0"."inv_warehouse_sk" = "t1"."w_warehouse_sk") AS "t2"
...
INNER JOIN (SELECT "i_item_sk"
FROM tpcds.sf1000.item AS item) AS "t13" ON "inventory0"."inv_item_sk" = "t13"."i_item_sk") AS "t14"
INNER JOIN (SELECT "w_warehouse_sk", "w_warehouse_name"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t15" ON "t14"."inv_warehouse_sk" = "t15"."w_warehouse_sk") AS "t16"
INNER JOIN (SELECT "d_date_sk", "d_moy"
FROM tpcds.sf1000.date_dim AS date_dim
...
ORDER BY "t12"."w_warehouse_sk", "t12"."i_item_sk", "t12"."d_moy", "t12"."mean", "t12"."cov", "t26"."d_moy", "t26"."mean", "t26"."cov"

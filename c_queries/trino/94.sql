...
FROM (tpcds.sf1000.web_sales AS "$cor0", LATERAL (SELECT TRUE AS "i"
...
FROM tpcds.sf1000.web_returns AS web_returns) AS "t3"
...
ORDER BY COUNT(DISTINCT "t18"."ws_order_number") IS NULL, COUNT(DISTINCT "t18"."ws_order_number")
LIMIT 100

...
FROM tpcds.sf1000.inventory AS inventory
...
FROM tpcds.sf1000.item AS item) AS "t3" ON "t2"."inv_item_sk" = "t3"."i_item_sk") AS "t4"
INNER JOIN (SELECT "w_warehouse_sk"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t5" ON "t4"."inv_warehouse_sk" = "t5"."w_warehouse_sk"
...
FROM tpcds.sf1000.inventory AS "inventory0"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.item AS item) AS "t12" ON "t11"."inv_item_sk" = "t12"."i_item_sk") AS "t13"
INNER JOIN (SELECT "w_warehouse_sk"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t14" ON "t13"."inv_warehouse_sk" = "t14"."w_warehouse_sk"
...
FROM tpcds.sf1000.inventory AS "inventory1"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.item AS item) AS "t23" ON "t22"."inv_item_sk" = "t23"."i_item_sk") AS "t24"
INNER JOIN (SELECT "w_warehouse_sk"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t25" ON "t24"."inv_warehouse_sk" = "t25"."w_warehouse_sk"
...
FROM tpcds.sf1000.inventory AS "inventory2"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.item AS item) AS "t34" ON "t33"."inv_item_sk" = "t34"."i_item_sk") AS "t35"
INNER JOIN (SELECT "w_warehouse_sk"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t36" ON "t35"."inv_warehouse_sk" = "t36"."w_warehouse_sk"
...
FROM tpcds.sf1000.inventory AS "inventory3"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.item AS item) AS "t45" ON "t44"."inv_item_sk" = "t45"."i_item_sk") AS "t46"
INNER JOIN (SELECT "w_warehouse_sk"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t47" ON "t46"."inv_warehouse_sk" = "t47"."w_warehouse_sk") AS "t51"

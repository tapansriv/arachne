...
FROM tpcds.sf1000.web_sales AS web_sales) AS "t7" ON "t6"."c_customer_sk" = "t7"."ws_bill_customer_sk") AS "t8"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t9" ON "t8"."ws_sold_date_sk" = "t9"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM tpcds.sf1000.customer AS customer) AS "t17"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", "ss_ext_list_price" - "ss_ext_discount_amt" AS "-"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t18" ON "t17"."c_customer_sk" = "t18"."ss_customer_sk") AS "t19"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t20" ON "t19"."ss_sold_date_sk" = "t20"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM tpcds.sf1000.customer AS customer) AS "t24"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", "ws_ext_list_price" - "ws_ext_discount_amt" AS "-"
FROM tpcds.sf1000.web_sales AS web_sales) AS "t25" ON "t24"."c_customer_sk" = "t25"."ws_bill_customer_sk") AS "t26"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t27" ON "t26"."ws_sold_date_sk" = "t27"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM tpcds.sf1000.customer AS customer) AS "t36"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", "ss_ext_list_price" - "ss_ext_discount_amt" AS "-"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t37" ON "t36"."c_customer_sk" = "t37"."ss_customer_sk") AS "t38"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t39" ON "t38"."ss_sold_date_sk" = "t39"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM tpcds.sf1000.customer AS customer) AS "t43"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", "ws_ext_list_price" - "ws_ext_discount_amt" AS "-"
FROM tpcds.sf1000.web_sales AS web_sales) AS "t44" ON "t43"."c_customer_sk" = "t44"."ws_bill_customer_sk") AS "t45"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t46" ON "t45"."ws_sold_date_sk" = "t46"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM tpcds.sf1000.customer AS customer) AS "t56"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", "ss_ext_list_price" - "ss_ext_discount_amt" AS "-"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t57" ON "t56"."c_customer_sk" = "t57"."ss_customer_sk") AS "t58"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t59" ON "t58"."ss_sold_date_sk" = "t59"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM tpcds.sf1000.customer AS customer) AS "t63"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", "ws_ext_list_price" - "ws_ext_discount_amt" AS "-"
FROM tpcds.sf1000.web_sales AS web_sales) AS "t64" ON "t63"."c_customer_sk" = "t64"."ws_bill_customer_sk") AS "t65"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t66" ON "t65"."ws_sold_date_sk" = "t66"."d_date_sk"
...
ORDER BY "t55"."customer_id0", "t55"."customer_first_name0", "t55"."customer_last_name0", "t55"."customer_preferred_cust_flag0"
LIMIT 100

...
FROM tpcds.sf1000.date_dim AS date_dim) AS "t0" ON "t"."ss_sold_date_sk" = "t0"."d_date_sk"
GROUP BY "t0"."d_week_seq", "t"."ss_store_sk") AS "t2"
INNER JOIN (SELECT "s_store_sk", "s_store_id", "s_store_name"
FROM tpcds.sf1000.store AS store) AS "t3" ON "t2"."ss_store_sk" = "t3"."s_store_sk") AS "t4"
...
FROM (SELECT "ss_sold_date_sk", "ss_store_sk", "ss_sales_price"
FROM tpcds.sf1000.store_sales AS store_sales) AS "t9"
INNER JOIN (SELECT "d_date_sk", "d_week_seq", "d_day_name" = 'Sunday' AS "=", "d_day_name" = 'Monday' AS "=3", "d_day_name" = 'Tuesday' AS "=4", "d_day_name" = 'Wednesday' AS "=5", "d_day_name" = 'Thursday' AS "=6", "d_day_name" = 'Friday' AS "=7", "d_day_name" = 'Saturday' AS "=8"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t10" ON "t9"."ss_sold_date_sk" = "t10"."d_date_sk"
GROUP BY "t10"."d_week_seq", "t9"."ss_store_sk") AS "t12"
INNER JOIN (SELECT "s_store_sk", "s_store_id", "s_store_name"
FROM tpcds.sf1000.store AS store) AS "t13" ON "t12"."ss_store_sk" = "t13"."s_store_sk") AS "t14"
INNER JOIN (SELECT "d_week_seq"
FROM tpcds.sf1000.date_dim AS date_dim
...
ORDER BY "t8"."s_store_name1", "t8"."s_store_id1", "t8"."d_week_seq1"
LIMIT 100

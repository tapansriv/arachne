...
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t"
...
FROM tpcds.sf1000.customer_address AS customer_address) AS "t4" ON "t3"."cr_returning_addr_sk" = "t4"."ca_address_sk"
...
FROM tpcds.sf1000.catalog_returns AS "catalog_returns0",
...
FROM tpcds.sf1000.customer AS customer) AS "t22" ON "t21"."ca_address_sk" = "t22"."c_current_addr_sk" AND "t19"."ctr_customer_sk" = "t22"."c_customer_sk"

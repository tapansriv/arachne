...
tpcds.sf1000.date_dim AS date_dim
...
tpcds.sf1000.item AS "item1",
tpcds.sf1000.date_dim AS "date_dim0"
...
tpcds.sf1000.item AS "item2",
tpcds.sf1000.date_dim AS "date_dim1"
...
FROM tpcds.sf1000.item AS item) AS "t16" ON "t15"."ss_item_sk" = "t16"."i_item_sk") AS "t17"
...
FROM tpcds.sf1000.store_sales AS "store_sales1",
tpcds.sf1000.date_dim AS "date_dim3"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales0",
tpcds.sf1000.date_dim AS "date_dim4"
...
FROM tpcds.sf1000.web_sales AS "web_sales0",
tpcds.sf1000.date_dim AS "date_dim5"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales1"
INNER JOIN (SELECT "item4"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item4",
(SELECT *
FROM (SELECT "item5"."i_brand_id" AS "brand_id", "item5"."i_class_id" AS "class_id", "item5"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales2",
tpcds.sf1000.item AS "item5",
tpcds.sf1000.date_dim AS "date_dim6"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales2",
tpcds.sf1000.item AS "item6",
tpcds.sf1000.date_dim AS "date_dim7"
...
FROM tpcds.sf1000.web_sales AS "web_sales1",
tpcds.sf1000.item AS "item7",
tpcds.sf1000.date_dim AS "date_dim8"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t58" ON "t57"."cs_item_sk" = "t58"."i_item_sk") AS "t59"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales3",
tpcds.sf1000.date_dim AS "date_dim10"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales3",
tpcds.sf1000.date_dim AS "date_dim11"
...
FROM tpcds.sf1000.web_sales AS "web_sales2",
tpcds.sf1000.date_dim AS "date_dim12"
...
FROM tpcds.sf1000.web_sales AS "web_sales3"
INNER JOIN (SELECT "item9"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item9",
(SELECT *
FROM (SELECT "item10"."i_brand_id" AS "brand_id", "item10"."i_class_id" AS "class_id", "item10"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales4",
tpcds.sf1000.item AS "item10",
tpcds.sf1000.date_dim AS "date_dim13"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales4",
tpcds.sf1000.item AS "item11",
tpcds.sf1000.date_dim AS "date_dim14"
...
FROM tpcds.sf1000.web_sales AS "web_sales4",
tpcds.sf1000.item AS "item12",
tpcds.sf1000.date_dim AS "date_dim15"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t101" ON "t100"."ws_item_sk" = "t101"."i_item_sk") AS "t102"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales5",
tpcds.sf1000.date_dim AS "date_dim17"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales5",
tpcds.sf1000.date_dim AS "date_dim18"
...
FROM tpcds.sf1000.web_sales AS "web_sales5",
tpcds.sf1000.date_dim AS "date_dim19"
...
FROM tpcds.sf1000.store_sales AS "store_sales6"
INNER JOIN (SELECT "item14"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item14",
(SELECT *
FROM (SELECT "item15"."i_brand_id" AS "brand_id", "item15"."i_class_id" AS "class_id", "item15"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales7",
tpcds.sf1000.item AS "item15",
tpcds.sf1000.date_dim AS "date_dim20"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales6",
tpcds.sf1000.item AS "item16",
tpcds.sf1000.date_dim AS "date_dim21"
...
FROM tpcds.sf1000.web_sales AS "web_sales6",
tpcds.sf1000.item AS "item17",
tpcds.sf1000.date_dim AS "date_dim22"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t146" ON "t145"."ss_item_sk" = "t146"."i_item_sk") AS "t147"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales8",
tpcds.sf1000.date_dim AS "date_dim24"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales7",
tpcds.sf1000.date_dim AS "date_dim25"
...
FROM tpcds.sf1000.web_sales AS "web_sales7",
tpcds.sf1000.date_dim AS "date_dim26"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales8"
INNER JOIN (SELECT "item19"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item19",
(SELECT *
FROM (SELECT "item20"."i_brand_id" AS "brand_id", "item20"."i_class_id" AS "class_id", "item20"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales9",
tpcds.sf1000.item AS "item20",
tpcds.sf1000.date_dim AS "date_dim27"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales9",
tpcds.sf1000.item AS "item21",
tpcds.sf1000.date_dim AS "date_dim28"
...
FROM tpcds.sf1000.web_sales AS "web_sales8",
tpcds.sf1000.item AS "item22",
tpcds.sf1000.date_dim AS "date_dim29"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t188" ON "t187"."cs_item_sk" = "t188"."i_item_sk") AS "t189"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales10",
tpcds.sf1000.date_dim AS "date_dim31"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales10",
tpcds.sf1000.date_dim AS "date_dim32"
...
FROM tpcds.sf1000.web_sales AS "web_sales9",
tpcds.sf1000.date_dim AS "date_dim33"
...
FROM tpcds.sf1000.web_sales AS "web_sales10"
INNER JOIN (SELECT "item24"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item24",
(SELECT *
FROM (SELECT "item25"."i_brand_id" AS "brand_id", "item25"."i_class_id" AS "class_id", "item25"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales11",
tpcds.sf1000.item AS "item25",
tpcds.sf1000.date_dim AS "date_dim34"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales11",
tpcds.sf1000.item AS "item26",
tpcds.sf1000.date_dim AS "date_dim35"
...
FROM tpcds.sf1000.web_sales AS "web_sales11",
tpcds.sf1000.item AS "item27",
tpcds.sf1000.date_dim AS "date_dim36"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t231" ON "t230"."ws_item_sk" = "t231"."i_item_sk") AS "t232"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales12",
tpcds.sf1000.date_dim AS "date_dim38"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales12",
tpcds.sf1000.date_dim AS "date_dim39"
...
FROM tpcds.sf1000.web_sales AS "web_sales12",
tpcds.sf1000.date_dim AS "date_dim40"
...
FROM tpcds.sf1000.store_sales AS "store_sales13"
INNER JOIN (SELECT "item29"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item29",
(SELECT *
FROM (SELECT "item30"."i_brand_id" AS "brand_id", "item30"."i_class_id" AS "class_id", "item30"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales14",
tpcds.sf1000.item AS "item30",
tpcds.sf1000.date_dim AS "date_dim41"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales13",
tpcds.sf1000.item AS "item31",
tpcds.sf1000.date_dim AS "date_dim42"
...
FROM tpcds.sf1000.web_sales AS "web_sales13",
tpcds.sf1000.item AS "item32",
tpcds.sf1000.date_dim AS "date_dim43"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t279" ON "t278"."ss_item_sk" = "t279"."i_item_sk") AS "t280"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales15",
tpcds.sf1000.date_dim AS "date_dim45"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales14",
tpcds.sf1000.date_dim AS "date_dim46"
...
FROM tpcds.sf1000.web_sales AS "web_sales14",
tpcds.sf1000.date_dim AS "date_dim47"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales15"
INNER JOIN (SELECT "item34"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item34",
(SELECT *
FROM (SELECT "item35"."i_brand_id" AS "brand_id", "item35"."i_class_id" AS "class_id", "item35"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales16",
tpcds.sf1000.item AS "item35",
tpcds.sf1000.date_dim AS "date_dim48"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales16",
tpcds.sf1000.item AS "item36",
tpcds.sf1000.date_dim AS "date_dim49"
...
FROM tpcds.sf1000.web_sales AS "web_sales15",
tpcds.sf1000.item AS "item37",
tpcds.sf1000.date_dim AS "date_dim50"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t321" ON "t320"."cs_item_sk" = "t321"."i_item_sk") AS "t322"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales17",
tpcds.sf1000.date_dim AS "date_dim52"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales17",
tpcds.sf1000.date_dim AS "date_dim53"
...
FROM tpcds.sf1000.web_sales AS "web_sales16",
tpcds.sf1000.date_dim AS "date_dim54"
...
FROM tpcds.sf1000.web_sales AS "web_sales17"
INNER JOIN (SELECT "item39"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item39",
(SELECT *
FROM (SELECT "item40"."i_brand_id" AS "brand_id", "item40"."i_class_id" AS "class_id", "item40"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales18",
tpcds.sf1000.item AS "item40",
tpcds.sf1000.date_dim AS "date_dim55"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales18",
tpcds.sf1000.item AS "item41",
tpcds.sf1000.date_dim AS "date_dim56"
...
FROM tpcds.sf1000.web_sales AS "web_sales18",
tpcds.sf1000.item AS "item42",
tpcds.sf1000.date_dim AS "date_dim57"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t364" ON "t363"."ws_item_sk" = "t364"."i_item_sk") AS "t365"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales19",
tpcds.sf1000.date_dim AS "date_dim59"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales19",
tpcds.sf1000.date_dim AS "date_dim60"
...
FROM tpcds.sf1000.web_sales AS "web_sales19",
tpcds.sf1000.date_dim AS "date_dim61"
...
FROM tpcds.sf1000.store_sales AS "store_sales20"
INNER JOIN (SELECT "item44"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item44",
(SELECT *
FROM (SELECT "item45"."i_brand_id" AS "brand_id", "item45"."i_class_id" AS "class_id", "item45"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales21",
tpcds.sf1000.item AS "item45",
tpcds.sf1000.date_dim AS "date_dim62"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales20",
tpcds.sf1000.item AS "item46",
tpcds.sf1000.date_dim AS "date_dim63"
...
FROM tpcds.sf1000.web_sales AS "web_sales20",
tpcds.sf1000.item AS "item47",
tpcds.sf1000.date_dim AS "date_dim64"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t412" ON "t411"."ss_item_sk" = "t412"."i_item_sk") AS "t413"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales22",
tpcds.sf1000.date_dim AS "date_dim66"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales21",
tpcds.sf1000.date_dim AS "date_dim67"
...
FROM tpcds.sf1000.web_sales AS "web_sales21",
tpcds.sf1000.date_dim AS "date_dim68"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales22"
INNER JOIN (SELECT "item49"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item49",
(SELECT *
FROM (SELECT "item50"."i_brand_id" AS "brand_id", "item50"."i_class_id" AS "class_id", "item50"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales23",
tpcds.sf1000.item AS "item50",
tpcds.sf1000.date_dim AS "date_dim69"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales23",
tpcds.sf1000.item AS "item51",
tpcds.sf1000.date_dim AS "date_dim70"
...
FROM tpcds.sf1000.web_sales AS "web_sales22",
tpcds.sf1000.item AS "item52",
tpcds.sf1000.date_dim AS "date_dim71"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t454" ON "t453"."cs_item_sk" = "t454"."i_item_sk") AS "t455"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales24",
tpcds.sf1000.date_dim AS "date_dim73"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales24",
tpcds.sf1000.date_dim AS "date_dim74"
...
FROM tpcds.sf1000.web_sales AS "web_sales23",
tpcds.sf1000.date_dim AS "date_dim75"
...
FROM tpcds.sf1000.web_sales AS "web_sales24"
INNER JOIN (SELECT "item54"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item54",
(SELECT *
FROM (SELECT "item55"."i_brand_id" AS "brand_id", "item55"."i_class_id" AS "class_id", "item55"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales25",
tpcds.sf1000.item AS "item55",
tpcds.sf1000.date_dim AS "date_dim76"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales25",
tpcds.sf1000.item AS "item56",
tpcds.sf1000.date_dim AS "date_dim77"
...
FROM tpcds.sf1000.web_sales AS "web_sales25",
tpcds.sf1000.item AS "item57",
tpcds.sf1000.date_dim AS "date_dim78"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t497" ON "t496"."ws_item_sk" = "t497"."i_item_sk") AS "t498"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales26",
tpcds.sf1000.date_dim AS "date_dim80"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales26",
tpcds.sf1000.date_dim AS "date_dim81"
...
FROM tpcds.sf1000.web_sales AS "web_sales26",
tpcds.sf1000.date_dim AS "date_dim82"
...
FROM tpcds.sf1000.store_sales AS "store_sales27"
INNER JOIN (SELECT "item59"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item59",
(SELECT *
FROM (SELECT "item60"."i_brand_id" AS "brand_id", "item60"."i_class_id" AS "class_id", "item60"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales28",
tpcds.sf1000.item AS "item60",
tpcds.sf1000.date_dim AS "date_dim83"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales27",
tpcds.sf1000.item AS "item61",
tpcds.sf1000.date_dim AS "date_dim84"
...
FROM tpcds.sf1000.web_sales AS "web_sales27",
tpcds.sf1000.item AS "item62",
tpcds.sf1000.date_dim AS "date_dim85"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t545" ON "t544"."ss_item_sk" = "t545"."i_item_sk") AS "t546"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales29",
tpcds.sf1000.date_dim AS "date_dim87"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales28",
tpcds.sf1000.date_dim AS "date_dim88"
...
FROM tpcds.sf1000.web_sales AS "web_sales28",
tpcds.sf1000.date_dim AS "date_dim89"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales29"
INNER JOIN (SELECT "item64"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item64",
(SELECT *
FROM (SELECT "item65"."i_brand_id" AS "brand_id", "item65"."i_class_id" AS "class_id", "item65"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales30",
tpcds.sf1000.item AS "item65",
tpcds.sf1000.date_dim AS "date_dim90"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales30",
tpcds.sf1000.item AS "item66",
tpcds.sf1000.date_dim AS "date_dim91"
...
FROM tpcds.sf1000.web_sales AS "web_sales29",
tpcds.sf1000.item AS "item67",
tpcds.sf1000.date_dim AS "date_dim92"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t587" ON "t586"."cs_item_sk" = "t587"."i_item_sk") AS "t588"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales31",
tpcds.sf1000.date_dim AS "date_dim94"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales31",
tpcds.sf1000.date_dim AS "date_dim95"
...
FROM tpcds.sf1000.web_sales AS "web_sales30",
tpcds.sf1000.date_dim AS "date_dim96"
...
FROM tpcds.sf1000.web_sales AS "web_sales31"
INNER JOIN (SELECT "item69"."i_item_sk" AS "ss_item_sk"
FROM tpcds.sf1000.item AS "item69",
(SELECT *
FROM (SELECT "item70"."i_brand_id" AS "brand_id", "item70"."i_class_id" AS "class_id", "item70"."i_category_id" AS "category_id"
FROM tpcds.sf1000.store_sales AS "store_sales32",
tpcds.sf1000.item AS "item70",
tpcds.sf1000.date_dim AS "date_dim97"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales32",
tpcds.sf1000.item AS "item71",
tpcds.sf1000.date_dim AS "date_dim98"
...
FROM tpcds.sf1000.web_sales AS "web_sales32",
tpcds.sf1000.item AS "item72",
tpcds.sf1000.date_dim AS "date_dim99"
...
INNER JOIN (SELECT "i_item_sk", "i_brand_id", "i_class_id", "i_category_id"
FROM tpcds.sf1000.item AS item) AS "t630" ON "t629"."ws_item_sk" = "t630"."i_item_sk") AS "t631"
INNER JOIN (SELECT "d_date_sk"
FROM tpcds.sf1000.date_dim AS date_dim
...
FROM tpcds.sf1000.store_sales AS "store_sales33",
tpcds.sf1000.date_dim AS "date_dim101"
...
FROM tpcds.sf1000.catalog_sales AS "catalog_sales33",
tpcds.sf1000.date_dim AS "date_dim102"
...
FROM tpcds.sf1000.web_sales AS "web_sales33",
tpcds.sf1000.date_dim AS "date_dim103"

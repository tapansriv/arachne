...
INNER JOIN (SELECT *
FROM tpcds.sf1000.inventory AS inventory) AS "t0" ON "t"."cs_item_sk" = "t0"."inv_item_sk" AND "t"."cs_quantity" > "t0"."inv_quantity_on_hand") AS "t1"
INNER JOIN (SELECT "w_warehouse_sk", "w_warehouse_name"
FROM tpcds.sf1000.warehouse AS warehouse) AS "t2" ON "t1"."inv_warehouse_sk" = "t2"."w_warehouse_sk") AS "t3"
INNER JOIN (SELECT "i_item_sk", "i_item_desc"
FROM tpcds.sf1000.item AS item) AS "t4" ON "t3"."cs_item_sk" = "t4"."i_item_sk") AS "t5"
...
FROM tpcds.sf1000.date_dim AS date_dim) AS "t18" ON "t17"."inv_date_sk" = "t18"."d_date_sk" AND "t17"."d_week_seq" = "t18"."d_week_seq") AS "t19"
INNER JOIN (SELECT "d_date_sk", "d_date"
FROM tpcds.sf1000.date_dim AS date_dim) AS "t20" ON "t19"."cs_ship_date_sk" = "t20"."d_date_sk" AND "t19"."+" < "t20"."d_date") AS "t21"
LEFT JOIN (SELECT "p_promo_sk"
FROM tpcds.sf1000.promotion AS promotion) AS "t22" ON "t21"."cs_promo_sk" = "t22"."p_promo_sk") AS "t23"
LEFT JOIN (SELECT "cr_item_sk", "cr_order_number"
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t24" ON "t23"."cs_item_sk" = "t24"."cr_item_sk" AND "t23"."cs_order_number" = "t24"."cr_order_number"
GROUP BY "t23"."i_item_desc", "t23"."w_warehouse_name", "t23"."d_week_seq"
ORDER BY COUNT(*) IS NULL DESC, COUNT(*) DESC, "t23"."i_item_desc", "t23"."w_warehouse_name", "t23"."d_week_seq"
LIMIT 100

...
FROM (tpcds.sf1000.catalog_sales AS "$cor0", LATERAL (SELECT TRUE AS "i"
...
FROM tpcds.sf1000.catalog_returns AS catalog_returns) AS "t3"
...
FROM tpcds.sf1000.call_center AS call_center

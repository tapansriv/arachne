...
FROM tpcds.sf1000.customer_address AS customer_address) AS "t12" ON "t11"."ss_addr_sk" = "t12"."ca_address_sk"
...
FROM tpcds.sf1000.customer AS customer) AS "t16" ON "t15"."ss_customer_sk" = "t16"."c_customer_sk") AS "t17"
INNER JOIN (SELECT "ca_address_sk", "ca_city"
FROM tpcds.sf1000.customer_address AS customer_address) AS "t18" ON "t17"."c_current_addr_sk" = "t18"."ca_address_sk" AND "t18"."ca_city" <> "t17"."bought_city"
ORDER BY "t17"."c_last_name", "t17"."c_first_name", "t18"."ca_city", "t17"."bought_city", "t17"."ss_ticket_number"
LIMIT 100

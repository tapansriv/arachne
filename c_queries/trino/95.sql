...
tpcds.sf1000.web_sales AS "web_sales1"
...
FROM tpcds.sf1000.web_returns AS web_returns,
...
tpcds.sf1000.web_sales AS "web_sales3"
...
FROM tpcds.sf1000.web_site AS web_site
WHERE "web_company_name" = 'pri') AS "t22" ON "t19"."ws_web_site_sk" = "t22"."web_site_sk"
ORDER BY COUNT(DISTINCT "t19"."ws_order_number") IS NULL, COUNT(DISTINCT "t19"."ws_order_number")
LIMIT 100

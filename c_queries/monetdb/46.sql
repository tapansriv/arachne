SELECT "t18"."c_last_name", "t18"."c_first_name", "t19"."ca_city", "t18"."bought_city", "t18"."ss_ticket_number", "t18"."amt", "t18"."profit"
FROM (SELECT "t16"."ss_ticket_number", "t16"."bought_city", "t16"."amt", "t16"."profit", "t17"."c_current_addr_sk", "t17"."c_first_name", "t17"."c_last_name"
...
ORDER BY "t18"."c_last_name", "t18"."c_first_name", "t19"."ca_city", "t18"."bought_city", "t18"."ss_ticket_number"
LIMIT 100
;

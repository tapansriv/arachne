...
INNER JOIN (SELECT "t15"."item_sk"
FROM (SELECT "t12"."itemdesc", "t12"."i_item_sk" AS "item_sk", "t10"."d_date" AS "solddate", COUNT(*) AS "cnt"
...
HAVING "cnt" > 4) AS "t15") AS "t17" ON "t5"."cs_item_sk" = "t17"."item_sk") AS "t18"
INNER JOIN (SELECT "t34"."c_customer_sk"
FROM (SELECT "t21"."c_customer_sk", SUM("t21"."*") AS "ssales", MAX("t32"."tpcds_cmax") AS "$f2"
...
HAVING "ssales" > 50 / 100.0 * "$f2") AS "t34") AS "t36" ON "t18"."cs_bill_customer_sk" = "t36"."c_customer_sk"
...
INNER JOIN (SELECT "t55"."item_sk"
FROM (SELECT "t52"."itemdesc", "t52"."i_item_sk" AS "item_sk", "t50"."d_date" AS "solddate", COUNT(*) AS "cnt"
...
HAVING "cnt" > 4) AS "t55") AS "t57" ON "t45"."ws_item_sk" = "t57"."item_sk") AS "t58"
INNER JOIN (SELECT "t74"."c_customer_sk"
FROM (SELECT "t61"."c_customer_sk", SUM("t61"."*") AS "ssales", MAX("t72"."tpcds_cmax") AS "$f2"
...
HAVING "ssales" > 50 / 100.0 * "$f2") AS "t74") AS "t76" ON "t58"."ws_bill_customer_sk" = "t76"."c_customer_sk"

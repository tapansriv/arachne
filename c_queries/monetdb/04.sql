SELECT "t132"."customer_id0" AS "customer_id", "t132"."customer_first_name0" AS "customer_first_name", "t132"."customer_last_name0" AS "customer_last_name", "t132"."customer_preferred_cust_flag0" AS "customer_preferred_cust_flag"
...
WHERE "sale_type" = 'w' AND "dyear" = 2001 AND "year_total" > 0) AS "t131" ON "t105"."customer_id" = "t131"."customer_id") AS "t132"
INNER JOIN (SELECT "customer_id", "year_total"
FROM (SELECT *
FROM (SELECT "t135"."c_customer_id" AS "customer_id", "t135"."c_first_name" AS "customer_first_name", "t135"."c_last_name" AS "customer_last_name", "t135"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t135"."c_birth_country" AS "customer_birth_country", "t135"."c_login" AS "customer_login", "t135"."c_email_address" AS "customer_email_address", "t136"."d_year" AS "dyear", SUM("t135"."/") AS "year_total", 's' AS "sale_type"
FROM (SELECT "t133"."c_customer_id", "t133"."c_first_name", "t133"."c_last_name", "t133"."c_preferred_cust_flag", "t133"."c_birth_country", "t133"."c_login", "t133"."c_email_address", "t134"."ss_sold_date_sk", "t134"."/"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t133"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM store_sales) AS "t134" ON "t133"."c_customer_sk" = "t134"."ss_customer_sk") AS "t135"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t136" ON "t135"."ss_sold_date_sk" = "t136"."d_date_sk"
GROUP BY "t135"."c_customer_id", "t135"."c_first_name", "t135"."c_last_name", "t135"."c_preferred_cust_flag", "t135"."c_birth_country", "t135"."c_login", "t135"."c_email_address", "t136"."d_year"
UNION ALL
SELECT "t142"."c_customer_id" AS "customer_id", "t142"."c_first_name" AS "customer_first_name", "t142"."c_last_name" AS "customer_last_name", "t142"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t142"."c_birth_country" AS "customer_birth_country", "t142"."c_login" AS "customer_login", "t142"."c_email_address" AS "customer_email_address", "t143"."d_year" AS "dyear", SUM("t142"."/") AS "year_total", 'c' AS "sale_type"
FROM (SELECT "t140"."c_customer_id", "t140"."c_first_name", "t140"."c_last_name", "t140"."c_preferred_cust_flag", "t140"."c_birth_country", "t140"."c_login", "t140"."c_email_address", "t141"."cs_sold_date_sk", "t141"."/"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t140"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM catalog_sales) AS "t141" ON "t140"."c_customer_sk" = "t141"."cs_bill_customer_sk") AS "t142"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t143" ON "t142"."cs_sold_date_sk" = "t143"."d_date_sk"
GROUP BY "t142"."c_customer_id", "t142"."c_first_name", "t142"."c_last_name", "t142"."c_preferred_cust_flag", "t142"."c_birth_country", "t142"."c_login", "t142"."c_email_address", "t143"."d_year") AS "t"
UNION ALL
SELECT "t150"."c_customer_id" AS "customer_id", "t150"."c_first_name" AS "customer_first_name", "t150"."c_last_name" AS "customer_last_name", "t150"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t150"."c_birth_country" AS "customer_birth_country", "t150"."c_login" AS "customer_login", "t150"."c_email_address" AS "customer_email_address", "t151"."d_year" AS "dyear", SUM("t150"."/") AS "year_total", 'w' AS "sale_type"
FROM (SELECT "t148"."c_customer_id", "t148"."c_first_name", "t148"."c_last_name", "t148"."c_preferred_cust_flag", "t148"."c_birth_country", "t148"."c_login", "t148"."c_email_address", "t149"."ws_sold_date_sk", "t149"."/"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM customer) AS "t148"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM web_sales) AS "t149" ON "t148"."c_customer_sk" = "t149"."ws_bill_customer_sk") AS "t150"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t151" ON "t150"."ws_sold_date_sk" = "t151"."d_date_sk"
GROUP BY "t150"."c_customer_id", "t150"."c_first_name", "t150"."c_last_name", "t150"."c_preferred_cust_flag", "t150"."c_birth_country", "t150"."c_login", "t150"."c_email_address", "t151"."d_year") AS "t155"
WHERE "sale_type" = 'w' AND "dyear" = 2001 + 1) AS "t158" ON "t132"."customer_id" = "t158"."customer_id" AND "t132"."CASE" > CASE WHEN "t132".">" THEN CAST("t158"."year_total" / "t132"."year_total3" AS DECIMAL(19, 0)) ELSE NULL END
ORDER BY "t132"."customer_id0", "t132"."customer_first_name0", "t132"."customer_last_name0", "t132"."customer_preferred_cust_flag0"
LIMIT 100
;

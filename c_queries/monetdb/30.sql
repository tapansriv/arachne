...
FROM customer_address) AS "t4" ON "t3"."wr_returning_addr_sk" = "t4"."ca_address_sk"
...
FROM customer) AS "t23" ON "t22"."ca_address_sk" = "t23"."c_current_addr_sk" AND "t19"."ctr_customer_sk" = "t23"."c_customer_sk"

...
FROM (SELECT "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id", "sales_cnt", "sales_amt", CAST("sales_cnt" AS DECIMAL(17, 2)) AS "CAST"
...
FROM store_returns) AS "t15" ON "t14"."ss_ticket_number" = "t15"."sr_ticket_number" AND "t14"."ss_item_sk" = "t15"."sr_item_sk") AS "t"
UNION
...
HAVING "d_year" = 2002) AS "t29") AS "t30"
INNER JOIN (SELECT "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id", "sales_cnt", "sales_amt", CAST("sales_cnt" AS DECIMAL(17, 2)) AS "CAST"
FROM (SELECT "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id", SUM("sales_cnt") AS "sales_cnt", SUM("sales_amt") AS "sales_amt"
FROM (SELECT *
...
LEFT JOIN (SELECT "sr_item_sk", "sr_ticket_number", "sr_return_quantity", "sr_return_amt", "sr_return_quantity" AS "CAST", "sr_return_amt" AS "CAST5"
FROM store_returns) AS "t47" ON "t46"."ss_ticket_number" = "t47"."sr_ticket_number" AND "t46"."ss_item_sk" = "t47"."sr_item_sk") AS "t"
UNION
...
GROUP BY "d_year", "i_brand_id", "i_class_id", "i_category_id", "i_manufact_id"
HAVING "d_year" = 2002 - 1) AS "t61") AS "t62" ON "t30"."i_brand_id" = "t62"."i_brand_id" AND "t30"."i_class_id" = "t62"."i_class_id" AND "t30"."i_category_id" = "t62"."i_category_id" AND "t30"."i_manufact_id" = "t62"."i_manufact_id" AND "t30"."CAST" / "t62"."CAST" < 0.9

...
HAVING "ss_sold_year" = 2000) AS "t5"
...
WHERE CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS SIGNED) ELSE 0 END > 0 OR CASE WHEN "t17"."cs_qty" IS NOT NULL THEN CAST("t17"."cs_qty" AS SIGNED) ELSE 0 END > 0
ORDER BY "t5"."ss_sold_year" IS NULL, "t5"."ss_sold_year", "t5"."ss_item_sk" IS NULL, "t5"."ss_item_sk", "t5"."ss_customer_sk" IS NULL, "t5"."ss_customer_sk", "t5"."ss_qty" DESC, "t5"."ss_wc" DESC, "t5"."ss_sp" DESC, CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS SIGNED) ELSE 0 END + CASE WHEN "t17"."cs_qty" IS NOT NULL THEN CAST("t17"."cs_qty" AS SIGNED) ELSE 0 END IS NULL, CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS SIGNED) ELSE 0 END + CASE WHEN "t17"."cs_qty" IS NOT NULL THEN CAST("t17"."cs_qty" AS SIGNED) ELSE 0 END, CASE WHEN "t11"."ws_wc" IS NOT NULL THEN CAST("t11"."ws_wc" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "t17"."cs_wc" IS NOT NULL THEN CAST("t17"."cs_wc" AS DECIMAL(19, 0)) ELSE 0 END IS NULL, CASE WHEN "t11"."ws_wc" IS NOT NULL THEN CAST("t11"."ws_wc" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "t17"."cs_wc" IS NOT NULL THEN CAST("t17"."cs_wc" AS DECIMAL(19, 0)) ELSE 0 END, CASE WHEN "t11"."ws_sp" IS NOT NULL THEN CAST("t11"."ws_sp" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "t17"."cs_sp" IS NOT NULL THEN CAST("t17"."cs_sp" AS DECIMAL(19, 0)) ELSE 0 END IS NULL, CASE WHEN "t11"."ws_sp" IS NOT NULL THEN CAST("t11"."ws_sp" AS DECIMAL(19, 0)) ELSE 0 END + CASE WHEN "t17"."cs_sp" IS NOT NULL THEN CAST("t17"."cs_sp" AS DECIMAL(19, 0)) ELSE 0 END, ROUND("t5"."ss_qty" * 1.00 / (CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS SIGNED) ELSE 0 END + CASE WHEN "t17"."cs_qty" IS NOT NULL THEN CAST("t17"."cs_qty" AS SIGNED) ELSE 0 END), 2) IS NULL, ROUND("t5"."ss_qty" * 1.00 / (CASE WHEN "t11"."ws_qty" IS NOT NULL THEN CAST("t11"."ws_qty" AS SIGNED) ELSE 0 END + CASE WHEN "t17"."cs_qty" IS NOT NULL THEN CAST("t17"."cs_qty" AS SIGNED) ELSE 0 END), 2)
LIMIT 100
;

SELECT "t6"."s_store_name", "t6"."s_store_id", SUM("t3"."CASE") AS "sun_sales", SUM("t3"."CASE2") AS "mon_sales", SUM("t3"."CASE3") AS "tue_sales", SUM("t3"."CASE4") AS "wed_sales", SUM("t3"."CASE5") AS "thu_sales", SUM("t3"."CASE6") AS "fri_sales", SUM("t3"."CASE7") AS "sat_sales"
...
GROUP BY "t6"."s_store_name", "t6"."s_store_id"
ORDER BY "t6"."s_store_name" IS NULL, "t6"."s_store_name", "t6"."s_store_id" IS NULL, "t6"."s_store_id", SUM("t3"."CASE") IS NULL, SUM("t3"."CASE"), SUM("t3"."CASE2") IS NULL, SUM("t3"."CASE2"), SUM("t3"."CASE3") IS NULL, SUM("t3"."CASE3"), SUM("t3"."CASE4") IS NULL, SUM("t3"."CASE4"), SUM("t3"."CASE5") IS NULL, SUM("t3"."CASE5"), SUM("t3"."CASE6") IS NULL, SUM("t3"."CASE6"), SUM("t3"."CASE7") IS NULL, SUM("t3"."CASE7")
LIMIT 100
;

...
FROM (SELECT "t13"."c_last_name", "t13"."c_first_name", "t13"."s_store_name", SUM("t13"."netpaid") AS "paid"
FROM (SELECT "t9"."c_last_name", "t9"."c_first_name", "t9"."s_store_name", "t10"."ca_state", "t9"."s_state", "t9"."i_color", "t9"."i_current_price", "t9"."i_manager_id", "t9"."i_units", "t9"."i_size", SUM("t9"."ss_net_paid") AS "netpaid"
...
HAVING "t9"."i_color" = 'peach') AS "t13"
GROUP BY "t13"."c_last_name", "t13"."c_first_name", "t13"."s_store_name") AS "t16"

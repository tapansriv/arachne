...
FROM (SELECT "t40"."product_name", "t40"."item_sk", "t40"."store_name", "t40"."store_zip", "t40"."b_street_number", "t40"."b_street_name", "t40"."b_city", "t40"."b_zip", "t40"."c_street_number", "t40"."c_street_name", "t40"."c_city", "t40"."c_zip", "t40"."syear", "t40"."cnt", "t40"."s1", "t40"."s2", "t40"."s3"
FROM (SELECT "t37"."i_product_name" AS "product_name", "t37"."i_item_sk" AS "item_sk", "t34"."s_store_name" AS "store_name", "t34"."s_zip" AS "store_zip", "t34"."ca_street_number" AS "b_street_number", "t34"."ca_street_name" AS "b_street_name", "t34"."ca_city" AS "b_city", "t34"."ca_zip" AS "b_zip", "t34"."ca_street_number0" AS "c_street_number", "t34"."ca_street_name0" AS "c_street_name", "t34"."ca_city0" AS "c_city", "t34"."ca_zip0" AS "c_zip", "t34"."d_year" AS "syear", "t34"."d_year0" AS "fsyear", "t34"."d_year1" AS "s2year", COUNT(*) AS "cnt", SUM("t34"."ss_wholesale_cost") AS "s1", SUM("t34"."ss_list_price") AS "s2", SUM("t34"."ss_coupon_amt") AS "s3"
...
INNER JOIN (SELECT "t6"."cs_item_sk"
FROM (SELECT "t2"."cs_item_sk", SUM("t2"."cs_ext_list_price") AS "sale", SUM("t3"."+") AS "refund"
...
FROM catalog_returns) AS "t3" ON "t2"."cs_item_sk" = "t3"."cr_item_sk" AND "t2"."cs_order_number" = "t3"."cr_order_number"
GROUP BY "t2"."cs_item_sk"
HAVING "sale" > 2 * "refund") AS "t6") AS "t7" ON "t1"."ss_item_sk" = "t7"."cs_item_sk") AS "t8"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t9" ON "t8"."ss_sold_date_sk" = "t9"."d_date_sk") AS "t10",
(SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t11",
(SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t12"
INNER JOIN (SELECT "s_store_sk", "s_store_name", "s_zip"
FROM store) AS "t13" ON "t10"."ss_store_sk" = "t13"."s_store_sk") AS "t14"
...
FROM customer) AS "t15" ON "t14"."ss_customer_sk" = "t15"."c_customer_sk" AND "t14"."d_date_sk0" = "t15"."c_first_sales_date_sk" AND "t14"."d_date_sk1" = "t15"."c_first_shipto_date_sk") AS "t16"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM customer_demographics) AS "t17" ON "t16"."ss_cdemo_sk" = "t17"."cd_demo_sk") AS "t18"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM customer_demographics) AS "t19" ON "t18"."c_current_cdemo_sk" = "t19"."cd_demo_sk" AND "t18"."cd_marital_status" <> "t19"."cd_marital_status") AS "t20"
INNER JOIN (SELECT "p_promo_sk"
FROM promotion) AS "t21" ON "t20"."ss_promo_sk" = "t21"."p_promo_sk") AS "t22"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM household_demographics) AS "t23" ON "t22"."ss_hdemo_sk" = "t23"."hd_demo_sk") AS "t24"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM household_demographics) AS "t25" ON "t24"."c_current_hdemo_sk" = "t25"."hd_demo_sk") AS "t26"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM customer_address) AS "t27" ON "t26"."ss_addr_sk" = "t27"."ca_address_sk") AS "t28"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM customer_address) AS "t29" ON "t28"."c_current_addr_sk" = "t29"."ca_address_sk") AS "t30"
INNER JOIN (SELECT "ib_income_band_sk"
FROM income_band) AS "t31" ON "t30"."hd_income_band_sk" = "t31"."ib_income_band_sk") AS "t32"
INNER JOIN (SELECT "ib_income_band_sk"
FROM income_band) AS "t33" ON "t32"."hd_income_band_sk0" = "t33"."ib_income_band_sk") AS "t34"
...
HAVING "syear" = 1999) AS "t40") AS "t41"
INNER JOIN (SELECT "t83"."item_sk", "t83"."store_name", "t83"."store_zip", "t83"."syear", "t83"."cnt", "t83"."s1", "t83"."s2", "t83"."s3"
FROM (SELECT "t80"."i_product_name" AS "product_name", "t80"."i_item_sk" AS "item_sk", "t77"."s_store_name" AS "store_name", "t77"."s_zip" AS "store_zip", "t77"."ca_street_number" AS "b_street_number", "t77"."ca_street_name" AS "b_street_name", "t77"."ca_city" AS "b_city", "t77"."ca_zip" AS "b_zip", "t77"."ca_street_number0" AS "c_street_number", "t77"."ca_street_name0" AS "c_street_name", "t77"."ca_city0" AS "c_city", "t77"."ca_zip0" AS "c_zip", "t77"."d_year" AS "syear", "t77"."d_year0" AS "fsyear", "t77"."d_year1" AS "s2year", COUNT(*) AS "cnt", SUM("t77"."ss_wholesale_cost") AS "s1", SUM("t77"."ss_list_price") AS "s2", SUM("t77"."ss_coupon_amt") AS "s3"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_customer_sk", "ss_cdemo_sk", "ss_hdemo_sk", "ss_addr_sk", "ss_store_sk", "ss_promo_sk", "ss_ticket_number", "ss_wholesale_cost", "ss_list_price", "ss_coupon_amt"
FROM store_sales) AS "t42"
INNER JOIN (SELECT "sr_item_sk", "sr_ticket_number"
FROM store_returns) AS "t43" ON "t42"."ss_item_sk" = "t43"."sr_item_sk" AND "t42"."ss_ticket_number" = "t43"."sr_ticket_number") AS "t44"
INNER JOIN (SELECT "t49"."cs_item_sk"
FROM (SELECT "t45"."cs_item_sk", SUM("t45"."cs_ext_list_price") AS "sale", SUM("t46"."+") AS "refund"
FROM (SELECT "cs_item_sk", "cs_order_number", "cs_ext_list_price"
FROM catalog_sales) AS "t45"
INNER JOIN (SELECT "cr_item_sk", "cr_order_number", "cr_refunded_cash" + "cr_reversed_charge" + "cr_store_credit" AS "+"
FROM catalog_returns) AS "t46" ON "t45"."cs_item_sk" = "t46"."cr_item_sk" AND "t45"."cs_order_number" = "t46"."cr_order_number"
GROUP BY "t45"."cs_item_sk"
HAVING "sale" > 2 * "refund") AS "t49") AS "t50" ON "t44"."ss_item_sk" = "t50"."cs_item_sk") AS "t51"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t52" ON "t51"."ss_sold_date_sk" = "t52"."d_date_sk") AS "t53",
(SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t54",
(SELECT "d_date_sk", "d_year"
FROM date_dim) AS "t55"
INNER JOIN (SELECT "s_store_sk", "s_store_name", "s_zip"
FROM store) AS "t56" ON "t53"."ss_store_sk" = "t56"."s_store_sk") AS "t57"
INNER JOIN (SELECT "c_customer_sk", "c_current_cdemo_sk", "c_current_hdemo_sk", "c_current_addr_sk", "c_first_shipto_date_sk", "c_first_sales_date_sk"
FROM customer) AS "t58" ON "t57"."ss_customer_sk" = "t58"."c_customer_sk" AND "t57"."d_date_sk0" = "t58"."c_first_sales_date_sk" AND "t57"."d_date_sk1" = "t58"."c_first_shipto_date_sk") AS "t59"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM customer_demographics) AS "t60" ON "t59"."ss_cdemo_sk" = "t60"."cd_demo_sk") AS "t61"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status"
FROM customer_demographics) AS "t62" ON "t61"."c_current_cdemo_sk" = "t62"."cd_demo_sk" AND "t61"."cd_marital_status" <> "t62"."cd_marital_status") AS "t63"
INNER JOIN (SELECT "p_promo_sk"
FROM promotion) AS "t64" ON "t63"."ss_promo_sk" = "t64"."p_promo_sk") AS "t65"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM household_demographics) AS "t66" ON "t65"."ss_hdemo_sk" = "t66"."hd_demo_sk") AS "t67"
INNER JOIN (SELECT "hd_demo_sk", "hd_income_band_sk"
FROM household_demographics) AS "t68" ON "t67"."c_current_hdemo_sk" = "t68"."hd_demo_sk") AS "t69"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM customer_address) AS "t70" ON "t69"."ss_addr_sk" = "t70"."ca_address_sk") AS "t71"
INNER JOIN (SELECT "ca_address_sk", "ca_street_number", "ca_street_name", "ca_city", "ca_zip"
FROM customer_address) AS "t72" ON "t71"."c_current_addr_sk" = "t72"."ca_address_sk") AS "t73"
INNER JOIN (SELECT "ib_income_band_sk"
FROM income_band) AS "t74" ON "t73"."hd_income_band_sk" = "t74"."ib_income_band_sk") AS "t75"
INNER JOIN (SELECT "ib_income_band_sk"
FROM income_band) AS "t76" ON "t75"."hd_income_band_sk0" = "t76"."ib_income_band_sk") AS "t77"
INNER JOIN (SELECT "i_item_sk", "i_product_name"
FROM item
...
HAVING "syear" = 1999 + 1) AS "t83") AS "t84" ON "t41"."item_sk" = "t84"."item_sk" AND "t41"."cnt" >= "t84"."cnt" AND "t41"."store_name" = "t84"."store_name" AND "t41"."store_zip" = "t84"."store_zip"
ORDER BY "t41"."product_name" IS NULL, "t41"."product_name", "t41"."store_name" IS NULL, "t41"."store_name", "t84"."cnt" IS NULL, "t84"."cnt", "t41"."s1" IS NULL, "t41"."s1", "t84"."s1" IS NULL, "t84"."s1"
;

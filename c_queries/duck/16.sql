...
FROM '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS catalog_returns) AS "t3"
...
FROM '/mnt/disks/tpcds/parquet/call_center.parquet' AS call_center
WHERE "cc_county" = 'Williamson County') AS "t21" ON "t18"."cs_call_center_sk" = "t21"."cc_call_center_sk"
ORDER BY COUNT(DISTINCT "t18"."cs_order_number")

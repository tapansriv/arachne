...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t14" ON "t13"."ss_customer_sk" = "t14"."c_customer_sk"
ORDER BY "t14"."c_last_name" NULLS FIRST, "t14"."c_first_name" NULLS FIRST, "t14"."c_salutation" NULLS FIRST, "t14"."c_preferred_cust_flag" DESC, "t13"."ss_ticket_number" NULLS FIRST

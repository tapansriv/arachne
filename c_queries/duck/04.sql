...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t25"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t26" ON "t25"."c_customer_sk" = "t26"."ss_customer_sk") AS "t27"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t28" ON "t27"."ss_sold_date_sk" = "t28"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t32"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/catalog_sales.parquet' AS catalog_sales) AS "t33" ON "t32"."c_customer_sk" = "t33"."cs_bill_customer_sk") AS "t34"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t35" ON "t34"."cs_sold_date_sk" = "t35"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t40"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t41" ON "t40"."c_customer_sk" = "t41"."ws_bill_customer_sk") AS "t42"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t43" ON "t42"."ws_sold_date_sk" = "t43"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t52"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t53" ON "t52"."c_customer_sk" = "t53"."ss_customer_sk") AS "t54"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t55" ON "t54"."ss_sold_date_sk" = "t55"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t59"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/catalog_sales.parquet' AS catalog_sales) AS "t60" ON "t59"."c_customer_sk" = "t60"."cs_bill_customer_sk") AS "t61"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t62" ON "t61"."cs_sold_date_sk" = "t62"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t67"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t68" ON "t67"."c_customer_sk" = "t68"."ws_bill_customer_sk") AS "t69"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t70" ON "t69"."ws_sold_date_sk" = "t70"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t79"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t80" ON "t79"."c_customer_sk" = "t80"."ss_customer_sk") AS "t81"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t82" ON "t81"."ss_sold_date_sk" = "t82"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t86"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/catalog_sales.parquet' AS catalog_sales) AS "t87" ON "t86"."c_customer_sk" = "t87"."cs_bill_customer_sk") AS "t88"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t89" ON "t88"."cs_sold_date_sk" = "t89"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t94"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t95" ON "t94"."c_customer_sk" = "t95"."ws_bill_customer_sk") AS "t96"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t97" ON "t96"."ws_sold_date_sk" = "t97"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t106"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t107" ON "t106"."c_customer_sk" = "t107"."ss_customer_sk") AS "t108"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t109" ON "t108"."ss_sold_date_sk" = "t109"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t113"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/catalog_sales.parquet' AS catalog_sales) AS "t114" ON "t113"."c_customer_sk" = "t114"."cs_bill_customer_sk") AS "t115"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t116" ON "t115"."cs_sold_date_sk" = "t116"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t121"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t122" ON "t121"."c_customer_sk" = "t122"."ws_bill_customer_sk") AS "t123"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t124" ON "t123"."ws_sold_date_sk" = "t124"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t134"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", ("ss_ext_list_price" - "ss_ext_wholesale_cost" - "ss_ext_discount_amt" + "ss_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t135" ON "t134"."c_customer_sk" = "t135"."ss_customer_sk") AS "t136"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t137" ON "t136"."ss_sold_date_sk" = "t137"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t141"
INNER JOIN (SELECT "cs_sold_date_sk", "cs_bill_customer_sk", ("cs_ext_list_price" - "cs_ext_wholesale_cost" - "cs_ext_discount_amt" + "cs_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/catalog_sales.parquet' AS catalog_sales) AS "t142" ON "t141"."c_customer_sk" = "t142"."cs_bill_customer_sk") AS "t143"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t144" ON "t143"."cs_sold_date_sk" = "t144"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t149"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", ("ws_ext_list_price" - "ws_ext_wholesale_cost" - "ws_ext_discount_amt" + "ws_ext_sales_price") / 2 AS "/"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t150" ON "t149"."c_customer_sk" = "t150"."ws_bill_customer_sk") AS "t151"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t152" ON "t151"."ws_sold_date_sk" = "t152"."d_date_sk"

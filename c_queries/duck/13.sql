...
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t0" ON "t"."ss_store_sk" = "t0"."s_store_sk") AS "t1",
...
FROM '/mnt/disks/tpcds/parquet/customer_demographics.parquet' AS customer_demographics) AS "t2") AS "t3"
INNER JOIN (SELECT "hd_demo_sk", "hd_dep_count" = 3 AS "=", "hd_dep_count" = 1 AS "=2"
FROM '/mnt/disks/tpcds/parquet/household_demographics.parquet' AS household_demographics) AS "t4" ON "t3"."ss_hdemo_sk" = "t4"."hd_demo_sk" AND ("t3"."=" AND "t3"."=10") AND ("t3"."=11" AND ("t3"."SEARCH" AND "t4"."=")) OR "t3"."ss_hdemo_sk" = "t4"."hd_demo_sk" AND ("t3"."=" AND "t3"."=13") AND ("t3"."=14" AND ("t3"."SEARCH15" AND "t4"."=2")) OR "t3"."ss_hdemo_sk" = "t4"."hd_demo_sk" AND ("t3"."=" AND "t3"."=16") AND ("t3"."=17" AND ("t3"."SEARCH18" AND "t4"."=2"))) AS "t5"
...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t6" ON "t5"."ss_addr_sk" = "t6"."ca_address_sk" AND "t6"."=" AND "t6"."SEARCH" AND "t5"."SEARCH" OR "t5"."ss_addr_sk" = "t6"."ca_address_sk" AND "t6"."=" AND "t6"."SEARCH3" AND "t5"."SEARCH6" OR "t5"."ss_addr_sk" = "t6"."ca_address_sk" AND "t6"."=" AND "t6"."SEARCH4" AND "t5"."SEARCH7") AS "t7"

...
LEFT JOIN '/mnt/disks/tpcds/parquet/store_returns.parquet' AS store_returns ON "store_sales"."ss_ticket_number" = "store_returns"."sr_ticket_number" AND "store_sales"."ss_item_sk" = "store_returns"."sr_item_sk"
...
LEFT JOIN '/mnt/disks/tpcds/parquet/web_returns.parquet' AS web_returns ON "web_sales"."ws_order_number" = "web_returns"."wr_order_number" AND "web_sales"."ws_item_sk" = "web_returns"."wr_item_sk"
...
LEFT JOIN '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS catalog_returns ON "catalog_sales"."cs_order_number" = "catalog_returns"."cr_order_number" AND "catalog_sales"."cs_item_sk" = "catalog_returns"."cr_item_sk"
WHERE "catalog_returns"."cr_order_number" IS NULL) AS "t14"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t15" ON "t14"."cs_sold_date_sk" = "t15"."d_date_sk"

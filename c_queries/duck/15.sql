...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t0" ON "t"."cs_bill_customer_sk" = "t0"."c_customer_sk") AS "t1"
...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t2" ON "t1"."c_current_addr_sk" = "t2"."ca_address_sk" AND ("t2"."=" OR "t2"."=3" OR ("t2"."=4" OR ("t2"."=5" OR "t2"."=6")) OR ("t2"."=7" OR ("t2"."=8" OR "t2"."=9") OR ("t2"."=10" OR ("t2"."SEARCH" OR "t1".">"))))) AS "t3"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_qoy" = 2 AND "d_year" = 2001) AS "t6" ON "t3"."cs_sold_date_sk" = "t6"."d_date_sk"
GROUP BY "t3"."ca_zip"
ORDER BY "t3"."ca_zip" NULLS FIRST

...
FROM '/mnt/disks/tpcds/parquet/store_returns.parquet' AS store_returns) AS "t0" ON "t"."ss_ticket_number" = "t0"."sr_ticket_number" AND "t"."ss_item_sk" = "t0"."sr_item_sk") AS "t1"
...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t6" ON "t5"."ss_item_sk" = "t6"."i_item_sk") AS "t7"
...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t10" ON "t9"."c_current_addr_sk" = "t10"."ca_address_sk" AND "t9"."c_birth_country" <> "t10"."UPPER" AND "t9"."s_zip" = "t10"."ca_zip"
...
'/mnt/disks/tpcds/parquet/store_returns.parquet' AS "store_returns0",
'/mnt/disks/tpcds/parquet/store.parquet' AS "store0",
'/mnt/disks/tpcds/parquet/item.parquet' AS "item0",
'/mnt/disks/tpcds/parquet/customer.parquet' AS "customer0",

...
FROM '/mnt/disks/tpcds/parquet/store_returns.parquet' AS "store_returns0",
...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t22" ON "t21"."ctr_customer_sk" = "t22"."c_customer_sk"

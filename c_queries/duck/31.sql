...
INNER JOIN (SELECT "d_date_sk", "d_year", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t35" ON "t34"."ws_sold_date_sk" = "t35"."d_date_sk") AS "t36"
INNER JOIN (SELECT "ca_address_sk", "ca_county"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t37" ON "t36"."ws_bill_addr_sk" = "t37"."ca_address_sk"
...
INNER JOIN (SELECT "d_date_sk", "d_year", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t45" ON "t44"."ws_sold_date_sk" = "t45"."d_date_sk") AS "t46"
INNER JOIN (SELECT "ca_address_sk", "ca_county"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t47" ON "t46"."ws_bill_addr_sk" = "t47"."ca_address_sk"

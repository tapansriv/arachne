...
FROM '/mnt/disks/tpcds/parquet/web_returns.parquet' AS web_returns) AS "t0" ON "t"."ws_item_sk" = "t0"."wr_item_sk" AND "t"."ws_order_number" = "t0"."wr_order_number") AS "t1"
...
FROM '/mnt/disks/tpcds/parquet/customer_demographics.parquet' AS customer_demographics) AS "t4" ON "t3"."wr_refunded_cdemo_sk" = "t4"."cd_demo_sk") AS "t6"
INNER JOIN (SELECT "cd_demo_sk", "cd_marital_status", "cd_education_status"
FROM '/mnt/disks/tpcds/parquet/customer_demographics.parquet' AS customer_demographics) AS "t7" ON "t6"."wr_returning_cdemo_sk" = "t7"."cd_demo_sk" AND ("t6"."=" AND "t6"."cd_marital_status" = "t7"."cd_marital_status" AND "t6"."=14" AND "t6"."cd_education_status" = "t7"."cd_education_status" AND "t6"."SEARCH" OR "t6"."=16" AND "t6"."cd_marital_status" = "t7"."cd_marital_status" AND "t6"."=17" AND "t6"."cd_education_status" = "t7"."cd_education_status" AND "t6"."SEARCH18" OR "t6"."=19" AND "t6"."cd_marital_status" = "t7"."cd_marital_status" AND "t6"."=20" AND "t6"."cd_education_status" = "t7"."cd_education_status" AND "t6"."SEARCH21")) AS "t9"
...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t10" ON "t9"."wr_refunded_addr_sk" = "t10"."ca_address_sk" AND ("t10"."=" AND "t10"."SEARCH" AND "t9"."SEARCH" OR "t10"."=" AND "t10"."SEARCH3" AND "t9"."SEARCH7" OR "t10"."=" AND "t10"."SEARCH4" AND "t9"."SEARCH8")) AS "t11"
...
FROM '/mnt/disks/tpcds/parquet/reason.parquet' AS reason) AS "t16" ON "t15"."wr_reason_sk" = "t16"."r_reason_sk"

...
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t0"
...
FROM '/mnt/disks/tpcds/parquet/catalog_sales.parquet' AS catalog_sales) AS "t6"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
...
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t13"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
...
ORDER BY SUM("t19"."ext_price") DESC, "t19"."i_brand_id" NULLS FIRST

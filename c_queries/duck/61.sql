...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t12" ON "t11"."ss_customer_sk" = "t12"."c_customer_sk") AS "t13"
...
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t24"
INNER JOIN (SELECT "s_store_sk"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store
...
INNER JOIN (SELECT "c_customer_sk", "c_current_addr_sk"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t33" ON "t32"."ss_customer_sk" = "t33"."c_customer_sk") AS "t34"
INNER JOIN (SELECT "ca_address_sk"
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address
...
ORDER BY "t23"."promotions", "t44"."total"

...
LEFT JOIN '/mnt/disks/tpcds/parquet/store_returns.parquet' AS store_returns ON "store_sales"."ss_item_sk" = "store_returns"."sr_item_sk" AND "store_sales"."ss_ticket_number" = "store_returns"."sr_ticket_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t" ON "store_sales"."ss_sold_date_sk" = "t"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/store.parquet' AS store ON "store_sales"."ss_store_sk" = "store"."s_store_sk"
INNER JOIN (SELECT *
...
LEFT JOIN '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS catalog_returns ON "catalog_sales"."cs_item_sk" = "catalog_returns"."cr_item_sk" AND "catalog_sales"."cs_order_number" = "catalog_returns"."cr_order_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t5" ON "catalog_sales"."cs_sold_date_sk" = "t5"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/catalog_page.parquet' AS catalog_page ON "catalog_sales"."cs_catalog_page_sk" = "catalog_page"."cp_catalog_page_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/web_returns.parquet' AS web_returns ON "web_sales"."ws_item_sk" = "web_returns"."wr_item_sk" AND "web_sales"."ws_order_number" = "web_returns"."wr_order_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t12" ON "web_sales"."ws_sold_date_sk" = "t12"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/web_site.parquet' AS web_site ON "web_sales"."ws_web_site_sk" = "web_site"."web_site_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/store_returns.parquet' AS "store_returns0" ON "store_sales0"."ss_item_sk" = "store_returns0"."sr_item_sk" AND "store_sales0"."ss_ticket_number" = "store_returns0"."sr_ticket_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t21" ON "store_sales0"."ss_sold_date_sk" = "t21"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/store.parquet' AS "store0" ON "store_sales0"."ss_store_sk" = "store0"."s_store_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS "catalog_returns0" ON "catalog_sales0"."cs_item_sk" = "catalog_returns0"."cr_item_sk" AND "catalog_sales0"."cs_order_number" = "catalog_returns0"."cr_order_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t27" ON "catalog_sales0"."cs_sold_date_sk" = "t27"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/catalog_page.parquet' AS "catalog_page0" ON "catalog_sales0"."cs_catalog_page_sk" = "catalog_page0"."cp_catalog_page_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/web_returns.parquet' AS "web_returns0" ON "web_sales0"."ws_item_sk" = "web_returns0"."wr_item_sk" AND "web_sales0"."ws_order_number" = "web_returns0"."wr_order_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t34" ON "web_sales0"."ws_sold_date_sk" = "t34"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/web_site.parquet' AS "web_site0" ON "web_sales0"."ws_web_site_sk" = "web_site0"."web_site_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/store_returns.parquet' AS "store_returns1" ON "store_sales1"."ss_item_sk" = "store_returns1"."sr_item_sk" AND "store_sales1"."ss_ticket_number" = "store_returns1"."sr_ticket_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t46" ON "store_sales1"."ss_sold_date_sk" = "t46"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/store.parquet' AS "store1" ON "store_sales1"."ss_store_sk" = "store1"."s_store_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS "catalog_returns1" ON "catalog_sales1"."cs_item_sk" = "catalog_returns1"."cr_item_sk" AND "catalog_sales1"."cs_order_number" = "catalog_returns1"."cr_order_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t52" ON "catalog_sales1"."cs_sold_date_sk" = "t52"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/catalog_page.parquet' AS "catalog_page1" ON "catalog_sales1"."cs_catalog_page_sk" = "catalog_page1"."cp_catalog_page_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item
...
LEFT JOIN '/mnt/disks/tpcds/parquet/web_returns.parquet' AS "web_returns1" ON "web_sales1"."ws_item_sk" = "web_returns1"."wr_item_sk" AND "web_sales1"."ws_order_number" = "web_returns1"."wr_order_number"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_date" >= DATE '2000-08-23' AND "d_date" <= DATE '2000-09-22') AS "t59" ON "web_sales1"."ws_sold_date_sk" = "t59"."d_date_sk"
INNER JOIN '/mnt/disks/tpcds/parquet/web_site.parquet' AS "web_site1" ON "web_sales1"."ws_web_site_sk" = "web_site1"."web_site_sk"
INNER JOIN (SELECT *
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item

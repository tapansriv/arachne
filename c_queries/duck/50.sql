...
FROM '/mnt/disks/tpcds/parquet/store_returns.parquet' AS store_returns) AS "t0" ON "t"."ss_ticket_number" = "t0"."sr_ticket_number" AND "t"."ss_item_sk" = "t0"."sr_item_sk" AND "t"."ss_customer_sk" = "t0"."sr_customer_sk") AS "t1"
...
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t2" ON "t1"."ss_store_sk" = "t2"."s_store_sk") AS "t3"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t4" ON "t3"."ss_sold_date_sk" = "t4"."d_date_sk") AS "t6"
INNER JOIN (SELECT "d_date_sk"

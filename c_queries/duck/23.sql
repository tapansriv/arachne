...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t12" ON "t10"."ss_item_sk" = "t12"."i_item_sk"
...
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t19"
INNER JOIN (SELECT "c_customer_sk"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t20" ON "t19"."ss_customer_sk" = "t20"."c_customer_sk") AS "t21",
...
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t22"
INNER JOIN (SELECT "c_customer_sk"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t23" ON "t22"."ss_customer_sk" = "t23"."c_customer_sk") AS "t24"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
...
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t39"
INNER JOIN (SELECT "c_customer_sk", "c_first_name", "c_last_name"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t40" ON "t39"."ws_bill_customer_sk" = "t40"."c_customer_sk") AS "t41"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t46"
INNER JOIN (SELECT "d_date_sk", "d_date"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_year" = 2000 OR "d_year" = 2000 + 1 OR "d_year" = 2000 + 2 OR "d_year" = 2000 + 3) AS "t49" ON "t46"."ss_sold_date_sk" = "t49"."d_date_sk") AS "t50"
INNER JOIN (SELECT SUBSTRING("i_item_desc" FROM 1 FOR 30) AS "itemdesc", "i_item_sk"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t52" ON "t50"."ss_item_sk" = "t52"."i_item_sk"
...
FROM (SELECT "ss_customer_sk", "ss_quantity" * "ss_sales_price" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t59"
INNER JOIN (SELECT "c_customer_sk"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t60" ON "t59"."ss_customer_sk" = "t60"."c_customer_sk") AS "t61",
...
INNER JOIN (SELECT "c_customer_sk"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t63" ON "t62"."ss_customer_sk" = "t63"."c_customer_sk") AS "t64"
INNER JOIN (SELECT "d_date_sk"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim

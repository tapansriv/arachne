...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t15" ON "t14"."ss_customer_sk" = "t15"."c_customer_sk"
ORDER BY "t15"."c_last_name" NULLS FIRST, "t15"."c_first_name" NULLS FIRST, "t14"."SUBSTRING" NULLS FIRST, "t14"."profit" NULLS FIRST

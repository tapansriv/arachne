...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t6" ON "t5"."ss_item_sk" = "t6"."i_item_sk"
...
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t15" ON "t14"."ss_store_sk" = "t15"."s_store_sk") AS "t16"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t17" ON "t16"."ss_item_sk" = "t17"."i_item_sk"
...
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t29" ON "t28"."ss_store_sk" = "t29"."s_store_sk") AS "t30"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t31" ON "t30"."ss_item_sk" = "t31"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price" * "ss_quantity" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t38"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_month_seq" >= 1200 AND "d_month_seq" <= 1200 + 11) AS "t41" ON "t38"."ss_sold_date_sk" = "t41"."d_date_sk") AS "t42"
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t43" ON "t42"."ss_store_sk" = "t43"."s_store_sk") AS "t44"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t45" ON "t44"."ss_item_sk" = "t45"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price" * "ss_quantity" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t52"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_month_seq" >= 1200 AND "d_month_seq" <= 1200 + 11) AS "t55" ON "t52"."ss_sold_date_sk" = "t55"."d_date_sk") AS "t56"
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t57" ON "t56"."ss_store_sk" = "t57"."s_store_sk") AS "t58"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t59" ON "t58"."ss_item_sk" = "t59"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price" * "ss_quantity" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t66"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_month_seq" >= 1200 AND "d_month_seq" <= 1200 + 11) AS "t69" ON "t66"."ss_sold_date_sk" = "t69"."d_date_sk") AS "t70"
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t71" ON "t70"."ss_store_sk" = "t71"."s_store_sk") AS "t72"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t73" ON "t72"."ss_item_sk" = "t73"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price" * "ss_quantity" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t80"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_month_seq" >= 1200 AND "d_month_seq" <= 1200 + 11) AS "t83" ON "t80"."ss_sold_date_sk" = "t83"."d_date_sk") AS "t84"
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t85" ON "t84"."ss_store_sk" = "t85"."s_store_sk") AS "t86"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t87" ON "t86"."ss_item_sk" = "t87"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price" * "ss_quantity" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t94"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_month_seq" >= 1200 AND "d_month_seq" <= 1200 + 11) AS "t97" ON "t94"."ss_sold_date_sk" = "t97"."d_date_sk") AS "t98"
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t99" ON "t98"."ss_store_sk" = "t99"."s_store_sk") AS "t100"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t101" ON "t100"."ss_item_sk" = "t101"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_store_sk", "ss_sales_price" * "ss_quantity" AS "*"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t108"
INNER JOIN (SELECT "d_date_sk", "d_year", "d_moy", "d_qoy"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim
WHERE "d_month_seq" >= 1200 AND "d_month_seq" <= 1200 + 11) AS "t111" ON "t108"."ss_sold_date_sk" = "t111"."d_date_sk") AS "t112"
INNER JOIN (SELECT "s_store_sk", "s_store_id"
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t113" ON "t112"."ss_store_sk" = "t113"."s_store_sk") AS "t114"
INNER JOIN (SELECT "i_item_sk", "i_brand", "i_class", "i_category", "i_product_name"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t115" ON "t114"."ss_item_sk" = "t115"."i_item_sk"

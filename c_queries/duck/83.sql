...
FROM '/mnt/disks/tpcds/parquet/web_returns.parquet' AS web_returns) AS "t30"
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t31" ON "t30"."wr_item_sk" = "t31"."i_item_sk") AS "t32"

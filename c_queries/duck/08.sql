...
FROM '/mnt/disks/tpcds/parquet/store.parquet' AS store) AS "t4" ON "t3"."ss_store_sk" = "t4"."s_store_sk") AS "t5"
...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t9"

...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t11" ON "t10"."ss_item_sk" = "t11"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_cdemo_sk", "ss_store_sk", "ss_quantity", "ss_list_price", "ss_sales_price", "ss_coupon_amt"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t15"
INNER JOIN (SELECT "cd_demo_sk"
FROM '/mnt/disks/tpcds/parquet/customer_demographics.parquet' AS customer_demographics
...
INNER JOIN (SELECT "i_item_sk", "i_item_id"
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t28" ON "t27"."ss_item_sk" = "t28"."i_item_sk"
...
FROM (SELECT "ss_sold_date_sk", "ss_item_sk", "ss_cdemo_sk", "ss_store_sk", "ss_quantity", "ss_list_price", "ss_sales_price", "ss_coupon_amt"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t33"
INNER JOIN (SELECT "cd_demo_sk"
FROM '/mnt/disks/tpcds/parquet/customer_demographics.parquet' AS customer_demographics
...
FROM '/mnt/disks/tpcds/parquet/item.parquet' AS item) AS "t46" ON "t45"."ss_item_sk" = "t46"."i_item_sk") AS "t50"

...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t4" ON "t3"."cr_returning_addr_sk" = "t4"."ca_address_sk"
...
FROM '/mnt/disks/tpcds/parquet/catalog_returns.parquet' AS "catalog_returns0",
...
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t22" ON "t21"."ca_address_sk" = "t22"."c_current_addr_sk" AND "t19"."ctr_customer_sk" = "t22"."c_customer_sk"
ORDER BY "t22"."c_customer_id", "t22"."c_salutation", "t22"."c_first_name", "t22"."c_last_name", "t21"."ca_street_number", "t21"."ca_street_name", "t21"."ca_street_type", "t21"."ca_suite_number", "t21"."ca_city", "t21"."ca_county", "t21"."ca_state", "t21"."ca_zip", "t21"."ca_country", "t21"."ca_gmt_offset", "t21"."ca_location_type", "t19"."ctr_total_return"

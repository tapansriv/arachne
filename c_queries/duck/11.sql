SELECT "t55"."customer_id0" AS "customer_id", "t55"."customer_first_name0" AS "customer_first_name", "t55"."customer_last_name0" AS "customer_last_name", "t55"."customer_preferred_cust_flag0" AS "customer_preferred_cust_flag"
FROM (SELECT "t35"."customer_id", "t35"."customer_id0", "t35"."customer_first_name0", "t35"."customer_last_name0", "t35"."customer_preferred_cust_flag0", "t53"."year_total" AS "year_total1", "t53".">", CASE WHEN "t35".">" THEN "t35"."/" ELSE 0.0 END AS "CASE"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t17"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", "ss_ext_list_price" - "ss_ext_discount_amt" AS "-"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t18" ON "t17"."c_customer_sk" = "t18"."ss_customer_sk") AS "t19"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t20" ON "t19"."ss_sold_date_sk" = "t20"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t24"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", "ws_ext_list_price" - "ws_ext_discount_amt" AS "-"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t25" ON "t24"."c_customer_sk" = "t25"."ws_bill_customer_sk") AS "t26"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t27" ON "t26"."ws_sold_date_sk" = "t27"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t36"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", "ss_ext_list_price" - "ss_ext_discount_amt" AS "-"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t37" ON "t36"."c_customer_sk" = "t37"."ss_customer_sk") AS "t38"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t39" ON "t38"."ss_sold_date_sk" = "t39"."d_date_sk"
...
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t43"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", "ws_ext_list_price" - "ws_ext_discount_amt" AS "-"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t44" ON "t43"."c_customer_sk" = "t44"."ws_bill_customer_sk") AS "t45"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t46" ON "t45"."ws_sold_date_sk" = "t46"."d_date_sk"
...
WHERE "sale_type" = 'w' AND "dyear" = 2001 AND "year_total" > 0) AS "t53" ON "t35"."customer_id" = "t53"."customer_id") AS "t55"
INNER JOIN (SELECT "customer_id", "year_total" * 1.0000 AS "*"
FROM (SELECT "t58"."c_customer_id" AS "customer_id", "t58"."c_first_name" AS "customer_first_name", "t58"."c_last_name" AS "customer_last_name", "t58"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t58"."c_birth_country" AS "customer_birth_country", "t58"."c_login" AS "customer_login", "t58"."c_email_address" AS "customer_email_address", "t59"."d_year" AS "dyear", SUM("t58"."-") AS "year_total", 's' AS "sale_type"
FROM (SELECT "t56"."c_customer_id", "t56"."c_first_name", "t56"."c_last_name", "t56"."c_preferred_cust_flag", "t56"."c_birth_country", "t56"."c_login", "t56"."c_email_address", "t57"."ss_sold_date_sk", "t57"."-"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t56"
INNER JOIN (SELECT "ss_sold_date_sk", "ss_customer_sk", "ss_ext_list_price" - "ss_ext_discount_amt" AS "-"
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t57" ON "t56"."c_customer_sk" = "t57"."ss_customer_sk") AS "t58"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t59" ON "t58"."ss_sold_date_sk" = "t59"."d_date_sk"
GROUP BY "t58"."c_customer_id", "t58"."c_first_name", "t58"."c_last_name", "t58"."c_preferred_cust_flag", "t58"."c_birth_country", "t58"."c_login", "t58"."c_email_address", "t59"."d_year"
UNION ALL
SELECT "t65"."c_customer_id" AS "customer_id", "t65"."c_first_name" AS "customer_first_name", "t65"."c_last_name" AS "customer_last_name", "t65"."c_preferred_cust_flag" AS "customer_preferred_cust_flag", "t65"."c_birth_country" AS "customer_birth_country", "t65"."c_login" AS "customer_login", "t65"."c_email_address" AS "customer_email_address", "t66"."d_year" AS "dyear", SUM("t65"."-") AS "year_total", 'w' AS "sale_type"
FROM (SELECT "t63"."c_customer_id", "t63"."c_first_name", "t63"."c_last_name", "t63"."c_preferred_cust_flag", "t63"."c_birth_country", "t63"."c_login", "t63"."c_email_address", "t64"."ws_sold_date_sk", "t64"."-"
FROM (SELECT "c_customer_sk", "c_customer_id", "c_first_name", "c_last_name", "c_preferred_cust_flag", "c_birth_country", "c_login", "c_email_address"
FROM '/mnt/disks/tpcds/parquet/customer.parquet' AS customer) AS "t63"
INNER JOIN (SELECT "ws_sold_date_sk", "ws_bill_customer_sk", "ws_ext_list_price" - "ws_ext_discount_amt" AS "-"
FROM '/mnt/disks/tpcds/parquet/web_sales.parquet' AS web_sales) AS "t64" ON "t63"."c_customer_sk" = "t64"."ws_bill_customer_sk") AS "t65"
INNER JOIN (SELECT "d_date_sk", "d_year"
FROM '/mnt/disks/tpcds/parquet/date_dim.parquet' AS date_dim) AS "t66" ON "t65"."ws_sold_date_sk" = "t66"."d_date_sk"
GROUP BY "t65"."c_customer_id", "t65"."c_first_name", "t65"."c_last_name", "t65"."c_preferred_cust_flag", "t65"."c_birth_country", "t65"."c_login", "t65"."c_email_address", "t66"."d_year") AS "t70"
WHERE "sale_type" = 'w' AND "dyear" = 2001 + 1) AS "t73" ON "t55"."customer_id" = "t73"."customer_id" AND CASE WHEN "t55".">" THEN "t73"."*" / "t55"."year_total1" ELSE 0.0 END > "t55"."CASE"
ORDER BY "t55"."customer_id0" NULLS FIRST, "t55"."customer_first_name0" NULLS FIRST, "t55"."customer_last_name0" NULLS FIRST, "t55"."customer_preferred_cust_flag0" NULLS FIRST

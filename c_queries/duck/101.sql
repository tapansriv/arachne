...
FROM "ldbc"."person") AS "t0"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t1" ON "t0"."p_placeid" = "t1"."pl_placeid") AS "t2"
INNER JOIN (SELECT "t8"."pl_placeid"
FROM (SELECT "t4"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t3"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t4" ON "t3"."p_placeid" = "t4"."pl_placeid") AS "t5"
...
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t24"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t25" ON "t24"."p_placeid" = "t25"."pl_placeid") AS "t26"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t40"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t41" ON "t40"."p_placeid" = "t41"."pl_placeid") AS "t42"
INNER JOIN (SELECT "t48"."pl_placeid"
FROM (SELECT "t44"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t43"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t44" ON "t43"."p_placeid" = "t44"."pl_placeid") AS "t45"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t60"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t61" ON "t60"."p_placeid" = "t61"."pl_placeid") AS "t62"
INNER JOIN (SELECT "t68"."pl_placeid"
FROM (SELECT "t64"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t63"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t64" ON "t63"."p_placeid" = "t64"."pl_placeid") AS "t65"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t79"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t80" ON "t79"."p_placeid" = "t80"."pl_placeid") AS "t81"
INNER JOIN (SELECT "t87"."pl_placeid"
FROM (SELECT "t83"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t82"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t83" ON "t82"."p_placeid" = "t83"."pl_placeid") AS "t84"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t98"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t99" ON "t98"."p_placeid" = "t99"."pl_placeid") AS "t100"
INNER JOIN (SELECT "t106"."pl_placeid"
FROM (SELECT "t102"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t101"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t102" ON "t101"."p_placeid" = "t102"."pl_placeid") AS "t103"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t119"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t120" ON "t119"."p_placeid" = "t120"."pl_placeid") AS "t121"
INNER JOIN (SELECT "t127"."pl_placeid"
FROM (SELECT "t123"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t122"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t123" ON "t122"."p_placeid" = "t123"."pl_placeid") AS "t124"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t138"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t139" ON "t138"."p_placeid" = "t139"."pl_placeid") AS "t140"
INNER JOIN (SELECT "t146"."pl_placeid"
FROM (SELECT "t142"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t141"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t142" ON "t141"."p_placeid" = "t142"."pl_placeid") AS "t143"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t157"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t158" ON "t157"."p_placeid" = "t158"."pl_placeid") AS "t159"
INNER JOIN (SELECT "t165"."pl_placeid"
FROM (SELECT "t161"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t160"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t161" ON "t160"."p_placeid" = "t161"."pl_placeid") AS "t162"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"
...
FROM (SELECT "p_personid", "p_placeid"
FROM "ldbc"."person") AS "t177"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t178" ON "t177"."p_placeid" = "t178"."pl_placeid") AS "t179"
INNER JOIN (SELECT "t185"."pl_placeid"
FROM (SELECT "t181"."pl_containerplaceid"
FROM (SELECT "p_placeid"
FROM "ldbc"."person") AS "t180"
INNER JOIN (SELECT "pl_placeid", "pl_containerplaceid"
FROM "ldbc"."place") AS "t181" ON "t180"."p_placeid" = "t181"."pl_placeid") AS "t182"
INNER JOIN (SELECT "pl_placeid"
FROM "ldbc"."place"

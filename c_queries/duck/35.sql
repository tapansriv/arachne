...
'/mnt/disks/tpcds/parquet/date_dim.parquet' AS "date_dim0") AS "t3"
...
'/mnt/disks/tpcds/parquet/date_dim.parquet' AS "date_dim1") AS "t7"
...
FROM '/mnt/disks/tpcds/parquet/customer_address.parquet' AS customer_address) AS "t15" ON "t14"."c_current_addr_sk" = "t15"."ca_address_sk") AS "t16"
INNER JOIN (SELECT "cd_demo_sk", "cd_gender", "cd_marital_status", "cd_dep_count", "cd_dep_employed_count", "cd_dep_college_count"
FROM '/mnt/disks/tpcds/parquet/customer_demographics.parquet' AS customer_demographics) AS "t17" ON "t16"."c_current_cdemo_sk" = "t17"."cd_demo_sk"
...
ORDER BY "t16"."ca_state" NULLS FIRST, "t17"."cd_gender" NULLS FIRST, "t17"."cd_marital_status" NULLS FIRST, "t17"."cd_dep_count" NULLS FIRST, "t17"."cd_dep_employed_count" NULLS FIRST, "t17"."cd_dep_college_count" NULLS FIRST

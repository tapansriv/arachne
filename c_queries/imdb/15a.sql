SELECT MIN("t16"."info0") AS "release_date", MIN("t19"."title") AS "internet_movie"
...
FROM title
WHERE "production_year" > 2000) AS "t19" ON "t16"."movie_id" = "t19"."id" AND "t16"."movie_id1" = "t19"."id" AND "t16"."movie_id2" = "t19"."id" AND "t16"."movie_id0" = "t19"."id"
;

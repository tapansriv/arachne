SELECT MIN("t16"."info2") AS "rating", MIN("t19"."title") AS "western_dark_production"
...
(SELECT "id"
FROM keyword
WHERE "keyword" IN ('murder', 'murder-in-title')) AS "t5"
CROSS JOIN 
(SELECT "id"
FROM kind_type
...
FROM movie_info_idx
WHERE "info" > '6.0') AS "t13" ON "t11"."movie_id" = "t13"."movie_id" AND "t11"."id0" = "t13"."info_type_id") AS "t14"
...
FROM title
WHERE "production_year" > 2010 AND ("title" LIKE '%murder%' OR "title" LIKE '%Murder%' OR "title" LIKE '%Mord%')) AS "t19" ON "t16"."id2" = "t19"."kind_id" AND "t16"."movie_id" = "t19"."id" AND "t16"."movie_id1" = "t19"."id" AND "t16"."movie_id0" = "t19"."id"
;

...
FROM movie_info
WHERE "info" IN ('American', 'Danish', 'Denmark', 'German', 'Germany', 'Norway', 'Norwegian', 'Sweden', 'Swedish', 'USA')) AS "t18" ON "t15"."movie_id" = "t18"."movie_id" AND "t15"."id1" = "t18"."info_type_id") AS "t19"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
FROM movie_info_idx
WHERE "info" < '8.5') AS "t21" ON "t19"."movie_id0" = "t21"."movie_id" AND "t19"."movie_id" = "t21"."movie_id" AND "t19"."id2" = "t21"."info_type_id") AS "t22"
...
FROM title
WHERE "production_year" > 2005) AS "t27" ON "t24"."id4" = "t27"."kind_id" AND "t24"."movie_id0" = "t27"."id" AND "t24"."movie_id2" = "t27"."id" AND "t24"."movie_id1" = "t27"."id" AND "t24"."movie_id" = "t27"."id"
;

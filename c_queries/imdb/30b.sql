SELECT MIN("t26"."info1") AS "movie_budget", MIN("t26"."info2") AS "movie_votes", MIN("t26"."name") AS "writer", MIN("t29"."title") AS "complete_gore_movie"
...
FROM comp_cast_type
WHERE "kind" IN ('cast', 'crew')) AS "t1" ON "t"."subject_id" = "t1"."id") AS "t2"
INNER JOIN (SELECT "id"
FROM comp_cast_type
...
FROM movie_info
WHERE "info" IN ('Horror', 'Thriller')) AS "t17" ON "t8"."movie_id" = "t17"."movie_id" AND "t5"."movie_id" = "t17"."movie_id" AND "t10"."id" = "t17"."info_type_id") AS "t18"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
...
FROM title
WHERE "production_year" > 2000 AND ("title" LIKE '%Freddy%' OR "title" LIKE '%Jason%' OR "title" LIKE 'Saw%')) AS "t29" ON "t26"."movie_id1" = "t29"."id" AND "t26"."movie_id2" = "t29"."id" AND "t26"."movie_id0" = "t29"."id" AND "t26"."movie_id3" = "t29"."id" AND "t26"."movie_id" = "t29"."id"
;

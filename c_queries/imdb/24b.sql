SELECT MIN("t27"."name0") AS "voiced_char_name", MIN("t27"."name2") AS "voicing_actress_name", MIN("t30"."title") AS "kung_fu_panda"
...
(SELECT "id"
FROM company_name
WHERE "country_code" = '[us]' AND "name" = 'DreamWorks Animation') AS "t7"
CROSS JOIN 
(SELECT "id"
FROM info_type
...
(SELECT "id"
FROM keyword
WHERE "keyword" IN ('computer-animated-movie', 'hand-to-hand-combat', 'hero', 'martial-arts')) AS "t12"
...
FROM title
WHERE "production_year" > 2010 AND "title" LIKE 'Kung Fu Panda%') AS "t30" ON "t27"."movie_id1" = "t30"."id" AND "t27"."movie_id0" = "t30"."id" AND "t27"."movie_id" = "t30"."id" AND "t27"."movie_id2" = "t30"."id"
;

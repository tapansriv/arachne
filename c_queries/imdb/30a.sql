SELECT MIN("t26"."info1") AS "movie_budget", MIN("t26"."info2") AS "movie_votes", MIN("t26"."name") AS "writer", MIN("t29"."title") AS "complete_violent_movie"
...
FROM title
WHERE "production_year" > 2000) AS "t29" ON "t26"."movie_id1" = "t29"."id" AND "t26"."movie_id2" = "t29"."id" AND "t26"."movie_id0" = "t29"."id" AND "t26"."movie_id3" = "t29"."id" AND "t26"."movie_id" = "t29"."id"
;

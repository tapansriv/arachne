SELECT MIN("t23"."name") AS "character_name", MIN("t23"."info0") AS "rating", MIN("t26"."title") AS "complete_hero_movie"
FROM (SELECT "t21"."movie_id", "t21"."name", "t21"."movie_id0", "t21"."id6", "t21"."movie_id1", "t21"."info0", "t21"."movie_id2"
...
(SELECT "id"
FROM keyword
WHERE "keyword" IN ('based-on-comic', 'fight', 'marvel-comics', 'superhero')) AS "t14"
CROSS JOIN 
(SELECT "id"
FROM kind_type
...
FROM movie_info_idx
WHERE "info" > '8.0') AS "t18" ON "t9"."movie_id0" = "t18"."movie_id" AND "t9"."movie_id" = "t18"."movie_id" AND "t11"."id" = "t18"."info_type_id") AS "t19"
...
FROM title
WHERE "production_year" > 2005) AS "t26" ON "t23"."id6" = "t26"."kind_id" AND "t23"."movie_id2" = "t26"."id" AND "t23"."movie_id0" = "t26"."id" AND "t23"."movie_id" = "t26"."id" AND "t23"."movie_id1" = "t26"."id"
;

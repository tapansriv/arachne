...
FROM comp_cast_type
WHERE "kind" = 'crew') AS "t1" ON "t"."subject_id" = "t1"."id") AS "t2"
INNER JOIN (SELECT "id"
FROM comp_cast_type
...
FROM movie_info
WHERE "info" IN ('German', 'Germany', 'Sweden', 'Swedish')) AS "t25" ON "t22"."movie_id0" = "t25"."movie_id" AND "t22"."movie_id" = "t25"."movie_id" AND "t22"."id4" = "t25"."info_type_id") AS "t26"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
FROM movie_info_idx
WHERE "info" > '6.5') AS "t28" ON "t26"."movie_id1" = "t28"."movie_id" AND "t26"."movie_id0" = "t28"."movie_id" AND "t26"."movie_id" = "t28"."movie_id" AND "t26"."id5" = "t28"."info_type_id") AS "t29"

...
FROM title
WHERE "production_year" >= 1950 AND "production_year" <= 2010) AS "t3" ON "t0"."movie_id3" = "t3"."id" AND "t0"."movie_id2" = "t3"."id" AND "t0"."movie_id0" = "t3"."id" AND "t0"."movie_id1" = "t3"."id" AND "t0"."movie_id" = "t3"."id"
;

SELECT MIN("t24"."name2") AS "voicing_actress", MIN("t27"."title") AS "voiced_movie"
...
WHERE "note" LIKE '%(USA)%' OR "note" LIKE '%(worldwide)%') AS "t12" ON "t4"."movie_id" = "t12"."movie_id" AND "t7"."id" = "t12"."company_id") AS "t13"
INNER JOIN (SELECT "movie_id", "info_type_id"
FROM movie_info
WHERE "info" LIKE 'Japan:%200%' OR "info" LIKE 'USA:%200%') AS "t16" ON "t13"."movie_id0" = "t16"."movie_id" AND "t13"."movie_id" = "t16"."movie_id" AND "t13"."id3" = "t16"."info_type_id") AS "t17"
INNER JOIN (SELECT "id", "name"
FROM name
WHERE "gender" = 'f' AND "name" LIKE '%Ang%') AS "t20" ON "t17"."person_id0" = "t20"."id" AND "t17"."person_id" = "t20"."id") AS "t21"
INNER JOIN (SELECT "id"
FROM role_type
WHERE "role" = 'actress') AS "t23" ON "t21"."role_id" = "t23"."id") AS "t24"
INNER JOIN (SELECT "id", "title"
FROM title
WHERE "production_year" >= 2005 AND "production_year" <= 2009) AS "t27" ON "t24"."movie_id1" = "t27"."id" AND "t24"."movie_id0" = "t27"."id" AND "t24"."movie_id" = "t27"."id"
;

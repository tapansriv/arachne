...
(SELECT "movie_id"
FROM movie_info
WHERE "info" IN ('American', 'Denish', 'Denmark', 'German', 'Germany', 'Norway', 'Norwegian', 'Sweden', 'Swedish', 'USA')) AS "t4"
...
FROM title
WHERE "production_year" > 1990) AS "t9" ON "t6"."movie_id" = "t9"."id" AND "t6"."movie_id0" = "t9"."id"
;

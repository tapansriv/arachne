SELECT MIN("t19"."info1") AS "movie_budget", MIN("t19"."info2") AS "movie_votes", MIN("t19"."name") AS "male_writer", MIN("t22"."title") AS "violent_movie_title"
...
(SELECT "id"
FROM keyword
WHERE "keyword" IN ('blood', 'death', 'female-nudity', 'gore', 'murder')) AS "t8"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
FROM movie_info
WHERE "info" = 'Horror') AS "t10" ON "t1"."movie_id" = "t10"."movie_id" AND "t3"."id" = "t10"."info_type_id") AS "t11"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
...
FROM title
WHERE "production_year" > 2010 AND "title" LIKE 'Vampire%') AS "t22" ON "t19"."movie_id0" = "t22"."id" AND "t19"."movie_id1" = "t22"."id" AND "t19"."movie_id" = "t22"."id" AND "t19"."movie_id2" = "t22"."id"
;

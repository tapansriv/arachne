...
FROM movie_info
WHERE "info" LIKE 'Japan:%200%' OR "info" LIKE 'USA:%200%') AS "t27" ON "t24"."movie_id1" = "t27"."movie_id" AND "t24"."movie_id0" = "t27"."movie_id" AND "t24"."movie_id" = "t27"."movie_id" AND "t24"."id6" = "t27"."info_type_id") AS "t28"
...
FROM title
WHERE "title" = 'Shrek 2' AND ("production_year" >= 2000 AND "production_year" <= 2010)) AS "t42" ON "t39"."movie_id2" = "t42"."id" AND "t39"."movie_id1" = "t42"."id" AND "t39"."movie_id0" = "t42"."id" AND "t39"."movie_id3" = "t42"."id" AND "t39"."movie_id" = "t42"."id"
;

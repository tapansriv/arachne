...
FROM title
WHERE "production_year" > 2000) AS "t34" ON "t31"."id7" = "t34"."kind_id" AND ("t31"."movie_id1" = "t34"."id" AND "t31"."movie_id3" = "t34"."id") AND ("t31"."movie_id2" = "t34"."id" AND ("t31"."movie_id0" = "t34"."id" AND "t31"."movie_id" = "t34"."id"))
;

SELECT MIN("t24"."info1") AS "movie_budget", MIN("t24"."info2") AS "movie_votes", MIN("t24"."name0") AS "writer", MIN("t25"."title") AS "violent_liongate_movie"
FROM (SELECT "t20"."movie_id", "t20"."movie_id0", "t20"."movie_id1", "t20"."info1", "t20"."movie_id2", "t20"."info2", "t20"."movie_id3", "t23"."name" AS "name0"
...
FROM movie_info
WHERE "info" IN ('Horror', 'Thriller')) AS "t15" ON "t13"."movie_id" = "t15"."movie_id" AND "t13"."movie_id0" = "t15"."movie_id" AND "t13"."id1" = "t15"."info_type_id") AS "t16"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
...
FROM name
WHERE "gender" = 'm') AS "t23" ON "t20"."person_id" = "t23"."id") AS "t24"
INNER JOIN (SELECT "id", "title"
FROM title) AS "t25" ON "t24"."movie_id1" = "t25"."id" AND "t24"."movie_id2" = "t25"."id" AND "t24"."movie_id" = "t25"."id" AND "t24"."movie_id3" = "t25"."id" AND "t24"."movie_id0" = "t25"."id"
;

SELECT MIN("t0"."name") AS "company_name", MIN("t0"."link") AS "link_type", MIN("t3"."title") AS "german_follow_up"
...
FROM title
WHERE "production_year" >= 2000 AND "production_year" <= 2010) AS "t3" ON "t0"."movie_id2" = "t3"."id" AND "t0"."movie_id1" = "t3"."id" AND "t0"."movie_id" = "t3"."id" AND "t0"."movie_id0" = "t3"."id"
;

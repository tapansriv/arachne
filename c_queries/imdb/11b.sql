SELECT MIN("t0"."name") AS "from_company", MIN("t0"."link") AS "movie_link_type", MIN("t3"."title") AS "sequel_movie"
...
FROM title
WHERE "production_year" = 1998 AND "title" LIKE '%Money%') AS "t3" ON "t0"."movie_id1" = "t3"."id" AND "t0"."movie_id0" = "t3"."id" AND "t0"."movie_id" = "t3"."id"
;

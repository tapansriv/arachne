SELECT MIN("t16"."info2") AS "rating", MIN("t19"."title") AS "north_european_dark_production"
...
FROM movie_info
WHERE "info" IN ('American', 'Danish', 'Denmark', 'German', 'Germany', 'Norway', 'Norwegian', 'Sweden', 'Swedish', 'USA')) AS "t10" ON "t0"."id" = "t10"."info_type_id") AS "t11"
...
FROM title
WHERE "production_year" > 2005) AS "t19" ON "t16"."id2" = "t19"."kind_id" AND "t16"."movie_id" = "t19"."id" AND "t16"."movie_id1" = "t19"."id" AND "t16"."movie_id0" = "t19"."id"
;

SELECT MIN("t16"."name") AS "movie_company", MIN("t16"."info2") AS "rating", MIN("t19"."title") AS "drama_horror_movie"
...
FROM movie_info
WHERE "info" IN ('Drama', 'Horror')) AS "t12" ON "t9"."id1" = "t12"."info_type_id" AND "t9"."movie_id" = "t12"."movie_id") AS "t13"
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
FROM movie_info_idx
WHERE "info" > '8.0') AS "t15" ON "t13"."id2" = "t15"."info_type_id" AND "t13"."movie_id" = "t15"."movie_id" AND "t13"."movie_id0" = "t15"."movie_id") AS "t16"
INNER JOIN (SELECT "id", "title"
FROM title
WHERE "production_year" >= 2005 AND "production_year" <= 2008) AS "t19" ON "t16"."movie_id0" = "t19"."id" AND "t16"."movie_id1" = "t19"."id" AND "t16"."movie_id" = "t19"."id"
;

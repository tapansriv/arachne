SELECT MIN("t6"."keyword") AS "movie_keyword", MIN("t6"."name") AS "actor_name", MIN("t9"."title") AS "hero_movie"
...
FROM title
WHERE "production_year" > 2014) AS "t9" ON "t6"."movie_id0" = "t9"."id" AND "t6"."movie_id" = "t9"."id"
;

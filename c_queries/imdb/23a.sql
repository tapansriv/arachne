...
FROM title
WHERE "production_year" > 2000) AS "t22" ON "t19"."id5" = "t22"."kind_id" AND "t19"."movie_id1" = "t22"."id" AND "t19"."movie_id2" = "t22"."id" AND "t19"."movie_id0" = "t22"."id" AND "t19"."movie_id" = "t22"."id"
;

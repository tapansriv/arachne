...
FROM title
WHERE "production_year" > 2009) AS "t27" ON "t24"."id4" = "t27"."kind_id" AND "t24"."movie_id0" = "t27"."id" AND "t24"."movie_id2" = "t27"."id" AND "t24"."movie_id1" = "t27"."id" AND "t24"."movie_id" = "t27"."id"
;

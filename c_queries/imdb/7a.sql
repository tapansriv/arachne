...
FROM name
WHERE "name_pcode_cf" >= 'A' AND "name_pcode_cf" <= 'F' AND ("gender" = 'm' OR "gender" = 'f' AND "name" LIKE 'B%')) AS "t11" ON "t8"."person_id" = "t11"."id" AND "t8"."person_id0" = "t11"."id"
...
FROM title
WHERE "production_year" >= 1980 AND "production_year" <= 1995) AS "t18" ON "t15"."movie_id" = "t18"."id" AND "t15"."linked_movie_id" = "t18"."id"
;

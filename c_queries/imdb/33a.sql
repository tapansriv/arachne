...
INNER JOIN (SELECT "id", "title", "kind_id"
FROM title
WHERE "production_year" >= 2005 AND "production_year" <= 2008) AS "t28" ON "t25"."linked_movie_id" = "t28"."id" AND "t25"."movie_id2" = "t28"."id" AND "t25"."id4" = "t28"."kind_id" AND "t25"."movie_id0" = "t28"."id"
;

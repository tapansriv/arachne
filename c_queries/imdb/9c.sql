SELECT MIN("t16"."name") AS "alternative_name", MIN("t16"."name0") AS "voiced_character_name", MIN("t16"."name2") AS "voicing_actress", MIN("t17"."title") AS "american_movie"
...
FROM name
WHERE "gender" = 'f' AND "name" LIKE '%An%') AS "t12" ON "t9"."person_id0" = "t12"."id" AND "t9"."person_id" = "t12"."id") AS "t13"

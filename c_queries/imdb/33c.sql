...
(SELECT "id"
FROM kind_type
WHERE "kind" IN ('episode', 'tv series')) AS "t8"
CROSS JOIN 
(SELECT "id"
FROM kind_type
WHERE "kind" IN ('episode', 'tv series')) AS "t10"
CROSS JOIN 
(SELECT "id"
FROM link_type
WHERE "link" IN ('followed by', 'follows', 'sequel')) AS "t12"
...
INNER JOIN (SELECT "movie_id", "info_type_id", "info"
FROM movie_info_idx
WHERE "info" < '3.5') AS "t20" ON "t18"."id2" = "t20"."info_type_id" AND "t18"."movie_id0" = "t20"."movie_id") AS "t21"
...
INNER JOIN (SELECT "id", "title", "kind_id"
FROM title
WHERE "production_year" >= 2000 AND "production_year" <= 2010) AS "t28" ON "t25"."linked_movie_id" = "t28"."id" AND "t25"."movie_id2" = "t28"."id" AND "t25"."id4" = "t28"."kind_id" AND "t25"."movie_id0" = "t28"."id"
;

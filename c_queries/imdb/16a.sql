SELECT MIN("t12"."name") AS "cool_actor_pseudonym", MIN("t15"."title") AS "series_named_after_char"
...
FROM title
WHERE "episode_nr" >= 50 AND "episode_nr" < 100) AS "t15" ON "t12"."movie_id" = "t15"."id" AND "t12"."movie_id1" = "t15"."id" AND "t12"."movie_id0" = "t15"."id"
;

CREATE TABLE duck_table_82_0 AS SELECT "t9"."i_item_id", "t9"."i_item_desc", "t9"."i_current_price"
...
FROM '/mnt/disks/tpcds/parquet/store_sales.parquet' AS store_sales) AS "t10" ON "t9"."i_item_sk" = "t10"."ss_item_sk";

SELECT "i_item_id", "i_item_desc", "i_current_price"
FROM "duck_table_82_0"
